...
putc(int fd, char c)
{
 ...
 368:	f4e080e7          	jalr	-178(ra) # 2b2 <write>
}
...
free(void *ap)
{
 ...
 66e:	1867b783          	ld	a5,390(a5) # 7f0 <freep>
 ...
 69c:	00e6ea63          	bltu	a3,a4,6b0 <free+0x50>
{
 ...
 6de:	10f73b23          	sd	a5,278(a4) # 7f0 <freep>
}
 6e2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 710:	0e453503          	ld	a0,228(a0) # 7f0 <freep>
 ...
 738:	0bc90913          	addi	s2,s2,188 # 7f0 <freep>
  if(p == (char*)-1)
 73c:	5afd                	li	s5,-1
 73e:	a88d                	j	7b0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 740:	00000797          	auipc	a5,0x0
 744:	0b878793          	addi	a5,a5,184 # 7f8 <base>
 748:	00000717          	auipc	a4,0x0
 74c:	0af73423          	sd	a5,168(a4) # 7f0 <freep>
 750:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c0:	b5e080e7          	jalr	-1186(ra) # 31a <sbrk>
  if(p == (char*)-1)
