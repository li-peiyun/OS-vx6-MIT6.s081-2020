...
int main(int argc, char *argv[]) {
  ...
  12:	7ea58593          	addi	a1,a1,2026 # 7f8 <malloc+0xe8>
  16:	4509                	li	a0,2
  18:	00000097          	auipc	ra,0x0
  1c:	60c080e7          	jalr	1548(ra) # 624 <fprintf>
    exit(1);
  20:	4505                	li	a0,1
  ...
  30:	18e080e7          	jalr	398(ra) # 1ba <atoi>
  int ret = sleep(ticks);
  34:	00000097          	auipc	ra,0x0
  38:	316080e7          	jalr	790(ra) # 34a <sleep>
  exit(ret);
...
free(void *ap)
{
 ...
 696:	1a67b783          	ld	a5,422(a5) # 838 <freep>
 ...
 6c4:	00e6ea63          	bltu	a3,a4,6d8 <free+0x50>
{
 ...
 706:	12f73b23          	sd	a5,310(a4) # 838 <freep>
}
 70a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 738:	10453503          	ld	a0,260(a0) # 838 <freep>
 ...
 760:	0dc90913          	addi	s2,s2,220 # 838 <freep>
  if(p == (char*)-1)
 764:	5afd                	li	s5,-1
 766:	a88d                	j	7d8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 768:	00000797          	auipc	a5,0x0
 76c:	0d878793          	addi	a5,a5,216 # 840 <base>
 770:	00000717          	auipc	a4,0x0
 774:	0cf73423          	sd	a5,200(a4) # 838 <freep>
 778:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 79a:	0aa73123          	sd	a0,162(a4) # 838 <freep>
      return (void*)(p + 1);
