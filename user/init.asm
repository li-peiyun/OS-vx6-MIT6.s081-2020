...
main(void)
{
  ...
  3a:	8a290913          	addi	s2,s2,-1886 # 8d8 <malloc+0x100>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8be50513          	addi	a0,a0,-1858 # 928 <malloc+0x150>
  ...
  a0:	82c50513          	addi	a0,a0,-2004 # 8c8 <malloc+0xf0>
  a4:	00000097          	auipc	ra,0x0
  a8:	326080e7          	jalr	806(ra) # 3ca <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	81250513          	addi	a0,a0,-2030 # 8c0 <malloc+0xe8>
  b6:	00000097          	auipc	ra,0x0
  ba:	30c080e7          	jalr	780(ra) # 3c2 <open>
  be:	b795                	j	22 <main+0x22>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	83050513          	addi	a0,a0,-2000 # 8f0 <malloc+0x118>
  ...
  de:	88e58593          	addi	a1,a1,-1906 # 968 <argv>
  e2:	00001517          	auipc	a0,0x1
  e6:	82650513          	addi	a0,a0,-2010 # 908 <malloc+0x130>
  ea:	00000097          	auipc	ra,0x0
  ee:	2d0080e7          	jalr	720(ra) # 3ba <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	81e50513          	addi	a0,a0,-2018 # 910 <malloc+0x138>
  fa:	00000097          	auipc	ra,0x0
  fe:	620080e7          	jalr	1568(ra) # 71a <printf>
      exit(1);
 102:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 556:	3feb8b93          	addi	s7,s7,1022 # 950 <digits>
 ...
 696:	2b690913          	addi	s2,s2,694 # 948 <malloc+0x170>
        while(*s != 0){
...
free(void *ap)
{
 ...
 75e:	21e7b783          	ld	a5,542(a5) # 978 <freep>
 ...
 78c:	00e6ea63          	bltu	a3,a4,7a0 <free+0x50>
{
 ...
 7ce:	1af73723          	sd	a5,430(a4) # 978 <freep>
}
 7d2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 800:	17c53503          	ld	a0,380(a0) # 978 <freep>
 ...
 828:	15490913          	addi	s2,s2,340 # 978 <freep>
  if(p == (char*)-1)
 82c:	5afd                	li	s5,-1
 82e:	a88d                	j	8a0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 830:	00000797          	auipc	a5,0x0
 834:	15078793          	addi	a5,a5,336 # 980 <base>
 838:	00000717          	auipc	a4,0x0
 83c:	14f73023          	sd	a5,320(a4) # 978 <freep>
 840:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 862:	10a73d23          	sd	a0,282(a4) # 978 <freep>
      return (void*)(p + 1);
