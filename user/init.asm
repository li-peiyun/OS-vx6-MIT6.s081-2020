...
main(void)
{
  ...
  12:	91a50513          	addi	a0,a0,-1766 # 928 <statistics+0x8c>
  16:	00000097          	auipc	ra,0x0
  1a:	3ac080e7          	jalr	940(ra) # 3c2 <open>
  ...
  28:	3d6080e7          	jalr	982(ra) # 3fa <dup>
  dup(0);  // stderr
  2c:	4501                	li	a0,0
  2e:	00000097          	auipc	ra,0x0
  32:	3cc080e7          	jalr	972(ra) # 3fa <dup>

  for(;;){
    printf("init: starting sh\n");
  36:	00001917          	auipc	s2,0x1
  3a:	90a90913          	addi	s2,s2,-1782 # 940 <statistics+0xa4>
  3e:	854a                	mv	a0,s2
  40:	00000097          	auipc	ra,0x0
  44:	6ba080e7          	jalr	1722(ra) # 6fa <printf>
    pid = fork();
  48:	00000097          	auipc	ra,0x0
  4c:	332080e7          	jalr	818(ra) # 37a <fork>
  50:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  5e:	330080e7          	jalr	816(ra) # 38a <wait>
      if(wpid == pid){
  ...
  6e:	92650513          	addi	a0,a0,-1754 # 990 <statistics+0xf4>
  72:	00000097          	auipc	ra,0x0
  76:	688080e7          	jalr	1672(ra) # 6fa <printf>
        exit(1);
  7a:	4505                	li	a0,1
  7c:	00000097          	auipc	ra,0x0
  80:	306080e7          	jalr	774(ra) # 382 <exit>
    mknod("console", CONSOLE, 0);
  84:	4601                	li	a2,0
  86:	4585                	li	a1,1
  88:	00001517          	auipc	a0,0x1
  8c:	8a050513          	addi	a0,a0,-1888 # 928 <statistics+0x8c>
  90:	00000097          	auipc	ra,0x0
  94:	33a080e7          	jalr	826(ra) # 3ca <mknod>
    mknod("statistics", STATS, 0);
  98:	4601                	li	a2,0
  9a:	4589                	li	a1,2
  9c:	00001517          	auipc	a0,0x1
  a0:	89450513          	addi	a0,a0,-1900 # 930 <statistics+0x94>
  a4:	00000097          	auipc	ra,0x0
  a8:	326080e7          	jalr	806(ra) # 3ca <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	87a50513          	addi	a0,a0,-1926 # 928 <statistics+0x8c>
  b6:	00000097          	auipc	ra,0x0
  ba:	30c080e7          	jalr	780(ra) # 3c2 <open>
  be:	b795                	j	22 <main+0x22>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	89850513          	addi	a0,a0,-1896 # 958 <statistics+0xbc>
  c8:	00000097          	auipc	ra,0x0
  cc:	632080e7          	jalr	1586(ra) # 6fa <printf>
      exit(1);
  d0:	4505                	li	a0,1
  d2:	00000097          	auipc	ra,0x0
  d6:	2b0080e7          	jalr	688(ra) # 382 <exit>
      exec("sh", argv);
  da:	00001597          	auipc	a1,0x1
  de:	90e58593          	addi	a1,a1,-1778 # 9e8 <argv>
  e2:	00001517          	auipc	a0,0x1
  e6:	88e50513          	addi	a0,a0,-1906 # 970 <statistics+0xd4>
  ea:	00000097          	auipc	ra,0x0
  ee:	2d0080e7          	jalr	720(ra) # 3ba <exec>
      printf("init: exec sh failed\n");
  f2:	00001517          	auipc	a0,0x1
  f6:	88650513          	addi	a0,a0,-1914 # 978 <statistics+0xdc>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46a:	55250513          	addi	a0,a0,1362 # 9b8 <digits>
 46e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 536:	486b8b93          	addi	s7,s7,1158 # 9b8 <digits>
 ...
 676:	33e90913          	addi	s2,s2,830 # 9b0 <statistics+0x114>
        while(*s != 0){
...
free(void *ap)
{
 ...
 73e:	2be7b783          	ld	a5,702(a5) # 9f8 <freep>
 ...
 76c:	00e6ea63          	bltu	a3,a4,780 <free+0x50>
{
 ...
 7ae:	24f73723          	sd	a5,590(a4) # 9f8 <freep>
}
 7b2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7e0:	21c53503          	ld	a0,540(a0) # 9f8 <freep>
 ...
 808:	1f490913          	addi	s2,s2,500 # 9f8 <freep>
  if(p == (char*)-1)
 80c:	5afd                	li	s5,-1
 80e:	a88d                	j	880 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 810:	00000797          	auipc	a5,0x0
 814:	1f078793          	addi	a5,a5,496 # a00 <base>
 818:	00000717          	auipc	a4,0x0
 81c:	1ef73023          	sd	a5,480(a4) # 9f8 <freep>
 820:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 842:	1aa73d23          	sd	a0,442(a4) # 9f8 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 8b6:	07e50513          	addi	a0,a0,126 # 930 <statistics+0x94>
 8ba:	00000097          	auipc	ra,0x0
 8be:	b08080e7          	jalr	-1272(ra) # 3c2 <open>
  if(fd < 0) {
 8c2:	04054263          	bltz	a0,906 <statistics+0x6a>
 8c6:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 8c8:	4481                	li	s1,0
 8ca:	03205063          	blez	s2,8ea <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 8ce:	4099063b          	subw	a2,s2,s1
 8d2:	009a05b3          	add	a1,s4,s1
 8d6:	854e                	mv	a0,s3
 8d8:	00000097          	auipc	ra,0x0
 8dc:	ac2080e7          	jalr	-1342(ra) # 39a <read>
 8e0:	00054563          	bltz	a0,8ea <statistics+0x4e>
      break;
    }
    i += n;
 8e4:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 8e6:	ff24c4e3          	blt	s1,s2,8ce <statistics+0x32>
  }
  close(fd);
 8ea:	854e                	mv	a0,s3
 8ec:	00000097          	auipc	ra,0x0
 8f0:	abe080e7          	jalr	-1346(ra) # 3aa <close>
  return i;
}
 8f4:	8526                	mv	a0,s1
 8f6:	70a2                	ld	ra,40(sp)
 8f8:	7402                	ld	s0,32(sp)
 8fa:	64e2                	ld	s1,24(sp)
 ...
 904:	8082                	ret
      fprintf(2, "stats: open failed\n");
 906:	00000597          	auipc	a1,0x0
 90a:	0ca58593          	addi	a1,a1,202 # 9d0 <digits+0x18>
 90e:	4509                	li	a0,2
 910:	00000097          	auipc	ra,0x0
 914:	dbc080e7          	jalr	-580(ra) # 6cc <fprintf>
      exit(1);
 918:	4505                	li	a0,1
 91a:	00000097          	auipc	ra,0x0
 91e:	a68080e7          	jalr	-1432(ra) # 382 <exit>
