...
go(int which_child)
{
  ...
  chdir("/");
      ...
      da:	2e250513          	addi	a0,a0,738 # 13b8 <malloc+0x104>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	2e298993          	addi	s3,s3,738 # 13c8 <malloc+0x114>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	2d098993          	addi	s3,s3,720 # 13c0 <malloc+0x10c>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.1247+0xeb>
     102:	a825                	j	13a <go+0xc2>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     104:	20200593          	li	a1,514
     108:	00001517          	auipc	a0,0x1
     10c:	2c850513          	addi	a0,a0,712 # 13d0 <malloc+0x11c>
    ...
    if(what == 1){
     ...
     292:	35a58593          	addi	a1,a1,858 # 15e8 <malloc+0x334>
     ...
     2b6:	38650513          	addi	a0,a0,902 # 1638 <malloc+0x384>
     2ba:	00001097          	auipc	ra,0x1
     2be:	f3c080e7          	jalr	-196(ra) # 11f6 <printf>
        exit(1);
     2c2:	4505                	li	a0,1
     ...
     2d4:	11050513          	addi	a0,a0,272 # 13e0 <malloc+0x12c>
     ...
     35c:	0a850513          	addi	a0,a0,168 # 1400 <malloc+0x14c>
     ...
     37e:	09650513          	addi	a0,a0,150 # 1410 <malloc+0x15c>
     ...
     396:	2fe58593          	addi	a1,a1,766 # 1690 <buf.1247>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	2e658593          	addi	a1,a1,742 # 1690 <buf.1247>
     3b2:	854a                	mv	a0,s2
     ...
     4b4:	fe050513          	addi	a0,a0,-32 # 1490 <malloc+0x1dc>
     4b8:	00001097          	auipc	ra,0x1
     4bc:	d3e080e7          	jalr	-706(ra) # 11f6 <printf>
        exit(1);
     4c0:	4505                	li	a0,1
     ...
     502:	f9250513          	addi	a0,a0,-110 # 1490 <malloc+0x1dc>
     506:	00001097          	auipc	ra,0x1
     50a:	cf0080e7          	jalr	-784(ra) # 11f6 <printf>
        exit(1);
     50e:	4505                	li	a0,1
     ...
     55e:	f4e50513          	addi	a0,a0,-178 # 14a8 <malloc+0x1f4>
     ...
     58a:	eea50513          	addi	a0,a0,-278 # 1470 <malloc+0x1bc>
     ...
     5ac:	ee850513          	addi	a0,a0,-280 # 1490 <malloc+0x1dc>
     5b0:	00001097          	auipc	ra,0x1
     5b4:	c46080e7          	jalr	-954(ra) # 11f6 <printf>
        exit(1);
     5b8:	4505                	li	a0,1
     ...
     5c6:	ef650513          	addi	a0,a0,-266 # 14b8 <malloc+0x204>
     5ca:	00001097          	auipc	ra,0x1
     5ce:	c2c080e7          	jalr	-980(ra) # 11f6 <printf>
        exit(1);
     5d2:	4505                	li	a0,1
     ...
     614:	e8050513          	addi	a0,a0,-384 # 1490 <malloc+0x1dc>
     618:	00001097          	auipc	ra,0x1
     61c:	bde080e7          	jalr	-1058(ra) # 11f6 <printf>
        exit(1);
     620:	4505                	li	a0,1
     ...
     670:	e5c50513          	addi	a0,a0,-420 # 14c8 <malloc+0x214>
     674:	00001097          	auipc	ra,0x1
     678:	b82080e7          	jalr	-1150(ra) # 11f6 <printf>
        exit(1);
     67c:	4505                	li	a0,1
     ...
     69c:	e4858593          	addi	a1,a1,-440 # 14e0 <malloc+0x22c>
     ...
     6d8:	e1450513          	addi	a0,a0,-492 # 14e8 <malloc+0x234>
     6dc:	00001097          	auipc	ra,0x1
     6e0:	b1a080e7          	jalr	-1254(ra) # 11f6 <printf>
     6e4:	b7f9                	j	6b2 <go+0x63a>
          printf("grind: pipe read failed\n");
     6e6:	00001517          	auipc	a0,0x1
     6ea:	e2250513          	addi	a0,a0,-478 # 1508 <malloc+0x254>
     6ee:	00001097          	auipc	ra,0x1
     6f2:	b08080e7          	jalr	-1272(ra) # 11f6 <printf>
     6f6:	bfd1                	j	6ca <go+0x652>
        printf("grind: fork failed\n");
     6f8:	00001517          	auipc	a0,0x1
     6fc:	d9850513          	addi	a0,a0,-616 # 1490 <malloc+0x1dc>
     700:	00001097          	auipc	ra,0x1
     704:	af6080e7          	jalr	-1290(ra) # 11f6 <printf>
        exit(1);
     708:	4505                	li	a0,1
     ...
     79e:	d8e50513          	addi	a0,a0,-626 # 1528 <malloc+0x274>
     7a2:	00001097          	auipc	ra,0x1
     7a6:	a54080e7          	jalr	-1452(ra) # 11f6 <printf>
        exit(1);
     7aa:	4505                	li	a0,1
     ...
     7e4:	d0058593          	addi	a1,a1,-768 # 14e0 <malloc+0x22c>
     ...
     856:	d0650513          	addi	a0,a0,-762 # 1558 <malloc+0x2a4>
     85a:	00001097          	auipc	ra,0x1
     85e:	99c080e7          	jalr	-1636(ra) # 11f6 <printf>
        exit(1);
     862:	4505                	li	a0,1
     ...
     870:	cfc50513          	addi	a0,a0,-772 # 1568 <malloc+0x2b4>
     874:	00001097          	auipc	ra,0x1
     878:	982080e7          	jalr	-1662(ra) # 11f6 <printf>
        exit(1);
     87c:	4505                	li	a0,1
     ...
     88c:	cf050513          	addi	a0,a0,-784 # 1578 <malloc+0x2c4>
     890:	00001097          	auipc	ra,0x1
     894:	966080e7          	jalr	-1690(ra) # 11f6 <printf>
        exit(1);
     898:	4505                	li	a0,1
     ...
     8a6:	cf650513          	addi	a0,a0,-778 # 1598 <malloc+0x2e4>
     8aa:	00001097          	auipc	ra,0x1
     8ae:	94c080e7          	jalr	-1716(ra) # 11f6 <printf>
        exit(1);
     8b2:	4505                	li	a0,1
     ...
     8c0:	d0458593          	addi	a1,a1,-764 # 15c0 <malloc+0x30c>
     8c4:	4509                	li	a0,2
     8c6:	00001097          	auipc	ra,0x1
     8ca:	902080e7          	jalr	-1790(ra) # 11c8 <fprintf>
        exit(1);
     8ce:	4505                	li	a0,1
     ...
     8dc:	ce858593          	addi	a1,a1,-792 # 15c0 <malloc+0x30c>
     8e0:	4509                	li	a0,2
     8e2:	00001097          	auipc	ra,0x1
     8e6:	8e6080e7          	jalr	-1818(ra) # 11c8 <fprintf>
        exit(1);
     8ea:	4505                	li	a0,1
     ...
     938:	c9c58593          	addi	a1,a1,-868 # 15d0 <malloc+0x31c>
     93c:	4509                	li	a0,2
     93e:	00001097          	auipc	ra,0x1
     942:	88a080e7          	jalr	-1910(ra) # 11c8 <fprintf>
          exit(1);
     946:	4505                	li	a0,1
     ...
     9ac:	b8058593          	addi	a1,a1,-1152 # 1528 <malloc+0x274>
     9b0:	4509                	li	a0,2
     9b2:	00001097          	auipc	ra,0x1
     9b6:	816080e7          	jalr	-2026(ra) # 11c8 <fprintf>
        exit(3);
     9ba:	450d                	li	a0,3
     ...
     9f8:	bdc58593          	addi	a1,a1,-1060 # 15d0 <malloc+0x31c>
     9fc:	4509                	li	a0,2
     9fe:	00000097          	auipc	ra,0x0
     a02:	7ca080e7          	jalr	1994(ra) # 11c8 <fprintf>
          exit(4);
     a06:	4511                	li	a0,4
     ...
     a3c:	b9858593          	addi	a1,a1,-1128 # 15d0 <malloc+0x31c>
     a40:	4509                	li	a0,2
     a42:	00000097          	auipc	ra,0x0
     a46:	786080e7          	jalr	1926(ra) # 11c8 <fprintf>
          exit(5);
     a4a:	4515                	li	a0,5
     ...
     aa4:	a8858593          	addi	a1,a1,-1400 # 1528 <malloc+0x274>
     aa8:	4509                	li	a0,2
     aaa:	00000097          	auipc	ra,0x0
     aae:	71e080e7          	jalr	1822(ra) # 11c8 <fprintf>
        exit(7);
     ab2:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     acc:	9a850513          	addi	a0,a0,-1624 # 1470 <malloc+0x1bc>
     ad0:	00000097          	auipc	ra,0x0
     ad4:	3de080e7          	jalr	990(ra) # eae <unlink>
  unlink("b");
     ad8:	00001517          	auipc	a0,0x1
     adc:	94850513          	addi	a0,a0,-1720 # 1420 <malloc+0x16c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b10:	98450513          	addi	a0,a0,-1660 # 1490 <malloc+0x1dc>
     b14:	00000097          	auipc	ra,0x0
     b18:	6e2080e7          	jalr	1762(ra) # 11f6 <printf>
    exit(1);
     b1c:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b52:	94250513          	addi	a0,a0,-1726 # 1490 <malloc+0x1dc>
     b56:	00000097          	auipc	ra,0x0
     b5a:	6a0080e7          	jalr	1696(ra) # 11f6 <printf>
    exit(1);
     b5e:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f66:	70650513          	addi	a0,a0,1798 # 1668 <digits>
     f6a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1032:	63ab8b93          	addi	s7,s7,1594 # 1668 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1172:	4f290913          	addi	s2,s2,1266 # 1660 <malloc+0x3ac>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    123a:	4527b783          	ld	a5,1106(a5) # 1688 <freep>
    ...
    1268:	00e6ea63          	bltu	a3,a4,127c <free+0x50>
{
  ...
  freep = p;
    ...
    12aa:	3ef73123          	sd	a5,994(a4) # 1688 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    12dc:	3b053503          	ld	a0,944(a0) # 1688 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1304:	38890913          	addi	s2,s2,904 # 1688 <freep>
  if(p == (char*)-1)
    1308:	5afd                	li	s5,-1
    130a:	a88d                	j	137c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    130c:	00000797          	auipc	a5,0x0
    1310:	76c78793          	addi	a5,a5,1900 # 1a78 <base>
    1314:	00000717          	auipc	a4,0x0
    1318:	36f73a23          	sd	a5,884(a4) # 1688 <freep>
    ...
    133e:	34a73723          	sd	a0,846(a4) # 1688 <freep>
      return (void*)(p + 1);
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    138c:	b5e080e7          	jalr	-1186(ra) # ee6 <sbrk>
  if(p == (char*)-1)
