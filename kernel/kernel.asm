...
0000000080000000 <_entry>:
    ...
    80000016:	726060ef          	jal	ra,8000673c <start>
...
kfree(void *pa)
{
  ...
  acquire(&kmem.lock);
    ...
    8000005e:	0ce080e7          	jalr	206(ra) # 80007128 <acquire>
  ...
  release(&kmem.lock);
    ...
    80000072:	16e080e7          	jalr	366(ra) # 800071dc <release>
}
    ...
    8000008e:	b54080e7          	jalr	-1196(ra) # 80006bde <panic>
...
00000000800000dc <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    800000f8:	fa4080e7          	jalr	-92(ra) # 80007098 <initlock>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000130:	ffc080e7          	jalr	-4(ra) # 80007128 <acquire>
  r = kmem.freelist;
  ...
  release(&kmem.lock);
    ...
    80000148:	098080e7          	jalr	152(ra) # 800071dc <release>
  ...
  release(&kmem.lock);
    ...
    80000172:	06e080e7          	jalr	110(ra) # 800071dc <release>
  if(r)
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    8000034c:	ef2080e7          	jalr	-270(ra) # 8000723a <lockfree_read4>
    ...
    8000036c:	8c0080e7          	jalr	-1856(ra) # 80006c28 <printf>
  ...
  scheduler();        
    ...
    80000434:	20c080e7          	jalr	524(ra) # 8000663c <pci_init>
    sockinit();
    80000438:	00006097          	auipc	ra,0x6
    8000043c:	dfa080e7          	jalr	-518(ra) # 80006232 <sockinit>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  if(va >= MAXVA)
    ...
    800004ae:	734080e7          	jalr	1844(ra) # 80006bde <panic>
...
mappages(pagetable_t pagetable, uint64 va, uint64 size, uint64 pa, int perm)
{
  ...
  a = PGROUNDDOWN(va);
    ...
    *pte = PA2PTE(pa) | perm | PTE_V;
    ...
    800005d2:	610080e7          	jalr	1552(ra) # 80006bde <panic>
      return -1;
...
00000000800005f2 <kvmmap>:
{
  ...
  if(mappages(kpgtbl, va, sz, pa, perm) != 0)
    ...
    8000061e:	5c4080e7          	jalr	1476(ra) # 80006bde <panic>
...
uvminit(pagetable_t pagetable, uchar *src, uint sz)
{
  ...
  memmove(mem, src, sz);
    ...
    800008bc:	326080e7          	jalr	806(ra) # 80006bde <panic>
...
freewalk(pagetable_t pagetable)
{
  ...
  for(int i = 0; i < 512; i++){
    ...
    800009fe:	1e4080e7          	jalr	484(ra) # 80006bde <panic>
    }
  }
...
uvmclear(pagetable_t pagetable, uint64 va)
{
  ...
  *pte &= ~PTE_U;
    ...
    80000b54:	08e080e7          	jalr	142(ra) # 80006bde <panic>
...
wakeup1(struct proc *p)
{
  ...
  if(!holding(&p->lock))
    ...
    80000d34:	37e080e7          	jalr	894(ra) # 800070ae <holding>
  ...
  if(p->chan == p && p->state == SLEEPING) {
    ...
    80000d56:	e8c080e7          	jalr	-372(ra) # 80006bde <panic>
  if(p->chan == p && p->state == SLEEPING) {
...
proc_mapstacks(pagetable_t kpgtbl) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dfa:	de8080e7          	jalr	-536(ra) # 80006bde <panic>
...
0000000080000dfe <procinit>:
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000e26:	276080e7          	jalr	630(ra) # 80007098 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000e5c:	240080e7          	jalr	576(ra) # 80007098 <initlock>
      p->kstack = KSTACK((int) (p - proc));
...
myproc(void) {
  ...
  push_off();
    ...
    80000ed0:	210080e7          	jalr	528(ra) # 800070dc <push_off>
  ...
  pop_off();
    ...
    80000eea:	296080e7          	jalr	662(ra) # 8000717c <pop_off>
}
...
0000000080000efa <forkret>:
{
  ...
  release(&myproc()->lock);
    ...
    80000f0e:	2d2080e7          	jalr	722(ra) # 800071dc <release>
  if (first) {
...
allocpid() {
  ...
  acquire(&pid_lock);
    ...
    80000f5a:	1d2080e7          	jalr	466(ra) # 80007128 <acquire>
  pid = nextpid;
  ...
  release(&pid_lock);
    ...
    80000f74:	26c080e7          	jalr	620(ra) # 800071dc <release>
}
...
00000000800010cc <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800010ee:	03e080e7          	jalr	62(ra) # 80007128 <acquire>
    if(p->state == UNUSED) {
    ...
    800010fc:	0e4080e7          	jalr	228(ra) # 800071dc <release>
  for(p = proc; p < &proc[NPROC]; p++) {
  ...
  p->context.sp = p->kstack + PGSIZE;
    ...
    8000116c:	074080e7          	jalr	116(ra) # 800071dc <release>
    return 0;
    ...
    80001184:	05c080e7          	jalr	92(ra) # 800071dc <release>
    return 0;
...
000000008000118c <userinit>:
{
  ...
  release(&p->lock);
    ...
    80001200:	fe0080e7          	jalr	-32(ra) # 800071dc <release>
}
...
0000000080001282 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  for(i = 0; i < NOFILE; i++)
    ...
    8000131a:	ec6080e7          	jalr	-314(ra) # 800071dc <release>
    return -1;
  ...
  release(&np->lock);
    ...
    80001372:	e6e080e7          	jalr	-402(ra) # 800071dc <release>
}
...
000000008000138c <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    800013cc:	d60080e7          	jalr	-672(ra) # 80007128 <acquire>
      pp->parent = initproc;
    ...
    800013dc:	e04080e7          	jalr	-508(ra) # 800071dc <release>
...
00000000800013f2 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001466:	d7a080e7          	jalr	-646(ra) # 800071dc <release>
    for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001478:	cb4080e7          	jalr	-844(ra) # 80007128 <acquire>
      if(p->state != UNUSED) {
...
00000000800014b6 <sched>:
{
  ...
  if(!holding(&p->lock))
    ...
    800014d2:	be0080e7          	jalr	-1056(ra) # 800070ae <holding>
...
000000008000158c <exit>:
{
  ...
  if(p == initproc)
    ...
    800015c8:	61a080e7          	jalr	1562(ra) # 80006bde <panic>
      fileclose(f);
  ...
  acquire(&initproc->lock);
    ...
    80001612:	b1a080e7          	jalr	-1254(ra) # 80007128 <acquire>
  wakeup1(initproc);
  ...
  release(&original_parent->lock);
    ...
    8000167a:	b66080e7          	jalr	-1178(ra) # 800071dc <release>
  sched();
  ...
  panic("zombie exit");
    ...
    80001692:	550080e7          	jalr	1360(ra) # 80006bde <panic>
...
0000000080001696 <yield>:
{
  ...
  acquire(&p->lock);
    ...
    800016ae:	a7e080e7          	jalr	-1410(ra) # 80007128 <acquire>
  p->state = RUNNABLE;
  ...
  release(&p->lock);
    ...
    800016c4:	b1c080e7          	jalr	-1252(ra) # 800071dc <release>
}
...
00000000800016d2 <sleep>:
{
  ...
  if(lk != &p->lock){  //DOC: sleeplock0
    ...
    800016f6:	a36080e7          	jalr	-1482(ra) # 80007128 <acquire>
    release(lk);
    800016fa:	854a                	mv	a0,s2
    800016fc:	00006097          	auipc	ra,0x6
    80001700:	ae0080e7          	jalr	-1312(ra) # 800071dc <release>
  p->chan = chan;
  ...
  p->chan = 0;
    ...
    8000171e:	ac2080e7          	jalr	-1342(ra) # 800071dc <release>
    acquire(lk);
    80001722:	854a                	mv	a0,s2
    80001724:	00006097          	auipc	ra,0x6
    80001728:	a04080e7          	jalr	-1532(ra) # 80007128 <acquire>
}
...
0000000080001750 <wait>:
{
  ...
  acquire(&p->lock);
    ...
    8000177a:	9b2080e7          	jalr	-1614(ra) # 80007128 <acquire>
    havekids = 0;
    ...
    80001804:	928080e7          	jalr	-1752(ra) # 80007128 <acquire>
        if(np->state == ZOMBIE){
    ...
    80001814:	9cc080e7          	jalr	-1588(ra) # 800071dc <release>
        havekids = 1;
    ...
    8000182a:	9b6080e7          	jalr	-1610(ra) # 800071dc <release>
      return -1;
...
0000000080001858 <wakeup>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000188c:	954080e7          	jalr	-1708(ra) # 800071dc <release>
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000189e:	88e080e7          	jalr	-1906(ra) # 80007128 <acquire>
    if(p->state == SLEEPING && p->chan == chan) {
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800018e8:	844080e7          	jalr	-1980(ra) # 80007128 <acquire>
    if(p->pid == pid){
    ...
    800018f8:	8e8080e7          	jalr	-1816(ra) # 800071dc <release>
  for(p = proc; p < &proc[NPROC]; p++){
  ...
  return -1;
    ...
    8000191a:	8c6080e7          	jalr	-1850(ra) # 800071dc <release>
      return 0;
...
procdump(void)
{
  ...
  printf("\n");
    ...
    80001a02:	22a080e7          	jalr	554(ra) # 80006c28 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80001a44:	1e8080e7          	jalr	488(ra) # 80006c28 <printf>
    printf("\n");
    80001a48:	8552                	mv	a0,s4
    80001a4a:	00005097          	auipc	ra,0x5
    80001a4e:	1de080e7          	jalr	478(ra) # 80006c28 <printf>
  for(p = proc; p < &proc[NPROC]; p++){
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001b14:	588080e7          	jalr	1416(ra) # 80007098 <initlock>
}
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bee:	53e080e7          	jalr	1342(ra) # 80007128 <acquire>
  ticks++;
  ...
  release(&tickslock);
    ...
    80001c0e:	5d2080e7          	jalr	1490(ra) # 800071dc <release>
}
...
devintr()
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80001c7e:	fae080e7          	jalr	-82(ra) # 80006c28 <printf>
    80001c82:	a029                	j	80001c8c <devintr+0x70>
      uartintr();
    80001c84:	00005097          	auipc	ra,0x5
    80001c88:	3c4080e7          	jalr	964(ra) # 80007048 <uartintr>
      plic_complete(irq);
    ...
    80001ca8:	d66080e7          	jalr	-666(ra) # 80005a0a <e1000_intr>
...
0000000080001cd0 <usertrap>:
{
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d22:	51c080e7          	jalr	1308(ra) # 8000723a <lockfree_read4>
    ...
    80001d36:	eac080e7          	jalr	-340(ra) # 80006bde <panic>
    if(lockfree_read4(&p->killed))
    80001d3a:	03050513          	addi	a0,a0,48
    80001d3e:	00005097          	auipc	ra,0x5
    80001d42:	4fc080e7          	jalr	1276(ra) # 8000723a <lockfree_read4>
  ...
  if(lockfree_read4(&p->killed))
    ...
    80001d6c:	4d2080e7          	jalr	1234(ra) # 8000723a <lockfree_read4>
  ...
  asm volatile("csrr %0, scause" : "=r" (x) );
    ...
    80001db6:	e76080e7          	jalr	-394(ra) # 80006c28 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
  ...
  asm volatile("csrr %0, stval" : "=r" (x) );
    ...
    80001dce:	e5e080e7          	jalr	-418(ra) # 80006c28 <printf>
    p->killed = 1;
...
0000000080001de2 <kerneltrap>:
{
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001e3c:	da6080e7          	jalr	-602(ra) # 80006bde <panic>
    ...
    80001e4c:	d96080e7          	jalr	-618(ra) # 80006bde <panic>
    printf("scause %p\n", scause);
    ...
    80001e5e:	dce080e7          	jalr	-562(ra) # 80006c28 <printf>
  asm volatile("csrr %0, sepc" : "=r" (x) );
...
argraw(int n)
{
  ...
  panic("argraw");
    ...
    80001f12:	cd0080e7          	jalr	-816(ra) # 80006bde <panic>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    8000207a:	bb2080e7          	jalr	-1102(ra) # 80006c28 <printf>
            p->pid, p->name, num);
    p->trapframe->a0 = -1;
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    800021a0:	f8c080e7          	jalr	-116(ra) # 80007128 <acquire>
  ticks0 = ticks;
  ...
  release(&tickslock);
    ...
    800021f4:	fec080e7          	jalr	-20(ra) # 800071dc <release>
  return 0;
    ...
    80002216:	fca080e7          	jalr	-54(ra) # 800071dc <release>
      return -1;
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002266:	ec6080e7          	jalr	-314(ra) # 80007128 <acquire>
  xticks = ticks;
  ...
  release(&tickslock);
    ...
    8000227e:	f62080e7          	jalr	-158(ra) # 800071dc <release>
  return xticks;
}
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    800022b6:	de6080e7          	jalr	-538(ra) # 80007098 <initlock>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    8000233e:	dee080e7          	jalr	-530(ra) # 80007128 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    ...
    8000237e:	e62080e7          	jalr	-414(ra) # 800071dc <release>
      acquiresleep(&b->lock);
  ...
  panic("bget: no buffers");
    ...
    800023bc:	826080e7          	jalr	-2010(ra) # 80006bde <panic>
      b->dev = dev;
    ...
    800023dc:	e04080e7          	jalr	-508(ra) # 800071dc <release>
      acquiresleep(&b->lock);
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    8000244c:	796080e7          	jalr	1942(ra) # 80006bde <panic>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002484:	ca8080e7          	jalr	-856(ra) # 80007128 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    800024ce:	d12080e7          	jalr	-750(ra) # 800071dc <release>
}
    ...
    800024ea:	6f8080e7          	jalr	1784(ra) # 80006bde <panic>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002506:	c26080e7          	jalr	-986(ra) # 80007128 <acquire>
  b->refcnt++;
  ...
  release(&bcache.lock);
    ...
    8000251c:	cc4080e7          	jalr	-828(ra) # 800071dc <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    80002542:	bea080e7          	jalr	-1046(ra) # 80007128 <acquire>
  b->refcnt--;
  ...
  release(&bcache.lock);
    ...
    80002558:	c88080e7          	jalr	-888(ra) # 800071dc <release>
}
...
bfree(int dev, uint b)
{
  ...
  brelse(bp);
    ...
    800025de:	604080e7          	jalr	1540(ra) # 80006bde <panic>
...
00000000800025e2 <balloc>:
{
  ...
  panic("balloc: out of blocks");
    ...
    800026a4:	53e080e7          	jalr	1342(ra) # 80006bde <panic>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800027ea:	3f8080e7          	jalr	1016(ra) # 80006bde <panic>
...
00000000800027ee <iget>:
{
  ...
  acquire(&icache.lock);
    ...
    8000280e:	91e080e7          	jalr	-1762(ra) # 80007128 <acquire>
  empty = 0;
  ...
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
    ...
    80002854:	98c080e7          	jalr	-1652(ra) # 800071dc <release>
      return ip;
  ...
  release(&icache.lock);
    ...
    80002884:	95c080e7          	jalr	-1700(ra) # 800071dc <release>
}
    ...
    800028a6:	33c080e7          	jalr	828(ra) # 80006bde <panic>
...
fsinit(int dev) {
  ...
  initlog(dev, &sb);
    ...
    80002926:	2bc080e7          	jalr	700(ra) # 80006bde <panic>
...
000000008000292a <iinit>:
{
  ...
  initlock(&icache.lock, "icache");
    ...
    8000294c:	750080e7          	jalr	1872(ra) # 80007098 <initlock>
  for(i = 0; i < NINODE; i++) {
...
000000008000298a <ialloc>:
{
  ...
  panic("ialloc: no inodes");
    ...
    80002a0a:	1d8080e7          	jalr	472(ra) # 80006bde <panic>
...
0000000080002ae4 <idup>:
{
  ...
  acquire(&icache.lock);
    ...
    80002afc:	630080e7          	jalr	1584(ra) # 80007128 <acquire>
  ip->ref++;
  ...
  release(&icache.lock);
    ...
    80002b12:	6ce080e7          	jalr	1742(ra) # 800071dc <release>
}
...
0000000080002b22 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80002b5e:	084080e7          	jalr	132(ra) # 80006bde <panic>
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80002be0:	002080e7          	jalr	2(ra) # 80006bde <panic>
...
0000000080002be4 <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    80002c2c:	fb6080e7          	jalr	-74(ra) # 80006bde <panic>
...
0000000080002cdc <iput>:
{
  ...
  acquire(&icache.lock);
    ...
    80002cf6:	436080e7          	jalr	1078(ra) # 80007128 <acquire>
  ...
  release(&icache.lock);
    ...
    80002d14:	4cc080e7          	jalr	1228(ra) # 800071dc <release>
}
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80002d48:	498080e7          	jalr	1176(ra) # 800071dc <release>
    itrunc(ip);
    ...
    80002d7e:	3ae080e7          	jalr	942(ra) # 80007128 <acquire>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    8000303c:	ba6080e7          	jalr	-1114(ra) # 80006bde <panic>
    ...
    8000304c:	b96080e7          	jalr	-1130(ra) # 80006bde <panic>
  for(off = 0; off < dp->size; off += sizeof(de)){
...
0000000080003450 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003478:	c24080e7          	jalr	-988(ra) # 80007098 <initlock>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000350c:	c20080e7          	jalr	-992(ra) # 80007128 <acquire>
  while(1){
    if(log.committing){
    ...
    80003564:	c7c080e7          	jalr	-900(ra) # 800071dc <release>
      break;
    }
  }
}
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003594:	b98080e7          	jalr	-1128(ra) # 80007128 <acquire>
  log.outstanding -= 1;
  ...
  release(&log.lock);
    ...
    800035bc:	c24080e7          	jalr	-988(ra) # 800071dc <release>
}
...
commit()
{
  if (log.lh.n > 0) {
    ...
    800035d4:	b58080e7          	jalr	-1192(ra) # 80007128 <acquire>
    log.committing = 0;
    ...
    800035ec:	bf4080e7          	jalr	-1036(ra) # 800071dc <release>
}
    ...
    8000360e:	5d4080e7          	jalr	1492(ra) # 80006bde <panic>
    wakeup(&log);
  ...
  release(&log.lock);
    ...
    8000362a:	bb6080e7          	jalr	-1098(ra) # 800071dc <release>
  if(do_commit){
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003710:	a1c080e7          	jalr	-1508(ra) # 80007128 <acquire>
  for (i = 0; i < log.lh.n; i++) {
  ...
  release(&log.lock);
    ...
    800037aa:	a36080e7          	jalr	-1482(ra) # 800071dc <release>
}
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    800037d8:	8c4080e7          	jalr	-1852(ra) # 80007098 <initlock>
  lk->name = name;
...
acquiresleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    8000380c:	920080e7          	jalr	-1760(ra) # 80007128 <acquire>
  while (lk->locked) {
  ...
  release(&lk->lk);
    ...
    8000383a:	9a6080e7          	jalr	-1626(ra) # 800071dc <release>
}
...
releasesleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    80003862:	8ca080e7          	jalr	-1846(ra) # 80007128 <acquire>
  lk->locked = 0;
  ...
  release(&lk->lk);
    ...
    8000387e:	962080e7          	jalr	-1694(ra) # 800071dc <release>
}
...
holdingsleep(struct sleeplock *lk)
{
  ...
  acquire(&lk->lk);
    ...
    800038a8:	884080e7          	jalr	-1916(ra) # 80007128 <acquire>
  ...
  release(&lk->lk);
    ...
    800038b8:	928080e7          	jalr	-1752(ra) # 800071dc <release>
  return r;
}
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003900:	79c080e7          	jalr	1948(ra) # 80007098 <initlock>
}
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    80003922:	80a080e7          	jalr	-2038(ra) # 80007128 <acquire>
  ...
  release(&ftable.lock);
    ...
    8000394e:	892080e7          	jalr	-1902(ra) # 800071dc <release>
  return 0;
    ...
    80003966:	87a080e7          	jalr	-1926(ra) # 800071dc <release>
}
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000398e:	79e080e7          	jalr	1950(ra) # 80007128 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    800039a8:	838080e7          	jalr	-1992(ra) # 800071dc <release>
  return f;
}
    ...
    800039c4:	21e080e7          	jalr	542(ra) # 80006bde <panic>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    800039ea:	742080e7          	jalr	1858(ra) # 80007128 <acquire>
  if(f->ref < 1)
  ...
  release(&ftable.lock);
    ...
    80003a28:	7b8080e7          	jalr	1976(ra) # 800071dc <release>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a48:	93c080e7          	jalr	-1732(ra) # 80006380 <sockclose>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003b58:	8bc080e7          	jalr	-1860(ra) # 80006410 <sockread>
  ...
  return r;
    ...
    80003be4:	ffe080e7          	jalr	-2(ra) # 80006bde <panic>
    return -1;
    ...
    80003bf8:	12078263          	beqz	a5,80003d1c <filewrite+0x128>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003c3a:	8aa080e7          	jalr	-1878(ra) # 800064e0 <sockwrite>
  else {
    panic("filewrite");
  }
  ...
  return ret;
    ...
    80003d18:	eca080e7          	jalr	-310(ra) # 80006bde <panic>
    return -1;
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80003d88:	314080e7          	jalr	788(ra) # 80007098 <initlock>
  (*f0)->type = FD_PIPE;
...
pipeclose(struct pipe *pi, int writable)
{
  ...
  acquire(&pi->lock);
    ...
    80003e16:	316080e7          	jalr	790(ra) # 80007128 <acquire>
  if(writable){
  ...
  if(pi->readopen == 0 && pi->writeopen == 0){
    ...
    80003e3a:	3a6080e7          	jalr	934(ra) # 800071dc <release>
    kfree((char*)pi);
    ...
    80003e6c:	374080e7          	jalr	884(ra) # 800071dc <release>
}
...
pipewrite(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003ea2:	28a080e7          	jalr	650(ra) # 80007128 <acquire>
  while(i < n){
  ...
  int i = 0;
    ...
    80003ec0:	320080e7          	jalr	800(ra) # 800071dc <release>
      return -1;
  ...
  release(&pi->lock);
    ...
    80003f62:	27e080e7          	jalr	638(ra) # 800071dc <release>
  return i;
...
piperead(struct pipe *pi, uint64 addr, int n)
{
  ...
  acquire(&pi->lock);
    ...
    80003f98:	194080e7          	jalr	404(ra) # 80007128 <acquire>
  ...
  release(&pi->lock);
    ...
    8000402c:	1b4080e7          	jalr	436(ra) # 800071dc <release>
  return i;
}
    ...
    8000404c:	194080e7          	jalr	404(ra) # 800071dc <release>
      return -1;
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004154:	a8e080e7          	jalr	-1394(ra) # 80006bde <panic>
    if(sz - i < PGSIZE)
      n = sz - i;
    else
      n = PGSIZE;
...
create(char *path, short type, short major, short minor)
{
  ...
  return ip;
    ...
    80004586:	65c080e7          	jalr	1628(ra) # 80006bde <panic>
    dp->nlink++;  // for ".."
...
00000000800048f4 <sys_unlink>:
{
  ...
  return 0;
    ...
    80004a20:	1c2080e7          	jalr	450(ra) # 80006bde <panic>
...
sys_connect(void)
{
  ...
  if(sockalloc(&f, raddr, lport, rport) < 0)
    ...
    8000505e:	200080e7          	jalr	512(ra) # 8000625a <sockalloc>
...
00000000800052ac <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    800052ca:	dd2080e7          	jalr	-558(ra) # 80007098 <initlock>
  ...
  *R(VIRTIO_MMIO_QUEUE_PFN) = ((uint64)disk.pages) >> PGSHIFT;
  ...
  disk.used = (struct virtq_used *) (disk.pages + PGSIZE);
    ...
    800053cc:	816080e7          	jalr	-2026(ra) # 80006bde <panic>
    ...
    800053dc:	806080e7          	jalr	-2042(ra) # 80006bde <panic>
    ...
    800053ec:	7f6080e7          	jalr	2038(ra) # 80006bde <panic>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    8000542a:	d02080e7          	jalr	-766(ra) # 80007128 <acquire>
  for(int i = 0; i < 3; i++){
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  release(&disk.vdisk_lock);
    ...
    80005664:	b7c080e7          	jalr	-1156(ra) # 800071dc <release>
}
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800056de:	a4e080e7          	jalr	-1458(ra) # 80007128 <acquire>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005770:	a70080e7          	jalr	-1424(ra) # 800071dc <release>
}
    ...
    8000578c:	456080e7          	jalr	1110(ra) # 80006bde <panic>
...
e1000_init(uint32 *xregs)
{
  ...
  initlock(&e1000_lock, "e1000");
    ...
    800057b4:	8e8080e7          	jalr	-1816(ra) # 80007098 <initlock>
  ...
  for (i = 0; i < RX_RING_SIZE; i++) {
    ...
    8000586e:	40a080e7          	jalr	1034(ra) # 80005c74 <mbufalloc>
  ...
  regs[E1000_IMS] = (1 << 7); // RXDW -- Receiver Descriptor Write Back
    ...
    80005930:	2b2080e7          	jalr	690(ra) # 80006bde <panic>
...
e1000_transmit(struct mbuf *m)
{
  ...
  acquire(&e1000_lock);
    ...
    80005952:	7da080e7          	jalr	2010(ra) # 80007128 <acquire>
  ...
  int idx = regs[E1000_TDT];
    ...
    80005962:	8187a483          	lw	s1,-2024(a5)
    80005966:	2481                	sext.w	s1,s1

  if ((tx_ring[idx].status & E1000_TXD_STAT_DD) == 0) {
    80005968:	00449793          	slli	a5,s1,0x4
    8000596c:	99be                	add	s3,s3,a5
    8000596e:	02c9c783          	lbu	a5,44(s3)
    80005972:	8b85                	andi	a5,a5,1
    80005974:	c3c9                	beqz	a5,800059f6 <e1000_transmit+0xc2>
    release(&e1000_lock);
    return -1;
  }
  ...
  if (tx_mbufs[idx])
    80005976:	00349713          	slli	a4,s1,0x3
    8000597a:	00019797          	auipc	a5,0x19
    8000597e:	68678793          	addi	a5,a5,1670 # 8001f000 <e1000_lock>
    80005982:	97ba                	add	a5,a5,a4
    80005984:	1207b503          	ld	a0,288(a5)
    80005988:	c509                	beqz	a0,80005992 <e1000_transmit+0x5e>
    mbuffree(tx_mbufs[idx]);
    8000598a:	00000097          	auipc	ra,0x0
    8000598e:	342080e7          	jalr	834(ra) # 80005ccc <mbuffree>
  // stuff the packet into tx buffer

  tx_mbufs[idx] = m;
    80005992:	00019517          	auipc	a0,0x19
    80005996:	66e50513          	addi	a0,a0,1646 # 8001f000 <e1000_lock>
    8000599a:	00349793          	slli	a5,s1,0x3
    8000599e:	97aa                	add	a5,a5,a0
    800059a0:	1327b023          	sd	s2,288(a5)
  tx_ring[idx].length = m->len;
    800059a4:	00449793          	slli	a5,s1,0x4
    800059a8:	97aa                	add	a5,a5,a0
    800059aa:	01092703          	lw	a4,16(s2)
    800059ae:	02e79423          	sh	a4,40(a5)
  tx_ring[idx].addr = (uint64) m->head;
    800059b2:	00893703          	ld	a4,8(s2)
    800059b6:	f398                	sd	a4,32(a5)
  tx_ring[idx].cmd = E1000_TXD_CMD_RS | E1000_TXD_CMD_EOP;
    800059b8:	4725                	li	a4,9
    800059ba:	02e785a3          	sb	a4,43(a5)
  regs[E1000_TDT] = (idx + 1) % TX_RING_SIZE;
    800059be:	2485                	addiw	s1,s1,1
    800059c0:	41f4d79b          	sraiw	a5,s1,0x1f
    800059c4:	01c7d79b          	srliw	a5,a5,0x1c
    800059c8:	9cbd                	addw	s1,s1,a5
    800059ca:	88bd                	andi	s1,s1,15
    800059cc:	9c9d                	subw	s1,s1,a5
    800059ce:	00004797          	auipc	a5,0x4
    800059d2:	6527b783          	ld	a5,1618(a5) # 8000a020 <regs>
    800059d6:	6711                	lui	a4,0x4
    800059d8:	97ba                	add	a5,a5,a4
    800059da:	8097ac23          	sw	s1,-2024(a5)

  release(&e1000_lock);
    800059de:	00001097          	auipc	ra,0x1
    800059e2:	7fe080e7          	jalr	2046(ra) # 800071dc <release>
  return 0;
    ...
    800059ee:	6942                	ld	s2,16(sp)
    800059f0:	69a2                	ld	s3,8(sp)
    800059f2:	6145                	addi	sp,sp,48
    800059f4:	8082                	ret
    release(&e1000_lock);
    800059f6:	00019517          	auipc	a0,0x19
    800059fa:	60a50513          	addi	a0,a0,1546 # 8001f000 <e1000_lock>
    800059fe:	00001097          	auipc	ra,0x1
    80005a02:	7de080e7          	jalr	2014(ra) # 800071dc <release>
    return -1;
    80005a06:	557d                	li	a0,-1
    80005a08:	b7c5                	j	800059e8 <e1000_transmit+0xb4>

0000000080005a0a <e1000_intr>:
  }
}
...
e1000_intr(void)
{
    ...
    80005a12:	f04a                	sd	s2,32(sp)
    80005a14:	ec4e                	sd	s3,24(sp)
    80005a16:	e852                	sd	s4,16(sp)
    80005a18:	e456                	sd	s5,8(sp)
    80005a1a:	e05a                	sd	s6,0(sp)
  ...
  regs[E1000_ICR] = 0xffffffff;
    ...
    80005a26:	577d                	li	a4,-1
    80005a28:	0ce7a023          	sw	a4,192(a5)
    int idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005a2c:	670d                	lui	a4,0x3
    80005a2e:	97ba                	add	a5,a5,a4
    80005a30:	8187a483          	lw	s1,-2024(a5)
    80005a34:	2485                	addiw	s1,s1,1
    80005a36:	88bd                	andi	s1,s1,15
    if ((rx_ring[idx].status & E1000_RXD_STAT_DD) == 0) {
    80005a38:	00449713          	slli	a4,s1,0x4
    80005a3c:	00019797          	auipc	a5,0x19
    80005a40:	5c478793          	addi	a5,a5,1476 # 8001f000 <e1000_lock>
    80005a44:	97ba                	add	a5,a5,a4
    80005a46:	1ac7c783          	lbu	a5,428(a5)
    80005a4a:	8b85                	andi	a5,a5,1
    80005a4c:	cba5                	beqz	a5,80005abc <e1000_intr+0xb2>
    rx_mbufs[idx]->len = rx_ring[idx].length;
    80005a4e:	00019a17          	auipc	s4,0x19
    80005a52:	5b2a0a13          	addi	s4,s4,1458 # 8001f000 <e1000_lock>
    regs[E1000_RDT] = idx;
    80005a56:	00004b17          	auipc	s6,0x4
    80005a5a:	5cab0b13          	addi	s6,s6,1482 # 8000a020 <regs>
    80005a5e:	6a8d                	lui	s5,0x3
    rx_mbufs[idx]->len = rx_ring[idx].length;
    80005a60:	00349993          	slli	s3,s1,0x3
    80005a64:	99d2                	add	s3,s3,s4
    80005a66:	2a09b783          	ld	a5,672(s3)
    80005a6a:	00449913          	slli	s2,s1,0x4
    80005a6e:	9952                	add	s2,s2,s4
    80005a70:	1a895703          	lhu	a4,424(s2)
    80005a74:	cb98                	sw	a4,16(a5)
    net_rx(rx_mbufs[idx]);
    80005a76:	2a09b503          	ld	a0,672(s3)
    80005a7a:	00000097          	auipc	ra,0x0
    80005a7e:	3c6080e7          	jalr	966(ra) # 80005e40 <net_rx>
    rx_mbufs[idx] = mbufalloc(0);
    80005a82:	4501                	li	a0,0
    80005a84:	00000097          	auipc	ra,0x0
    80005a88:	1f0080e7          	jalr	496(ra) # 80005c74 <mbufalloc>
    80005a8c:	2aa9b023          	sd	a0,672(s3)
    rx_ring[idx].status = 0;
    80005a90:	1a090623          	sb	zero,428(s2)
    rx_ring[idx].addr = (uint64)rx_mbufs[idx]->head;
    80005a94:	651c                	ld	a5,8(a0)
    80005a96:	1af93023          	sd	a5,416(s2)
    regs[E1000_RDT] = idx;
    80005a9a:	000b3783          	ld	a5,0(s6)
    80005a9e:	2481                	sext.w	s1,s1
    80005aa0:	97d6                	add	a5,a5,s5
    80005aa2:	8097ac23          	sw	s1,-2024(a5)
    int idx = (regs[E1000_RDT] + 1) % RX_RING_SIZE;
    80005aa6:	8187a483          	lw	s1,-2024(a5)
    80005aaa:	2485                	addiw	s1,s1,1
    80005aac:	88bd                	andi	s1,s1,15
    if ((rx_ring[idx].status & E1000_RXD_STAT_DD) == 0) {
    80005aae:	00449793          	slli	a5,s1,0x4
    80005ab2:	97d2                	add	a5,a5,s4
    80005ab4:	1ac7c783          	lbu	a5,428(a5)
    80005ab8:	8b85                	andi	a5,a5,1
    80005aba:	f3dd                	bnez	a5,80005a60 <e1000_intr+0x56>

  e1000_recv();
}
    80005abc:	70e2                	ld	ra,56(sp)
    80005abe:	7442                	ld	s0,48(sp)
    80005ac0:	74a2                	ld	s1,40(sp)
    80005ac2:	7902                	ld	s2,32(sp)
    80005ac4:	69e2                	ld	s3,24(sp)
    80005ac6:	6a42                	ld	s4,16(sp)
    80005ac8:	6aa2                	ld	s5,8(sp)
    80005aca:	6b02                	ld	s6,0(sp)
    80005acc:	6121                	addi	sp,sp,64
    80005ace:	8082                	ret

0000000080005ad0 <in_cksum>:
...
in_cksum(const unsigned char *addr, int len)
{
    ...
    80005ad2:	ec22                	sd	s0,24(sp)
    80005ad4:	1000                	addi	s0,sp,32
  int nleft = len;
  const unsigned short *w = (const unsigned short *)addr;
  unsigned int sum = 0;
  unsigned short answer = 0;
    80005ad6:	fe041723          	sh	zero,-18(s0)
  /*
  ...
  while (nleft > 1)  {
    ...
    80005adc:	04b7d963          	bge	a5,a1,80005b2e <in_cksum+0x5e>
    80005ae0:	ffe5879b          	addiw	a5,a1,-2
    80005ae4:	0017d61b          	srliw	a2,a5,0x1
    80005ae8:	0017d71b          	srliw	a4,a5,0x1
    80005aec:	0705                	addi	a4,a4,1
    80005aee:	0706                	slli	a4,a4,0x1
    80005af0:	972a                	add	a4,a4,a0
  unsigned int sum = 0;
    80005af2:	4781                	li	a5,0
    sum += *w++;
    80005af4:	0509                	addi	a0,a0,2
    80005af6:	ffe55683          	lhu	a3,-2(a0)
    80005afa:	9fb5                	addw	a5,a5,a3
  while (nleft > 1)  {
    80005afc:	fee51ce3          	bne	a0,a4,80005af4 <in_cksum+0x24>
    80005b00:	35f9                	addiw	a1,a1,-2
    80005b02:	0016169b          	slliw	a3,a2,0x1
    80005b06:	9d95                	subw	a1,a1,a3
    nleft -= 2;
  }
  ...
  if (nleft == 1) {
    ...
    80005b0a:	02d58563          	beq	a1,a3,80005b34 <in_cksum+0x64>
  ...
  sum = (sum & 0xffff) + (sum >> 16);
    80005b0e:	03079513          	slli	a0,a5,0x30
    80005b12:	9141                	srli	a0,a0,0x30
    80005b14:	0107d79b          	srliw	a5,a5,0x10
    80005b18:	9fa9                	addw	a5,a5,a0
  sum += (sum >> 16);
    80005b1a:	0107d51b          	srliw	a0,a5,0x10
  /* guaranteed now that the lower 16 bits of sum are correct */

  answer = ~sum; /* truncate to 16 bits */
    80005b1e:	9d3d                	addw	a0,a0,a5
    80005b20:	fff54513          	not	a0,a0
  return answer;
}
    80005b24:	1542                	slli	a0,a0,0x30
    80005b26:	9141                	srli	a0,a0,0x30
    80005b28:	6462                	ld	s0,24(sp)
    80005b2a:	6105                	addi	sp,sp,32
    80005b2c:	8082                	ret
  const unsigned short *w = (const unsigned short *)addr;
    80005b2e:	872a                	mv	a4,a0
  unsigned int sum = 0;
    80005b30:	4781                	li	a5,0
    80005b32:	bfd9                	j	80005b08 <in_cksum+0x38>
    *(unsigned char *)(&answer) = *(const unsigned char *)w;
    80005b34:	00074703          	lbu	a4,0(a4) # 3000 <_entry-0x7fffd000>
    80005b38:	fee40723          	sb	a4,-18(s0)
    sum += answer;
    80005b3c:	fee45703          	lhu	a4,-18(s0)
    80005b40:	9fb9                	addw	a5,a5,a4
    80005b42:	b7f1                	j	80005b0e <in_cksum+0x3e>

0000000080005b44 <mbufpull>:
{
    80005b44:	1141                	addi	sp,sp,-16
    80005b46:	e422                	sd	s0,8(sp)
    80005b48:	0800                	addi	s0,sp,16
    80005b4a:	87aa                	mv	a5,a0
  char *tmp = m->head;
    80005b4c:	6508                	ld	a0,8(a0)
  if (m->len < len)
    80005b4e:	4b98                	lw	a4,16(a5)
    80005b50:	00b76b63          	bltu	a4,a1,80005b66 <mbufpull+0x22>
  m->len -= len;
    80005b54:	9f0d                	subw	a4,a4,a1
    80005b56:	cb98                	sw	a4,16(a5)
  m->head += len;
    80005b58:	1582                	slli	a1,a1,0x20
    80005b5a:	9181                	srli	a1,a1,0x20
    80005b5c:	95aa                	add	a1,a1,a0
    80005b5e:	e78c                	sd	a1,8(a5)
}
    80005b60:	6422                	ld	s0,8(sp)
    80005b62:	0141                	addi	sp,sp,16
    80005b64:	8082                	ret
    return 0;
    80005b66:	4501                	li	a0,0
    80005b68:	bfe5                	j	80005b60 <mbufpull+0x1c>

0000000080005b6a <mbufpush>:
{
    80005b6a:	87aa                	mv	a5,a0
  m->head -= len;
    80005b6c:	02059713          	slli	a4,a1,0x20
    80005b70:	9301                	srli	a4,a4,0x20
    80005b72:	6508                	ld	a0,8(a0)
    80005b74:	8d19                	sub	a0,a0,a4
    80005b76:	e788                	sd	a0,8(a5)
  if (m->head < m->buf)
    80005b78:	01478713          	addi	a4,a5,20
    80005b7c:	00e56663          	bltu	a0,a4,80005b88 <mbufpush+0x1e>
  m->len += len;
    80005b80:	4b98                	lw	a4,16(a5)
    80005b82:	9db9                	addw	a1,a1,a4
    80005b84:	cb8c                	sw	a1,16(a5)
}
    80005b86:	8082                	ret
{
    ...
    80005b94:	c3050513          	addi	a0,a0,-976 # 800097c0 <syscalls+0x410>
    80005b98:	00001097          	auipc	ra,0x1
    80005b9c:	046080e7          	jalr	70(ra) # 80006bde <panic>

0000000080005ba0 <net_tx_eth>:
...
net_tx_eth(struct mbuf *m, uint16 ethtype)
{
    ...
    80005bb0:	892e                	mv	s2,a1
  struct eth *ethhdr;

  ethhdr = mbufpushhdr(m, *ethhdr);
    80005bb2:	45b9                	li	a1,14
    80005bb4:	00000097          	auipc	ra,0x0
    80005bb8:	fb6080e7          	jalr	-74(ra) # 80005b6a <mbufpush>
    80005bbc:	84aa                	mv	s1,a0
  memmove(ethhdr->shost, local_mac, ETHADDR_LEN);
    80005bbe:	4619                	li	a2,6
    80005bc0:	00004597          	auipc	a1,0x4
    80005bc4:	cc058593          	addi	a1,a1,-832 # 80009880 <local_mac>
    80005bc8:	0519                	addi	a0,a0,6
    80005bca:	ffffa097          	auipc	ra,0xffffa
    80005bce:	60e080e7          	jalr	1550(ra) # 800001d8 <memmove>
  // In a real networking stack, dhost would be set to the address discovered
  // through ARP. Because we don't support enough of the ARP protocol, set it
  // to broadcast instead.
  memmove(ethhdr->dhost, broadcast_mac, ETHADDR_LEN);
    80005bd2:	4619                	li	a2,6
    80005bd4:	00004597          	auipc	a1,0x4
    80005bd8:	ca458593          	addi	a1,a1,-860 # 80009878 <broadcast_mac>
    80005bdc:	8526                	mv	a0,s1
    80005bde:	ffffa097          	auipc	ra,0xffffa
    80005be2:	5fa080e7          	jalr	1530(ra) # 800001d8 <memmove>
// endianness support
//
...
static inline uint16 bswaps(uint16 val)
{
  return (((val & 0x00ffU) << 8) |
    80005be6:	0089579b          	srliw	a5,s2,0x8
  ethhdr->type = htons(ethtype);
    80005bea:	00f48623          	sb	a5,12(s1)
    80005bee:	012486a3          	sb	s2,13(s1)
  if (e1000_transmit(m)) {
    80005bf2:	854e                	mv	a0,s3
    80005bf4:	00000097          	auipc	ra,0x0
    80005bf8:	d40080e7          	jalr	-704(ra) # 80005934 <e1000_transmit>
    80005bfc:	e901                	bnez	a0,80005c0c <net_tx_eth+0x6c>
    mbuffree(m);
  }
}
  ...
  kfree(m);
    ...
    80005c0e:	ffffa097          	auipc	ra,0xffffa
    80005c12:	40e080e7          	jalr	1038(ra) # 8000001c <kfree>
}
    80005c16:	b7e5                	j	80005bfe <net_tx_eth+0x5e>

0000000080005c18 <mbufput>:
{
    80005c18:	87aa                	mv	a5,a0
  char *tmp = m->head + m->len;
    80005c1a:	4918                	lw	a4,16(a0)
    80005c1c:	02071693          	slli	a3,a4,0x20
    80005c20:	9281                	srli	a3,a3,0x20
    80005c22:	6508                	ld	a0,8(a0)
    80005c24:	9536                	add	a0,a0,a3
  m->len += len;
    80005c26:	9f2d                	addw	a4,a4,a1
    80005c28:	0007069b          	sext.w	a3,a4
    80005c2c:	cb98                	sw	a4,16(a5)
  if (m->len > MBUF_SIZE)
    80005c2e:	6785                	lui	a5,0x1
    80005c30:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    80005c34:	00d7e363          	bltu	a5,a3,80005c3a <mbufput+0x22>
}
    80005c38:	8082                	ret
{
    ...
    80005c46:	b8e50513          	addi	a0,a0,-1138 # 800097d0 <syscalls+0x420>
    80005c4a:	00001097          	auipc	ra,0x1
    80005c4e:	f94080e7          	jalr	-108(ra) # 80006bde <panic>

0000000080005c52 <mbuftrim>:
{
    80005c52:	1141                	addi	sp,sp,-16
    80005c54:	e422                	sd	s0,8(sp)
    80005c56:	0800                	addi	s0,sp,16
  if (len > m->len)
    80005c58:	491c                	lw	a5,16(a0)
    80005c5a:	00b7eb63          	bltu	a5,a1,80005c70 <mbuftrim+0x1e>
  m->len -= len;
    80005c5e:	9f8d                	subw	a5,a5,a1
    80005c60:	c91c                	sw	a5,16(a0)
  return m->head + m->len;
    80005c62:	1782                	slli	a5,a5,0x20
    80005c64:	9381                	srli	a5,a5,0x20
    80005c66:	6508                	ld	a0,8(a0)
    ...
    80005c72:	bfe5                	j	80005c6a <mbuftrim+0x18>

0000000080005c74 <mbufalloc>:
{
    80005c74:	1101                	addi	sp,sp,-32
    80005c76:	ec06                	sd	ra,24(sp)
    80005c78:	e822                	sd	s0,16(sp)
    80005c7a:	e426                	sd	s1,8(sp)
    80005c7c:	e04a                	sd	s2,0(sp)
    80005c7e:	1000                	addi	s0,sp,32
  if (headroom > MBUF_SIZE)
    80005c80:	6785                	lui	a5,0x1
    80005c82:	80078793          	addi	a5,a5,-2048 # 800 <_entry-0x7ffff800>
    return 0;
    80005c86:	4901                	li	s2,0
  if (headroom > MBUF_SIZE)
    80005c88:	02a7eb63          	bltu	a5,a0,80005cbe <mbufalloc+0x4a>
    80005c8c:	84aa                	mv	s1,a0
  m = kalloc();
    80005c8e:	ffffa097          	auipc	ra,0xffffa
    80005c92:	48a080e7          	jalr	1162(ra) # 80000118 <kalloc>
    80005c96:	892a                	mv	s2,a0
  if (m == 0)
    80005c98:	c11d                	beqz	a0,80005cbe <mbufalloc+0x4a>
  m->next = 0;
    80005c9a:	00053023          	sd	zero,0(a0)
  m->head = (char *)m->buf + headroom;
    80005c9e:	0551                	addi	a0,a0,20
    80005ca0:	1482                	slli	s1,s1,0x20
    80005ca2:	9081                	srli	s1,s1,0x20
    80005ca4:	94aa                	add	s1,s1,a0
    80005ca6:	00993423          	sd	s1,8(s2)
  m->len = 0;
    80005caa:	00092823          	sw	zero,16(s2)
  memset(m->buf, 0, sizeof(m->buf));
    80005cae:	6605                	lui	a2,0x1
    80005cb0:	80060613          	addi	a2,a2,-2048 # 800 <_entry-0x7ffff800>
    80005cb4:	4581                	li	a1,0
    80005cb6:	ffffa097          	auipc	ra,0xffffa
    80005cba:	4c2080e7          	jalr	1218(ra) # 80000178 <memset>
}
    80005cbe:	854a                	mv	a0,s2
    80005cc0:	60e2                	ld	ra,24(sp)
    80005cc2:	6442                	ld	s0,16(sp)
    80005cc4:	64a2                	ld	s1,8(sp)
    80005cc6:	6902                	ld	s2,0(sp)
    80005cc8:	6105                	addi	sp,sp,32
    80005cca:	8082                	ret

0000000080005ccc <mbuffree>:
{
  ...
  kfree(m);
    ...
    80005cd8:	348080e7          	jalr	840(ra) # 8000001c <kfree>
}
...
0000000080005ce4 <mbufq_pushtail>:
{
    80005ce4:	1141                	addi	sp,sp,-16
    80005ce6:	e422                	sd	s0,8(sp)
    80005ce8:	0800                	addi	s0,sp,16
  m->next = 0;
    80005cea:	0005b023          	sd	zero,0(a1)
  if (!q->head){
    80005cee:	611c                	ld	a5,0(a0)
    80005cf0:	c799                	beqz	a5,80005cfe <mbufq_pushtail+0x1a>
  q->tail->next = m;
    80005cf2:	651c                	ld	a5,8(a0)
    80005cf4:	e38c                	sd	a1,0(a5)
  q->tail = m;
    80005cf6:	e50c                	sd	a1,8(a0)
}
    80005cf8:	6422                	ld	s0,8(sp)
    80005cfa:	0141                	addi	sp,sp,16
    80005cfc:	8082                	ret
    q->head = q->tail = m;
    80005cfe:	e50c                	sd	a1,8(a0)
    80005d00:	e10c                	sd	a1,0(a0)
    return;
    80005d02:	bfdd                	j	80005cf8 <mbufq_pushtail+0x14>

0000000080005d04 <mbufq_pophead>:
{
    80005d04:	1141                	addi	sp,sp,-16
    80005d06:	e422                	sd	s0,8(sp)
    80005d08:	0800                	addi	s0,sp,16
    80005d0a:	87aa                	mv	a5,a0
  struct mbuf *head = q->head;
    80005d0c:	6108                	ld	a0,0(a0)
  if (!head)
    80005d0e:	c119                	beqz	a0,80005d14 <mbufq_pophead+0x10>
  q->head = head->next;
    80005d10:	6118                	ld	a4,0(a0)
    80005d12:	e398                	sd	a4,0(a5)
}
    80005d14:	6422                	ld	s0,8(sp)
    80005d16:	0141                	addi	sp,sp,16
    80005d18:	8082                	ret

0000000080005d1a <mbufq_empty>:
{
    80005d1a:	1141                	addi	sp,sp,-16
    80005d1c:	e422                	sd	s0,8(sp)
    80005d1e:	0800                	addi	s0,sp,16
  return q->head == 0;
    80005d20:	6108                	ld	a0,0(a0)
}
    80005d22:	00153513          	seqz	a0,a0
    80005d26:	6422                	ld	s0,8(sp)
    80005d28:	0141                	addi	sp,sp,16
    80005d2a:	8082                	ret

0000000080005d2c <mbufq_init>:
{
    80005d2c:	1141                	addi	sp,sp,-16
    80005d2e:	e422                	sd	s0,8(sp)
           ...
           uint16 sport, uint16 dport)
{
    ...
    80005d48:	e052                	sd	s4,0(sp)
    80005d4a:	1800                	addi	s0,sp,48
    80005d4c:	8a2a                	mv	s4,a0
    80005d4e:	892e                	mv	s2,a1
    80005d50:	89b2                	mv	s3,a2
    80005d52:	84b6                	mv	s1,a3
  struct udp *udphdr;

  // put the UDP header
  udphdr = mbufpushhdr(m, *udphdr);
    80005d54:	45a1                	li	a1,8
    80005d56:	00000097          	auipc	ra,0x0
    80005d5a:	e14080e7          	jalr	-492(ra) # 80005b6a <mbufpush>
    80005d5e:	0089d61b          	srliw	a2,s3,0x8
    80005d62:	0089999b          	slliw	s3,s3,0x8
    80005d66:	00c9e9b3          	or	s3,s3,a2
  udphdr->sport = htons(sport);
    80005d6a:	01351023          	sh	s3,0(a0)
    80005d6e:	0084d69b          	srliw	a3,s1,0x8
    80005d72:	0084949b          	slliw	s1,s1,0x8
    80005d76:	8cd5                	or	s1,s1,a3
  udphdr->dport = htons(dport);
    80005d78:	00951123          	sh	s1,2(a0)
  udphdr->ulen = htons(m->len);
    80005d7c:	010a2783          	lw	a5,16(s4)
    80005d80:	0087d713          	srli	a4,a5,0x8
    80005d84:	0087979b          	slliw	a5,a5,0x8
    80005d88:	0ff77713          	andi	a4,a4,255
    80005d8c:	8fd9                	or	a5,a5,a4
    80005d8e:	00f51223          	sh	a5,4(a0)
  udphdr->sum = 0; // zero means no checksum is provided
    80005d92:	00051323          	sh	zero,6(a0)
  iphdr = mbufpushhdr(m, *iphdr);
    80005d96:	45d1                	li	a1,20
    80005d98:	8552                	mv	a0,s4
    80005d9a:	00000097          	auipc	ra,0x0
    80005d9e:	dd0080e7          	jalr	-560(ra) # 80005b6a <mbufpush>
    80005da2:	84aa                	mv	s1,a0
  memset(iphdr, 0, sizeof(*iphdr));
    80005da4:	4651                	li	a2,20
    80005da6:	4581                	li	a1,0
    80005da8:	ffffa097          	auipc	ra,0xffffa
    80005dac:	3d0080e7          	jalr	976(ra) # 80000178 <memset>
  iphdr->ip_vhl = (4 << 4) | (20 >> 2);
    80005db0:	04500793          	li	a5,69
    80005db4:	00f48023          	sb	a5,0(s1)
  iphdr->ip_p = proto;
    80005db8:	47c5                	li	a5,17
    80005dba:	00f484a3          	sb	a5,9(s1)
  iphdr->ip_src = htonl(local_ip);
    80005dbe:	0f0207b7          	lui	a5,0xf020
    80005dc2:	27a9                	addiw	a5,a5,10
    80005dc4:	c4dc                	sw	a5,12(s1)
          ((val & 0xff00U) >> 8));
}
...
static inline uint32 bswapl(uint32 val)
{
  return (((val & 0x000000ffUL) << 24) |
    80005dc6:	0189179b          	slliw	a5,s2,0x18
          ((val & 0x0000ff00UL) << 8) |
          ((val & 0x00ff0000UL) >> 8) |
          ((val & 0xff000000UL) >> 24));
    80005dca:	0189571b          	srliw	a4,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005dce:	8fd9                	or	a5,a5,a4
          ((val & 0x0000ff00UL) << 8) |
    80005dd0:	0089171b          	slliw	a4,s2,0x8
    80005dd4:	00ff06b7          	lui	a3,0xff0
    80005dd8:	8f75                	and	a4,a4,a3
          ((val & 0x00ff0000UL) >> 8) |
    80005dda:	8fd9                	or	a5,a5,a4
    80005ddc:	0089591b          	srliw	s2,s2,0x8
    80005de0:	65c1                	lui	a1,0x10
    80005de2:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80005de6:	00b97933          	and	s2,s2,a1
    80005dea:	0127e933          	or	s2,a5,s2
  iphdr->ip_dst = htonl(dip);
    80005dee:	0124a823          	sw	s2,16(s1)
  iphdr->ip_len = htons(m->len);
    80005df2:	010a2783          	lw	a5,16(s4)
  return (((val & 0x00ffU) << 8) |
    80005df6:	0087d713          	srli	a4,a5,0x8
    80005dfa:	0087979b          	slliw	a5,a5,0x8
    80005dfe:	0ff77713          	andi	a4,a4,255
    80005e02:	8fd9                	or	a5,a5,a4
    80005e04:	00f49123          	sh	a5,2(s1)
  iphdr->ip_ttl = 100;
    80005e08:	06400793          	li	a5,100
    80005e0c:	00f48423          	sb	a5,8(s1)
  iphdr->ip_sum = in_cksum((unsigned char *)iphdr, sizeof(*iphdr));
    80005e10:	45d1                	li	a1,20
    80005e12:	8526                	mv	a0,s1
    80005e14:	00000097          	auipc	ra,0x0
    80005e18:	cbc080e7          	jalr	-836(ra) # 80005ad0 <in_cksum>
    80005e1c:	00a49523          	sh	a0,10(s1)
  net_tx_eth(m, ETHTYPE_IP);
    80005e20:	6585                	lui	a1,0x1
    80005e22:	80058593          	addi	a1,a1,-2048 # 800 <_entry-0x7ffff800>
    80005e26:	8552                	mv	a0,s4
    80005e28:	00000097          	auipc	ra,0x0
    80005e2c:	d78080e7          	jalr	-648(ra) # 80005ba0 <net_tx_eth>

  // now on to the IP layer
  net_tx_ip(m, IPPROTO_UDP, dip);
}
    80005e30:	70a2                	ld	ra,40(sp)
    80005e32:	7402                	ld	s0,32(sp)
    80005e34:	64e2                	ld	s1,24(sp)
    80005e36:	6942                	ld	s2,16(sp)
    80005e38:	69a2                	ld	s3,8(sp)
    80005e3a:	6a02                	ld	s4,0(sp)
    80005e3c:	6145                	addi	sp,sp,48
    80005e3e:	8082                	ret

0000000080005e40 <net_rx>:
}
...
{
    80005e40:	715d                	addi	sp,sp,-80
    80005e42:	e486                	sd	ra,72(sp)
    80005e44:	e0a2                	sd	s0,64(sp)
    80005e46:	fc26                	sd	s1,56(sp)
    80005e48:	f84a                	sd	s2,48(sp)
    80005e4a:	f44e                	sd	s3,40(sp)
    80005e4c:	f052                	sd	s4,32(sp)
    80005e4e:	ec56                	sd	s5,24(sp)
    80005e50:	0880                	addi	s0,sp,80
    80005e52:	84aa                	mv	s1,a0
  struct eth *ethhdr;
  uint16 type;

  ethhdr = mbufpullhdr(m, *ethhdr);
    80005e54:	45b9                	li	a1,14
    80005e56:	00000097          	auipc	ra,0x0
    80005e5a:	cee080e7          	jalr	-786(ra) # 80005b44 <mbufpull>
  if (!ethhdr) {
    80005e5e:	c521                	beqz	a0,80005ea6 <net_rx+0x66>
    mbuffree(m);
    return;
  }

  type = ntohs(ethhdr->type);
    80005e60:	00c54783          	lbu	a5,12(a0)
    80005e64:	00d54703          	lbu	a4,13(a0)
    80005e68:	0722                	slli	a4,a4,0x8
    80005e6a:	8fd9                	or	a5,a5,a4
    80005e6c:	0087979b          	slliw	a5,a5,0x8
    80005e70:	8321                	srli	a4,a4,0x8
    80005e72:	8fd9                	or	a5,a5,a4
    80005e74:	17c2                	slli	a5,a5,0x30
    80005e76:	93c1                	srli	a5,a5,0x30
  if (type == ETHTYPE_IP)
    80005e78:	8007871b          	addiw	a4,a5,-2048
    80005e7c:	cb1d                	beqz	a4,80005eb2 <net_rx+0x72>
    net_rx_ip(m);
  else if (type == ETHTYPE_ARP)
    80005e7e:	2781                	sext.w	a5,a5
    80005e80:	6705                	lui	a4,0x1
    80005e82:	80670713          	addi	a4,a4,-2042 # 806 <_entry-0x7ffff7fa>
    80005e86:	18e78e63          	beq	a5,a4,80006022 <net_rx+0x1e2>
  kfree(m);
    80005e8a:	8526                	mv	a0,s1
    80005e8c:	ffffa097          	auipc	ra,0xffffa
    80005e90:	190080e7          	jalr	400(ra) # 8000001c <kfree>
    net_rx_arp(m);
  else
    mbuffree(m);
}
    80005e94:	60a6                	ld	ra,72(sp)
    80005e96:	6406                	ld	s0,64(sp)
    80005e98:	74e2                	ld	s1,56(sp)
    80005e9a:	7942                	ld	s2,48(sp)
    80005e9c:	79a2                	ld	s3,40(sp)
    80005e9e:	7a02                	ld	s4,32(sp)
    80005ea0:	6ae2                	ld	s5,24(sp)
    80005ea2:	6161                	addi	sp,sp,80
    80005ea4:	8082                	ret
  kfree(m);
    80005ea6:	8526                	mv	a0,s1
    80005ea8:	ffffa097          	auipc	ra,0xffffa
    80005eac:	174080e7          	jalr	372(ra) # 8000001c <kfree>
}
    80005eb0:	b7d5                	j	80005e94 <net_rx+0x54>
  iphdr = mbufpullhdr(m, *iphdr);
    80005eb2:	45d1                	li	a1,20
    80005eb4:	8526                	mv	a0,s1
    80005eb6:	00000097          	auipc	ra,0x0
    80005eba:	c8e080e7          	jalr	-882(ra) # 80005b44 <mbufpull>
    80005ebe:	892a                	mv	s2,a0
  if (!iphdr)
    80005ec0:	c519                	beqz	a0,80005ece <net_rx+0x8e>
  if (iphdr->ip_vhl != ((4 << 4) | (20 >> 2)))
    80005ec2:	00054703          	lbu	a4,0(a0)
    80005ec6:	04500793          	li	a5,69
    80005eca:	00f70863          	beq	a4,a5,80005eda <net_rx+0x9a>
  kfree(m);
    80005ece:	8526                	mv	a0,s1
    80005ed0:	ffffa097          	auipc	ra,0xffffa
    80005ed4:	14c080e7          	jalr	332(ra) # 8000001c <kfree>
}
    80005ed8:	bf75                	j	80005e94 <net_rx+0x54>
  if (in_cksum((unsigned char *)iphdr, sizeof(*iphdr)))
    80005eda:	45d1                	li	a1,20
    80005edc:	00000097          	auipc	ra,0x0
    80005ee0:	bf4080e7          	jalr	-1036(ra) # 80005ad0 <in_cksum>
    80005ee4:	f56d                	bnez	a0,80005ece <net_rx+0x8e>
    80005ee6:	00695783          	lhu	a5,6(s2)
    80005eea:	0087d713          	srli	a4,a5,0x8
    80005eee:	0087979b          	slliw	a5,a5,0x8
    80005ef2:	0ff77713          	andi	a4,a4,255
    80005ef6:	8fd9                	or	a5,a5,a4
  if (htons(iphdr->ip_off) != 0)
    80005ef8:	17c2                	slli	a5,a5,0x30
    80005efa:	93c1                	srli	a5,a5,0x30
    80005efc:	fbe9                	bnez	a5,80005ece <net_rx+0x8e>
  if (htonl(iphdr->ip_dst) != local_ip)
    80005efe:	01092703          	lw	a4,16(s2)
  return (((val & 0x000000ffUL) << 24) |
    80005f02:	0187179b          	slliw	a5,a4,0x18
          ((val & 0xff000000UL) >> 24));
    80005f06:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005f0a:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    80005f0c:	0087169b          	slliw	a3,a4,0x8
    80005f10:	00ff0637          	lui	a2,0xff0
    80005f14:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    80005f16:	8fd5                	or	a5,a5,a3
    80005f18:	0087571b          	srliw	a4,a4,0x8
    80005f1c:	66c1                	lui	a3,0x10
    80005f1e:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80005f22:	8f75                	and	a4,a4,a3
    80005f24:	8fd9                	or	a5,a5,a4
    80005f26:	2781                	sext.w	a5,a5
    80005f28:	0a000737          	lui	a4,0xa000
    80005f2c:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    80005f30:	f8e79fe3          	bne	a5,a4,80005ece <net_rx+0x8e>
  if (iphdr->ip_p != IPPROTO_UDP)
    80005f34:	00994703          	lbu	a4,9(s2)
    80005f38:	47c5                	li	a5,17
    80005f3a:	f8f71ae3          	bne	a4,a5,80005ece <net_rx+0x8e>
  return (((val & 0x00ffU) << 8) |
    80005f3e:	00295783          	lhu	a5,2(s2)
    80005f42:	0087d713          	srli	a4,a5,0x8
    80005f46:	0087999b          	slliw	s3,a5,0x8
    80005f4a:	0ff77793          	andi	a5,a4,255
    80005f4e:	00f9e9b3          	or	s3,s3,a5
    80005f52:	19c2                	slli	s3,s3,0x30
  ...
  udphdr = mbufpullhdr(m, *udphdr);
    ...
    80005f6c:	bdc080e7          	jalr	-1060(ra) # 80005b44 <mbufpull>
    80005f70:	8aaa                	mv	s5,a0
  if (!udphdr)
    80005f72:	c915                	beqz	a0,80005fa6 <net_rx+0x166>
    80005f74:	00455783          	lhu	a5,4(a0)
    80005f78:	0087d713          	srli	a4,a5,0x8
    80005f7c:	0087979b          	slliw	a5,a5,0x8
    80005f80:	0ff77713          	andi	a4,a4,255
    80005f84:	8fd9                	or	a5,a5,a4
  if (ntohs(udphdr->ulen) != len)
    80005f86:	2a01                	sext.w	s4,s4
    80005f88:	17c2                	slli	a5,a5,0x30
    80005f8a:	93c1                	srli	a5,a5,0x30
    80005f8c:	00fa1d63          	bne	s4,a5,80005fa6 <net_rx+0x166>
  len -= sizeof(*udphdr);
    80005f90:	fe49879b          	addiw	a5,s3,-28
  if (len > m->len)
    80005f94:	0107979b          	slliw	a5,a5,0x10
    80005f98:	0107d79b          	srliw	a5,a5,0x10
    80005f9c:	0007871b          	sext.w	a4,a5
    80005fa0:	488c                	lw	a1,16(s1)
    80005fa2:	00e5f863          	bgeu	a1,a4,80005fb2 <net_rx+0x172>
  kfree(m);
    80005fa6:	8526                	mv	a0,s1
    80005fa8:	ffffa097          	auipc	ra,0xffffa
    80005fac:	074080e7          	jalr	116(ra) # 8000001c <kfree>
}
    80005fb0:	b5d5                	j	80005e94 <net_rx+0x54>
  mbuftrim(m, m->len - len);
    80005fb2:	9d9d                	subw	a1,a1,a5
    80005fb4:	8526                	mv	a0,s1
    80005fb6:	00000097          	auipc	ra,0x0
    80005fba:	c9c080e7          	jalr	-868(ra) # 80005c52 <mbuftrim>
  sip = ntohl(iphdr->ip_src);
    80005fbe:	00c92783          	lw	a5,12(s2)
    80005fc2:	000ad703          	lhu	a4,0(s5) # 3000 <_entry-0x7fffd000>
    80005fc6:	00875693          	srli	a3,a4,0x8
    80005fca:	0087171b          	slliw	a4,a4,0x8
    80005fce:	0ff6f693          	andi	a3,a3,255
    80005fd2:	8ed9                	or	a3,a3,a4
    80005fd4:	002ad703          	lhu	a4,2(s5)
    80005fd8:	00875613          	srli	a2,a4,0x8
    80005fdc:	0087171b          	slliw	a4,a4,0x8
    80005fe0:	0ff67613          	andi	a2,a2,255
    80005fe4:	8e59                	or	a2,a2,a4
  return (((val & 0x000000ffUL) << 24) |
    80005fe6:	0187971b          	slliw	a4,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80005fea:	0187d59b          	srliw	a1,a5,0x18
          ((val & 0x00ff0000UL) >> 8) |
    80005fee:	8f4d                	or	a4,a4,a1
          ((val & 0x0000ff00UL) << 8) |
    80005ff0:	0087959b          	slliw	a1,a5,0x8
    80005ff4:	00ff0537          	lui	a0,0xff0
    80005ff8:	8de9                	and	a1,a1,a0
          ((val & 0x00ff0000UL) >> 8) |
    80005ffa:	8f4d                	or	a4,a4,a1
    80005ffc:	0087d79b          	srliw	a5,a5,0x8
    80006000:	65c1                	lui	a1,0x10
    80006002:	f0058593          	addi	a1,a1,-256 # ff00 <_entry-0x7fff0100>
    80006006:	8fed                	and	a5,a5,a1
    80006008:	8fd9                	or	a5,a5,a4
  sockrecvudp(m, sip, dport, sport);
    8000600a:	16c2                	slli	a3,a3,0x30
    8000600c:	92c1                	srli	a3,a3,0x30
    8000600e:	1642                	slli	a2,a2,0x30
    80006010:	9241                	srli	a2,a2,0x30
    80006012:	0007859b          	sext.w	a1,a5
    80006016:	8526                	mv	a0,s1
    80006018:	00000097          	auipc	ra,0x0
    8000601c:	55c080e7          	jalr	1372(ra) # 80006574 <sockrecvudp>
  return;
    80006020:	bd95                	j	80005e94 <net_rx+0x54>
  arphdr = mbufpullhdr(m, *arphdr);
    80006022:	45f1                	li	a1,28
    80006024:	8526                	mv	a0,s1
    80006026:	00000097          	auipc	ra,0x0
    8000602a:	b1e080e7          	jalr	-1250(ra) # 80005b44 <mbufpull>
    8000602e:	892a                	mv	s2,a0
  if (!arphdr)
    80006030:	c179                	beqz	a0,800060f6 <net_rx+0x2b6>
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006032:	00054783          	lbu	a5,0(a0) # ff0000 <_entry-0x7f010000>
    80006036:	00154703          	lbu	a4,1(a0)
    8000603a:	0722                	slli	a4,a4,0x8
    8000603c:	8fd9                	or	a5,a5,a4
  return (((val & 0x00ffU) << 8) |
    8000603e:	0087979b          	slliw	a5,a5,0x8
    80006042:	8321                	srli	a4,a4,0x8
    80006044:	8fd9                	or	a5,a5,a4
    80006046:	17c2                	slli	a5,a5,0x30
    80006048:	93c1                	srli	a5,a5,0x30
    8000604a:	4705                	li	a4,1
    8000604c:	0ae79563          	bne	a5,a4,800060f6 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006050:	00254783          	lbu	a5,2(a0)
    80006054:	00354703          	lbu	a4,3(a0)
  ...
  if (ntohs(arphdr->hrd) != ARP_HRD_ETHER ||
    80006064:	0107979b          	slliw	a5,a5,0x10
    80006068:	0107d79b          	srliw	a5,a5,0x10
    8000606c:	8007879b          	addiw	a5,a5,-2048
    80006070:	e3d9                	bnez	a5,800060f6 <net_rx+0x2b6>
      ntohs(arphdr->pro) != ETHTYPE_IP ||
    80006072:	00454703          	lbu	a4,4(a0)
    80006076:	4799                	li	a5,6
    80006078:	06f71f63          	bne	a4,a5,800060f6 <net_rx+0x2b6>
      arphdr->hln != ETHADDR_LEN ||
    8000607c:	00554703          	lbu	a4,5(a0)
    80006080:	4791                	li	a5,4
    80006082:	06f71a63          	bne	a4,a5,800060f6 <net_rx+0x2b6>
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    80006086:	00654783          	lbu	a5,6(a0)
    8000608a:	00754703          	lbu	a4,7(a0)
    8000608e:	0722                	slli	a4,a4,0x8
    80006090:	8fd9                	or	a5,a5,a4
    80006092:	0087979b          	slliw	a5,a5,0x8
    80006096:	8321                	srli	a4,a4,0x8
    80006098:	8fd9                	or	a5,a5,a4
    8000609a:	17c2                	slli	a5,a5,0x30
    8000609c:	93c1                	srli	a5,a5,0x30
    8000609e:	4705                	li	a4,1
    800060a0:	04e79b63          	bne	a5,a4,800060f6 <net_rx+0x2b6>
  tip = ntohl(arphdr->tip); // target IP address
    800060a4:	01854783          	lbu	a5,24(a0)
    800060a8:	01954703          	lbu	a4,25(a0)
    800060ac:	0722                	slli	a4,a4,0x8
    800060ae:	8f5d                	or	a4,a4,a5
    800060b0:	01a54783          	lbu	a5,26(a0)
    800060b4:	07c2                	slli	a5,a5,0x10
    800060b6:	8f5d                	or	a4,a4,a5
    800060b8:	01b54783          	lbu	a5,27(a0)
    800060bc:	07e2                	slli	a5,a5,0x18
    800060be:	8fd9                	or	a5,a5,a4
    800060c0:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    800060c4:	0187979b          	slliw	a5,a5,0x18
          ((val & 0xff000000UL) >> 24));
    800060c8:	0187569b          	srliw	a3,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800060cc:	8fd5                	or	a5,a5,a3
          ((val & 0x0000ff00UL) << 8) |
    800060ce:	0087169b          	slliw	a3,a4,0x8
    800060d2:	00ff0637          	lui	a2,0xff0
    800060d6:	8ef1                	and	a3,a3,a2
          ((val & 0x00ff0000UL) >> 8) |
    800060d8:	8fd5                	or	a5,a5,a3
    800060da:	0087571b          	srliw	a4,a4,0x8
    800060de:	66c1                	lui	a3,0x10
    800060e0:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    800060e4:	8f75                	and	a4,a4,a3
    800060e6:	8fd9                	or	a5,a5,a4
  if (ntohs(arphdr->op) != ARP_OP_REQUEST || tip != local_ip)
    800060e8:	2781                	sext.w	a5,a5
    800060ea:	0a000737          	lui	a4,0xa000
    800060ee:	20f70713          	addi	a4,a4,527 # a00020f <_entry-0x75fffdf1>
    800060f2:	00e78863          	beq	a5,a4,80006102 <net_rx+0x2c2>
  kfree(m);
    800060f6:	8526                	mv	a0,s1
    800060f8:	ffffa097          	auipc	ra,0xffffa
    800060fc:	f24080e7          	jalr	-220(ra) # 8000001c <kfree>
}
    80006100:	bb51                	j	80005e94 <net_rx+0x54>
  memmove(smac, arphdr->sha, ETHADDR_LEN); // sender's ethernet address
    80006102:	4619                	li	a2,6
    80006104:	00850593          	addi	a1,a0,8
    80006108:	fb840513          	addi	a0,s0,-72
    8000610c:	ffffa097          	auipc	ra,0xffffa
    80006110:	0cc080e7          	jalr	204(ra) # 800001d8 <memmove>
  sip = ntohl(arphdr->sip); // sender's IP address (qemu's slirp)
    80006114:	00e94783          	lbu	a5,14(s2)
    80006118:	00f94703          	lbu	a4,15(s2)
    8000611c:	0722                	slli	a4,a4,0x8
    8000611e:	8f5d                	or	a4,a4,a5
    80006120:	01094783          	lbu	a5,16(s2)
    80006124:	07c2                	slli	a5,a5,0x10
    80006126:	8f5d                	or	a4,a4,a5
    80006128:	01194783          	lbu	a5,17(s2)
    8000612c:	07e2                	slli	a5,a5,0x18
    8000612e:	8fd9                	or	a5,a5,a4
    80006130:	0007871b          	sext.w	a4,a5
  return (((val & 0x000000ffUL) << 24) |
    80006134:	0187991b          	slliw	s2,a5,0x18
          ((val & 0xff000000UL) >> 24));
    80006138:	0187579b          	srliw	a5,a4,0x18
          ((val & 0x00ff0000UL) >> 8) |
    8000613c:	00f96933          	or	s2,s2,a5
          ((val & 0x0000ff00UL) << 8) |
    80006140:	0087179b          	slliw	a5,a4,0x8
    80006144:	00ff06b7          	lui	a3,0xff0
    80006148:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    8000614a:	00f96933          	or	s2,s2,a5
    8000614e:	0087579b          	srliw	a5,a4,0x8
    80006152:	6741                	lui	a4,0x10
    80006154:	f0070713          	addi	a4,a4,-256 # ff00 <_entry-0x7fff0100>
    80006158:	8ff9                	and	a5,a5,a4
    8000615a:	00f96933          	or	s2,s2,a5
    8000615e:	2901                	sext.w	s2,s2
  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006160:	08000513          	li	a0,128
    80006164:	00000097          	auipc	ra,0x0
    80006168:	b10080e7          	jalr	-1264(ra) # 80005c74 <mbufalloc>
    8000616c:	8a2a                	mv	s4,a0
  if (!m)
    8000616e:	d541                	beqz	a0,800060f6 <net_rx+0x2b6>
  arphdr = mbufputhdr(m, *arphdr);
    80006170:	45f1                	li	a1,28
    80006172:	00000097          	auipc	ra,0x0
    80006176:	aa6080e7          	jalr	-1370(ra) # 80005c18 <mbufput>
    8000617a:	89aa                	mv	s3,a0
  arphdr->hrd = htons(ARP_HRD_ETHER);
    8000617c:	00050023          	sb	zero,0(a0)
    80006180:	4785                	li	a5,1
    80006182:	00f500a3          	sb	a5,1(a0)
  arphdr->pro = htons(ETHTYPE_IP);
    80006186:	47a1                	li	a5,8
    80006188:	00f50123          	sb	a5,2(a0)
    8000618c:	000501a3          	sb	zero,3(a0)
  arphdr->hln = ETHADDR_LEN;
    80006190:	4799                	li	a5,6
    80006192:	00f50223          	sb	a5,4(a0)
  arphdr->pln = sizeof(uint32);
    80006196:	4791                	li	a5,4
    80006198:	00f502a3          	sb	a5,5(a0)
  arphdr->op = htons(op);
    8000619c:	00050323          	sb	zero,6(a0)
    800061a0:	4a89                	li	s5,2
    800061a2:	015503a3          	sb	s5,7(a0)
  memmove(arphdr->sha, local_mac, ETHADDR_LEN);
    800061a6:	4619                	li	a2,6
    800061a8:	00003597          	auipc	a1,0x3
    800061ac:	6d858593          	addi	a1,a1,1752 # 80009880 <local_mac>
    800061b0:	0521                	addi	a0,a0,8
    800061b2:	ffffa097          	auipc	ra,0xffffa
    800061b6:	026080e7          	jalr	38(ra) # 800001d8 <memmove>
  arphdr->sip = htonl(local_ip);
    800061ba:	47a9                	li	a5,10
    800061bc:	00f98723          	sb	a5,14(s3)
    800061c0:	000987a3          	sb	zero,15(s3)
    800061c4:	01598823          	sb	s5,16(s3)
    800061c8:	47bd                	li	a5,15
    800061ca:	00f988a3          	sb	a5,17(s3)
  memmove(arphdr->tha, dmac, ETHADDR_LEN);
    800061ce:	4619                	li	a2,6
    800061d0:	fb840593          	addi	a1,s0,-72
    800061d4:	01298513          	addi	a0,s3,18
    800061d8:	ffffa097          	auipc	ra,0xffffa
    800061dc:	000080e7          	jalr	ra # 800001d8 <memmove>
  return (((val & 0x000000ffUL) << 24) |
    800061e0:	0189171b          	slliw	a4,s2,0x18
          ((val & 0xff000000UL) >> 24));
    800061e4:	0189579b          	srliw	a5,s2,0x18
          ((val & 0x00ff0000UL) >> 8) |
    800061e8:	8f5d                	or	a4,a4,a5
          ((val & 0x0000ff00UL) << 8) |
    800061ea:	0089179b          	slliw	a5,s2,0x8
    800061ee:	00ff06b7          	lui	a3,0xff0
    800061f2:	8ff5                	and	a5,a5,a3
          ((val & 0x00ff0000UL) >> 8) |
    800061f4:	8f5d                	or	a4,a4,a5
    800061f6:	0089579b          	srliw	a5,s2,0x8
    800061fa:	66c1                	lui	a3,0x10
    800061fc:	f0068693          	addi	a3,a3,-256 # ff00 <_entry-0x7fff0100>
    80006200:	8ff5                	and	a5,a5,a3
    80006202:	8fd9                	or	a5,a5,a4
  arphdr->tip = htonl(dip);
    80006204:	00e98c23          	sb	a4,24(s3)
    80006208:	0087d71b          	srliw	a4,a5,0x8
    8000620c:	00e98ca3          	sb	a4,25(s3)
    80006210:	0107d71b          	srliw	a4,a5,0x10
    80006214:	00e98d23          	sb	a4,26(s3)
    80006218:	0187d79b          	srliw	a5,a5,0x18
    8000621c:	00f98da3          	sb	a5,27(s3)
  net_tx_eth(m, ETHTYPE_ARP);
    80006220:	6585                	lui	a1,0x1
    80006222:	80658593          	addi	a1,a1,-2042 # 806 <_entry-0x7ffff7fa>
    80006226:	8552                	mv	a0,s4
    80006228:	00000097          	auipc	ra,0x0
    8000622c:	978080e7          	jalr	-1672(ra) # 80005ba0 <net_tx_eth>
  return 0;
    80006230:	b5d9                	j	800060f6 <net_rx+0x2b6>

0000000080006232 <sockinit>:
...
sockinit(void)
{
  ...
  initlock(&lock, "socktbl");
    8000623a:	00003597          	auipc	a1,0x3
    8000623e:	59e58593          	addi	a1,a1,1438 # 800097d8 <syscalls+0x428>
    80006242:	00019517          	auipc	a0,0x19
    80006246:	0de50513          	addi	a0,a0,222 # 8001f320 <lock>
    8000624a:	00001097          	auipc	ra,0x1
    8000624e:	e4e080e7          	jalr	-434(ra) # 80007098 <initlock>
}
    80006252:	60a2                	ld	ra,8(sp)
    80006254:	6402                	ld	s0,0(sp)
    80006256:	0141                	addi	sp,sp,16
    80006258:	8082                	ret

000000008000625a <sockalloc>:

int
sockalloc(struct file **f, uint32 raddr, uint16 lport, uint16 rport)
{
    8000625a:	7139                	addi	sp,sp,-64
    8000625c:	fc06                	sd	ra,56(sp)
    8000625e:	f822                	sd	s0,48(sp)
    80006260:	f426                	sd	s1,40(sp)
    80006262:	f04a                	sd	s2,32(sp)
    80006264:	ec4e                	sd	s3,24(sp)
    80006266:	e852                	sd	s4,16(sp)
    80006268:	e456                	sd	s5,8(sp)
    8000626a:	0080                	addi	s0,sp,64
    8000626c:	892a                	mv	s2,a0
    8000626e:	84ae                	mv	s1,a1
    80006270:	8a32                	mv	s4,a2
    80006272:	89b6                	mv	s3,a3
  struct sock *si, *pos;

  si = 0;
  *f = 0;
    80006274:	00053023          	sd	zero,0(a0)
  if ((*f = filealloc()) == 0)
    80006278:	ffffd097          	auipc	ra,0xffffd
    8000627c:	694080e7          	jalr	1684(ra) # 8000390c <filealloc>
    80006280:	00a93023          	sd	a0,0(s2)
    80006284:	c975                	beqz	a0,80006378 <sockalloc+0x11e>
    goto bad;
  if ((si = (struct sock*)kalloc()) == 0)
    80006286:	ffffa097          	auipc	ra,0xffffa
    8000628a:	e92080e7          	jalr	-366(ra) # 80000118 <kalloc>
    8000628e:	8aaa                	mv	s5,a0
    80006290:	c15d                	beqz	a0,80006336 <sockalloc+0xdc>
    goto bad;

  // initialize objects
  si->raddr = raddr;
    80006292:	c504                	sw	s1,8(a0)
  si->lport = lport;
    80006294:	01451623          	sh	s4,12(a0)
  si->rport = rport;
    80006298:	01351723          	sh	s3,14(a0)
  initlock(&si->lock, "sock");
    8000629c:	00003597          	auipc	a1,0x3
    800062a0:	54458593          	addi	a1,a1,1348 # 800097e0 <syscalls+0x430>
    800062a4:	0541                	addi	a0,a0,16
    800062a6:	00001097          	auipc	ra,0x1
    800062aa:	df2080e7          	jalr	-526(ra) # 80007098 <initlock>
  mbufq_init(&si->rxq);
    800062ae:	028a8513          	addi	a0,s5,40
    800062b2:	00000097          	auipc	ra,0x0
    800062b6:	a7a080e7          	jalr	-1414(ra) # 80005d2c <mbufq_init>
  (*f)->type = FD_SOCK;
    800062ba:	00093783          	ld	a5,0(s2)
    800062be:	4711                	li	a4,4
    800062c0:	c398                	sw	a4,0(a5)
  (*f)->readable = 1;
    800062c2:	00093703          	ld	a4,0(s2)
    800062c6:	4785                	li	a5,1
    800062c8:	00f70423          	sb	a5,8(a4)
  (*f)->writable = 1;
    800062cc:	00093703          	ld	a4,0(s2)
    800062d0:	00f704a3          	sb	a5,9(a4)
  (*f)->sock = si;
    800062d4:	00093783          	ld	a5,0(s2)
    800062d8:	0357b023          	sd	s5,32(a5) # f020020 <_entry-0x70fdffe0>
  ...
  acquire(&lock);
    ...
    800062e8:	e44080e7          	jalr	-444(ra) # 80007128 <acquire>
  pos = sockets;
    800062ec:	00004597          	auipc	a1,0x4
    800062f0:	d3c5b583          	ld	a1,-708(a1) # 8000a028 <sockets>
  while (pos) {
    800062f4:	c9b1                	beqz	a1,80006348 <sockalloc+0xee>
  pos = sockets;
    800062f6:	87ae                	mv	a5,a1
    if (pos->raddr == raddr &&
    800062f8:	000a061b          	sext.w	a2,s4
        pos->lport == lport &&
    800062fc:	0009869b          	sext.w	a3,s3
    80006300:	a019                	j	80006306 <sockalloc+0xac>
	pos->rport == rport) {
      release(&lock);
      goto bad;
    }
    pos = pos->next;
    80006302:	639c                	ld	a5,0(a5)
  while (pos) {
    80006304:	c3b1                	beqz	a5,80006348 <sockalloc+0xee>
    if (pos->raddr == raddr &&
    80006306:	4798                	lw	a4,8(a5)
    80006308:	fe971de3          	bne	a4,s1,80006302 <sockalloc+0xa8>
    8000630c:	00c7d703          	lhu	a4,12(a5)
    80006310:	fec719e3          	bne	a4,a2,80006302 <sockalloc+0xa8>
        pos->lport == lport &&
    80006314:	00e7d703          	lhu	a4,14(a5)
    80006318:	fed715e3          	bne	a4,a3,80006302 <sockalloc+0xa8>
      release(&lock);
    8000631c:	00019517          	auipc	a0,0x19
    80006320:	00450513          	addi	a0,a0,4 # 8001f320 <lock>
    80006324:	00001097          	auipc	ra,0x1
    80006328:	eb8080e7          	jalr	-328(ra) # 800071dc <release>
  release(&lock);
  return 0;
...
bad:
  if (si)
    kfree((char*)si);
    8000632c:	8556                	mv	a0,s5
    8000632e:	ffffa097          	auipc	ra,0xffffa
    80006332:	cee080e7          	jalr	-786(ra) # 8000001c <kfree>
  if (*f)
    80006336:	00093503          	ld	a0,0(s2)
    8000633a:	c129                	beqz	a0,8000637c <sockalloc+0x122>
    fileclose(*f);
    8000633c:	ffffd097          	auipc	ra,0xffffd
    80006340:	68c080e7          	jalr	1676(ra) # 800039c8 <fileclose>
  return -1;
    80006344:	557d                	li	a0,-1
    80006346:	a005                	j	80006366 <sockalloc+0x10c>
  si->next = sockets;
    80006348:	00bab023          	sd	a1,0(s5)
  sockets = si;
    8000634c:	00004797          	auipc	a5,0x4
    80006350:	cd57be23          	sd	s5,-804(a5) # 8000a028 <sockets>
  release(&lock);
    80006354:	00019517          	auipc	a0,0x19
    80006358:	fcc50513          	addi	a0,a0,-52 # 8001f320 <lock>
    8000635c:	00001097          	auipc	ra,0x1
    80006360:	e80080e7          	jalr	-384(ra) # 800071dc <release>
  return 0;
    ...
    8000636c:	7902                	ld	s2,32(sp)
    8000636e:	69e2                	ld	s3,24(sp)
    80006370:	6a42                	ld	s4,16(sp)
    80006372:	6aa2                	ld	s5,8(sp)
    80006374:	6121                	addi	sp,sp,64
    80006376:	8082                	ret
  return -1;
    80006378:	557d                	li	a0,-1
    8000637a:	b7f5                	j	80006366 <sockalloc+0x10c>
    8000637c:	557d                	li	a0,-1
    8000637e:	b7e5                	j	80006366 <sockalloc+0x10c>

0000000080006380 <sockclose>:
...
sockclose(struct sock *si)
{
  ...
  acquire(&lock);
    8000638e:	00019517          	auipc	a0,0x19
    80006392:	f9250513          	addi	a0,a0,-110 # 8001f320 <lock>
    80006396:	00001097          	auipc	ra,0x1
    8000639a:	d92080e7          	jalr	-622(ra) # 80007128 <acquire>
  pos = &sockets;
    8000639e:	00004797          	auipc	a5,0x4
    800063a2:	c8a7b783          	ld	a5,-886(a5) # 8000a028 <sockets>
  while (*pos) {
    800063a6:	cb99                	beqz	a5,800063bc <sockclose+0x3c>
    if (*pos == si){
    800063a8:	02f90563          	beq	s2,a5,800063d2 <sockclose+0x52>
      *pos = si->next;
      break;
    }
    pos = &(*pos)->next;
    800063ac:	873e                	mv	a4,a5
    800063ae:	639c                	ld	a5,0(a5)
  while (*pos) {
    800063b0:	c791                	beqz	a5,800063bc <sockclose+0x3c>
    if (*pos == si){
    800063b2:	fef91de3          	bne	s2,a5,800063ac <sockclose+0x2c>
      *pos = si->next;
    800063b6:	00093783          	ld	a5,0(s2)
    800063ba:	e31c                	sd	a5,0(a4)
  }
  release(&lock);
    800063bc:	00019517          	auipc	a0,0x19
    800063c0:	f6450513          	addi	a0,a0,-156 # 8001f320 <lock>
    800063c4:	00001097          	auipc	ra,0x1
    800063c8:	e18080e7          	jalr	-488(ra) # 800071dc <release>

  // free any pending mbufs
  while (!mbufq_empty(&si->rxq)) {
    800063cc:	02890493          	addi	s1,s2,40
    800063d0:	a839                	j	800063ee <sockclose+0x6e>
  pos = &sockets;
    800063d2:	00004717          	auipc	a4,0x4
    800063d6:	c5670713          	addi	a4,a4,-938 # 8000a028 <sockets>
    800063da:	bff1                	j	800063b6 <sockclose+0x36>
    m = mbufq_pophead(&si->rxq);
    800063dc:	8526                	mv	a0,s1
    800063de:	00000097          	auipc	ra,0x0
    800063e2:	926080e7          	jalr	-1754(ra) # 80005d04 <mbufq_pophead>
    mbuffree(m);
    800063e6:	00000097          	auipc	ra,0x0
    800063ea:	8e6080e7          	jalr	-1818(ra) # 80005ccc <mbuffree>
  while (!mbufq_empty(&si->rxq)) {
    800063ee:	8526                	mv	a0,s1
    800063f0:	00000097          	auipc	ra,0x0
    800063f4:	92a080e7          	jalr	-1750(ra) # 80005d1a <mbufq_empty>
    800063f8:	d175                	beqz	a0,800063dc <sockclose+0x5c>
  }

  kfree((char*)si);
    800063fa:	854a                	mv	a0,s2
    800063fc:	ffffa097          	auipc	ra,0xffffa
    80006400:	c20080e7          	jalr	-992(ra) # 8000001c <kfree>
}
...
0000000080006410 <sockread>:

int
sockread(struct sock *si, uint64 addr, int n)
{
    80006410:	7139                	addi	sp,sp,-64
    80006412:	fc06                	sd	ra,56(sp)
    80006414:	f822                	sd	s0,48(sp)
    80006416:	f426                	sd	s1,40(sp)
    80006418:	f04a                	sd	s2,32(sp)
    8000641a:	ec4e                	sd	s3,24(sp)
    8000641c:	e852                	sd	s4,16(sp)
    8000641e:	e456                	sd	s5,8(sp)
    80006420:	0080                	addi	s0,sp,64
    80006422:	84aa                	mv	s1,a0
    80006424:	8a2e                	mv	s4,a1
    80006426:	8ab2                	mv	s5,a2
  struct proc *pr = myproc();
    80006428:	ffffb097          	auipc	ra,0xffffb
    8000642c:	a9a080e7          	jalr	-1382(ra) # 80000ec2 <myproc>
    80006430:	892a                	mv	s2,a0
  struct mbuf *m;
  int len;

  acquire(&si->lock);
    80006432:	01048993          	addi	s3,s1,16
    80006436:	854e                	mv	a0,s3
    80006438:	00001097          	auipc	ra,0x1
    8000643c:	cf0080e7          	jalr	-784(ra) # 80007128 <acquire>
  while (mbufq_empty(&si->rxq) && !pr->killed) {
    80006440:	02848493          	addi	s1,s1,40
    80006444:	8526                	mv	a0,s1
    80006446:	00000097          	auipc	ra,0x0
    8000644a:	8d4080e7          	jalr	-1836(ra) # 80005d1a <mbufq_empty>
    8000644e:	c919                	beqz	a0,80006464 <sockread+0x54>
    80006450:	03092783          	lw	a5,48(s2)
    80006454:	eba5                	bnez	a5,800064c4 <sockread+0xb4>
    sleep(&si->rxq, &si->lock);
    80006456:	85ce                	mv	a1,s3
    80006458:	8526                	mv	a0,s1
    8000645a:	ffffb097          	auipc	ra,0xffffb
    8000645e:	278080e7          	jalr	632(ra) # 800016d2 <sleep>
    80006462:	b7cd                	j	80006444 <sockread+0x34>
  }
  if (pr->killed) {
    80006464:	03092783          	lw	a5,48(s2)
    80006468:	efb1                	bnez	a5,800064c4 <sockread+0xb4>
    release(&si->lock);
    return -1;
  }
  m = mbufq_pophead(&si->rxq);
    ...
    80006470:	898080e7          	jalr	-1896(ra) # 80005d04 <mbufq_pophead>
    80006474:	84aa                	mv	s1,a0
  release(&si->lock);
    80006476:	854e                	mv	a0,s3
    80006478:	00001097          	auipc	ra,0x1
    8000647c:	d64080e7          	jalr	-668(ra) # 800071dc <release>

  len = m->len;
    80006480:	489c                	lw	a5,16(s1)
  if (len > n)
    80006482:	89be                	mv	s3,a5
    80006484:	00fad363          	bge	s5,a5,8000648a <sockread+0x7a>
    80006488:	89d6                	mv	s3,s5
    8000648a:	2981                	sext.w	s3,s3
    len = n;
  if (copyout(pr->pagetable, addr, m->head, len) == -1) {
    8000648c:	86ce                	mv	a3,s3
    8000648e:	6490                	ld	a2,8(s1)
    80006490:	85d2                	mv	a1,s4
    80006492:	05093503          	ld	a0,80(s2)
    80006496:	ffffa097          	auipc	ra,0xffffa
    8000649a:	6c2080e7          	jalr	1730(ra) # 80000b58 <copyout>
    8000649e:	892a                	mv	s2,a0
    800064a0:	57fd                	li	a5,-1
    800064a2:	02f50863          	beq	a0,a5,800064d2 <sockread+0xc2>
    mbuffree(m);
    return -1;
  }
  mbuffree(m);
    ...
    800064ac:	824080e7          	jalr	-2012(ra) # 80005ccc <mbuffree>
  return len;
}
    ...
    800064c2:	8082                	ret
    release(&si->lock);
    800064c4:	854e                	mv	a0,s3
    800064c6:	00001097          	auipc	ra,0x1
    800064ca:	d16080e7          	jalr	-746(ra) # 800071dc <release>
    return -1;
    800064ce:	59fd                	li	s3,-1
    800064d0:	b7c5                	j	800064b0 <sockread+0xa0>
    mbuffree(m);
    800064d2:	8526                	mv	a0,s1
    800064d4:	fffff097          	auipc	ra,0xfffff
    800064d8:	7f8080e7          	jalr	2040(ra) # 80005ccc <mbuffree>
    return -1;
    800064dc:	89ca                	mv	s3,s2
    800064de:	bfc9                	j	800064b0 <sockread+0xa0>

00000000800064e0 <sockwrite>:

int
sockwrite(struct sock *si, uint64 addr, int n)
{
    800064e0:	7139                	addi	sp,sp,-64
    800064e2:	fc06                	sd	ra,56(sp)
    800064e4:	f822                	sd	s0,48(sp)
    800064e6:	f426                	sd	s1,40(sp)
    800064e8:	f04a                	sd	s2,32(sp)
    800064ea:	ec4e                	sd	s3,24(sp)
    800064ec:	e852                	sd	s4,16(sp)
    800064ee:	e456                	sd	s5,8(sp)
    800064f0:	0080                	addi	s0,sp,64
    800064f2:	8aaa                	mv	s5,a0
    800064f4:	89ae                	mv	s3,a1
    800064f6:	8932                	mv	s2,a2
  struct proc *pr = myproc();
    800064f8:	ffffb097          	auipc	ra,0xffffb
    800064fc:	9ca080e7          	jalr	-1590(ra) # 80000ec2 <myproc>
    80006500:	8a2a                	mv	s4,a0
  struct mbuf *m;

  m = mbufalloc(MBUF_DEFAULT_HEADROOM);
    80006502:	08000513          	li	a0,128
    80006506:	fffff097          	auipc	ra,0xfffff
    8000650a:	76e080e7          	jalr	1902(ra) # 80005c74 <mbufalloc>
  if (!m)
    8000650e:	c12d                	beqz	a0,80006570 <sockwrite+0x90>
    80006510:	84aa                	mv	s1,a0
    return -1;

  if (copyin(pr->pagetable, mbufput(m, n), addr, n) == -1) {
    80006512:	050a3a03          	ld	s4,80(s4)
    80006516:	85ca                	mv	a1,s2
    80006518:	fffff097          	auipc	ra,0xfffff
    8000651c:	700080e7          	jalr	1792(ra) # 80005c18 <mbufput>
    80006520:	85aa                	mv	a1,a0
    80006522:	86ca                	mv	a3,s2
    80006524:	864e                	mv	a2,s3
    80006526:	8552                	mv	a0,s4
    80006528:	ffffa097          	auipc	ra,0xffffa
    8000652c:	6bc080e7          	jalr	1724(ra) # 80000be4 <copyin>
    80006530:	89aa                	mv	s3,a0
    80006532:	57fd                	li	a5,-1
    80006534:	02f50863          	beq	a0,a5,80006564 <sockwrite+0x84>
    mbuffree(m);
    return -1;
  }
  net_tx_udp(m, si->raddr, si->lport, si->rport);
    80006538:	00ead683          	lhu	a3,14(s5)
    8000653c:	00cad603          	lhu	a2,12(s5)
    80006540:	008aa583          	lw	a1,8(s5)
    80006544:	8526                	mv	a0,s1
    80006546:	fffff097          	auipc	ra,0xfffff
    8000654a:	7f6080e7          	jalr	2038(ra) # 80005d3c <net_tx_udp>
  return n;
    8000654e:	89ca                	mv	s3,s2
}
    ...
    8000656a:	766080e7          	jalr	1894(ra) # 80005ccc <mbuffree>
    return -1;
    8000656e:	b7cd                	j	80006550 <sockwrite+0x70>
    return -1;
    80006570:	59fd                	li	s3,-1
    80006572:	bff9                	j	80006550 <sockwrite+0x70>

0000000080006574 <sockrecvudp>:
...
sockrecvudp(struct mbuf *m, uint32 raddr, uint16 lport, uint16 rport)
{
    ...
    8000657a:	f426                	sd	s1,40(sp)
    8000657c:	f04a                	sd	s2,32(sp)
    8000657e:	ec4e                	sd	s3,24(sp)
    80006580:	e852                	sd	s4,16(sp)
    80006582:	e456                	sd	s5,8(sp)
    80006584:	0080                	addi	s0,sp,64
    80006586:	8a2a                	mv	s4,a0
    80006588:	892e                	mv	s2,a1
    8000658a:	89b2                	mv	s3,a2
    8000658c:	8ab6                	mv	s5,a3
  ...
  acquire(&lock);
    8000658e:	00019517          	auipc	a0,0x19
    80006592:	d9250513          	addi	a0,a0,-622 # 8001f320 <lock>
    80006596:	00001097          	auipc	ra,0x1
    8000659a:	b92080e7          	jalr	-1134(ra) # 80007128 <acquire>
  si = sockets;
    8000659e:	00004497          	auipc	s1,0x4
    800065a2:	a8a4b483          	ld	s1,-1398(s1) # 8000a028 <sockets>
  while (si) {
    800065a6:	c4ad                	beqz	s1,80006610 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065a8:	0009871b          	sext.w	a4,s3
    800065ac:	000a869b          	sext.w	a3,s5
    800065b0:	a019                	j	800065b6 <sockrecvudp+0x42>
      goto found;
    si = si->next;
    800065b2:	6084                	ld	s1,0(s1)
  while (si) {
    800065b4:	ccb1                	beqz	s1,80006610 <sockrecvudp+0x9c>
    if (si->raddr == raddr && si->lport == lport && si->rport == rport)
    800065b6:	449c                	lw	a5,8(s1)
    800065b8:	ff279de3          	bne	a5,s2,800065b2 <sockrecvudp+0x3e>
    800065bc:	00c4d783          	lhu	a5,12(s1)
    800065c0:	fee799e3          	bne	a5,a4,800065b2 <sockrecvudp+0x3e>
    800065c4:	00e4d783          	lhu	a5,14(s1)
    800065c8:	fed795e3          	bne	a5,a3,800065b2 <sockrecvudp+0x3e>
  release(&lock);
  mbuffree(m);
  return;
...
found:
  acquire(&si->lock);
    800065cc:	01048913          	addi	s2,s1,16
    800065d0:	854a                	mv	a0,s2
    800065d2:	00001097          	auipc	ra,0x1
    800065d6:	b56080e7          	jalr	-1194(ra) # 80007128 <acquire>
  mbufq_pushtail(&si->rxq, m);
    800065da:	02848493          	addi	s1,s1,40
    800065de:	85d2                	mv	a1,s4
    800065e0:	8526                	mv	a0,s1
    800065e2:	fffff097          	auipc	ra,0xfffff
    800065e6:	702080e7          	jalr	1794(ra) # 80005ce4 <mbufq_pushtail>
  wakeup(&si->rxq);
    800065ea:	8526                	mv	a0,s1
    800065ec:	ffffb097          	auipc	ra,0xffffb
    800065f0:	26c080e7          	jalr	620(ra) # 80001858 <wakeup>
  release(&si->lock);
    800065f4:	854a                	mv	a0,s2
    800065f6:	00001097          	auipc	ra,0x1
    800065fa:	be6080e7          	jalr	-1050(ra) # 800071dc <release>
  release(&lock);
    800065fe:	00019517          	auipc	a0,0x19
    80006602:	d2250513          	addi	a0,a0,-734 # 8001f320 <lock>
    80006606:	00001097          	auipc	ra,0x1
    8000660a:	bd6080e7          	jalr	-1066(ra) # 800071dc <release>
    8000660e:	a831                	j	8000662a <sockrecvudp+0xb6>
  release(&lock);
    80006610:	00019517          	auipc	a0,0x19
    80006614:	d1050513          	addi	a0,a0,-752 # 8001f320 <lock>
    80006618:	00001097          	auipc	ra,0x1
    8000661c:	bc4080e7          	jalr	-1084(ra) # 800071dc <release>
  mbuffree(m);
    80006620:	8552                	mv	a0,s4
    80006622:	fffff097          	auipc	ra,0xfffff
    80006626:	6aa080e7          	jalr	1706(ra) # 80005ccc <mbuffree>
}
    8000662a:	70e2                	ld	ra,56(sp)
    8000662c:	7442                	ld	s0,48(sp)
    8000662e:	74a2                	ld	s1,40(sp)
    80006630:	7902                	ld	s2,32(sp)
    80006632:	69e2                	ld	s3,24(sp)
    80006634:	6a42                	ld	s4,16(sp)
    80006636:	6aa2                	ld	s5,8(sp)
    80006638:	6121                	addi	sp,sp,64
    8000663a:	8082                	ret

000000008000663c <pci_init>:
#include "proc.h"
#include "defs.h"
...
pci_init()
{
    8000663c:	715d                	addi	sp,sp,-80
    8000663e:	e486                	sd	ra,72(sp)
    80006640:	e0a2                	sd	s0,64(sp)
    80006642:	fc26                	sd	s1,56(sp)
    80006644:	f84a                	sd	s2,48(sp)
    80006646:	f44e                	sd	s3,40(sp)
    80006648:	f052                	sd	s4,32(sp)
    8000664a:	ec56                	sd	s5,24(sp)
    8000664c:	e85a                	sd	s6,16(sp)
    8000664e:	e45e                	sd	s7,8(sp)
    80006650:	0880                	addi	s0,sp,80
    80006652:	300004b7          	lui	s1,0x30000
    ...
    if(id == 0x100e8086){
    80006656:	100e8937          	lui	s2,0x100e8
    8000665a:	08690913          	addi	s2,s2,134 # 100e8086 <_entry-0x6ff17f7a>
      // command and status register.
      // bit 0 : I/O access enable
      // bit 1 : memory access enable
      // bit 2 : enable mastering
      base[1] = 7;
    8000665e:	4b9d                	li	s7,7
      for(int i = 0; i < 6; i++){
        uint32 old = base[4+i];
    ...
    80006660:	5afd                	li	s5,-1
      ...
      base[4+0] = e1000_regs;
    80006662:	40000b37          	lui	s6,0x40000
    80006666:	6a09                	lui	s4,0x2
  for(int dev = 0; dev < 32; dev++){
    80006668:	300409b7          	lui	s3,0x30040
    8000666c:	a821                	j	80006684 <pci_init+0x48>
      base[4+0] = e1000_regs;
    8000666e:	0166a823          	sw	s6,16(a3)

      e1000_init((uint32*)e1000_regs);
    80006672:	40000537          	lui	a0,0x40000
    80006676:	fffff097          	auipc	ra,0xfffff
    8000667a:	11a080e7          	jalr	282(ra) # 80005790 <e1000_init>
  for(int dev = 0; dev < 32; dev++){
    8000667e:	94d2                	add	s1,s1,s4
    80006680:	03348a63          	beq	s1,s3,800066b4 <pci_init+0x78>
    volatile uint32 *base = ecam + off;
    80006684:	86a6                	mv	a3,s1
    uint32 id = base[0];
    80006686:	409c                	lw	a5,0(s1)
    80006688:	2781                	sext.w	a5,a5
    if(id == 0x100e8086){
    8000668a:	ff279ae3          	bne	a5,s2,8000667e <pci_init+0x42>
      base[1] = 7;
    8000668e:	0174a223          	sw	s7,4(s1) # 30000004 <_entry-0x4ffffffc>
      __sync_synchronize();
    80006692:	0ff0000f          	fence
      for(int i = 0; i < 6; i++){
    80006696:	01048793          	addi	a5,s1,16
    8000669a:	02848613          	addi	a2,s1,40
        uint32 old = base[4+i];
    8000669e:	4398                	lw	a4,0(a5)
    800066a0:	2701                	sext.w	a4,a4
        base[4+i] = 0xffffffff;
    800066a2:	0157a023          	sw	s5,0(a5)
        __sync_synchronize();
    800066a6:	0ff0000f          	fence
        base[4+i] = old;
    800066aa:	c398                	sw	a4,0(a5)
      for(int i = 0; i < 6; i++){
    800066ac:	0791                	addi	a5,a5,4
    800066ae:	fec798e3          	bne	a5,a2,8000669e <pci_init+0x62>
    800066b2:	bf75                	j	8000666e <pci_init+0x32>
    }
  }
}
    800066b4:	60a6                	ld	ra,72(sp)
    800066b6:	6406                	ld	s0,64(sp)
    800066b8:	74e2                	ld	s1,56(sp)
    800066ba:	7942                	ld	s2,48(sp)
    800066bc:	79a2                	ld	s3,40(sp)
    800066be:	7a02                	ld	s4,32(sp)
    800066c0:	6ae2                	ld	s5,24(sp)
    800066c2:	6b42                	ld	s6,16(sp)
    800066c4:	6ba2                	ld	s7,8(sp)
    800066c6:	6161                	addi	sp,sp,80
    800066c8:	8082                	ret

00000000800066ca <timerinit>:
...
timerinit()
{
  ...
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    800066d0:	f14027f3          	csrr	a5,mhartid
  // each CPU has a separate source of timer interrupts.
  int id = r_mhartid();
    800066d4:	0007869b          	sext.w	a3,a5

  // ask the CLINT for a timer interrupt.
  int interval = 1000000; // cycles; about 1/10th second in qemu.
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
    800066d8:	0037979b          	slliw	a5,a5,0x3
    800066dc:	02004737          	lui	a4,0x2004
    800066e0:	97ba                	add	a5,a5,a4
    800066e2:	0200c737          	lui	a4,0x200c
    800066e6:	ff873583          	ld	a1,-8(a4) # 200bff8 <_entry-0x7dff4008>
    800066ea:	000f4637          	lui	a2,0xf4
    800066ee:	24060613          	addi	a2,a2,576 # f4240 <_entry-0x7ff0bdc0>
    800066f2:	95b2                	add	a1,a1,a2
    800066f4:	e38c                	sd	a1,0(a5)
  ...
  uint64 *scratch = &timer_scratch[id][0];
    800066f6:	00269713          	slli	a4,a3,0x2
    800066fa:	9736                	add	a4,a4,a3
    800066fc:	00371693          	slli	a3,a4,0x3
    80006700:	00019717          	auipc	a4,0x19
    80006704:	c4070713          	addi	a4,a4,-960 # 8001f340 <timer_scratch>
    80006708:	9736                	add	a4,a4,a3
  scratch[3] = CLINT_MTIMECMP(id);
    8000670a:	ef1c                	sd	a5,24(a4)
  scratch[4] = interval;
    8000670c:	f310                	sd	a2,32(a4)
  asm volatile("csrw mscratch, %0" : : "r" (x));
    8000670e:	34071073          	csrw	mscratch,a4
  asm volatile("csrw mtvec, %0" : : "r" (x));
    80006712:	fffff797          	auipc	a5,0xfffff
    80006716:	a1e78793          	addi	a5,a5,-1506 # 80005130 <timervec>
    8000671a:	30579073          	csrw	mtvec,a5
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    8000671e:	300027f3          	csrr	a5,mstatus
  ...
  w_mstatus(r_mstatus() | MSTATUS_MIE);
    80006722:	0087e793          	ori	a5,a5,8
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006726:	30079073          	csrw	mstatus,a5
  asm volatile("csrr %0, mie" : "=r" (x) );
    8000672a:	304027f3          	csrr	a5,mie

  // enable machine-mode timer interrupts.
  w_mie(r_mie() | MIE_MTIE);
    8000672e:	0807e793          	ori	a5,a5,128
  asm volatile("csrw mie, %0" : : "r" (x));
    80006732:	30479073          	csrw	mie,a5
}
    80006736:	6422                	ld	s0,8(sp)
    80006738:	0141                	addi	sp,sp,16
    8000673a:	8082                	ret

000000008000673c <start>:
{
    8000673c:	1141                	addi	sp,sp,-16
    8000673e:	e406                	sd	ra,8(sp)
    80006740:	e022                	sd	s0,0(sp)
    80006742:	0800                	addi	s0,sp,16
  asm volatile("csrr %0, mstatus" : "=r" (x) );
    80006744:	300027f3          	csrr	a5,mstatus
  x &= ~MSTATUS_MPP_MASK;
    80006748:	7779                	lui	a4,0xffffe
    8000674a:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffd727f>
    8000674e:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
    80006750:	6705                	lui	a4,0x1
    80006752:	80070713          	addi	a4,a4,-2048 # 800 <_entry-0x7ffff800>
    80006756:	8fd9                	or	a5,a5,a4
  asm volatile("csrw mstatus, %0" : : "r" (x));
    80006758:	30079073          	csrw	mstatus,a5
  asm volatile("csrw mepc, %0" : : "r" (x));
    8000675c:	ffffa797          	auipc	a5,0xffffa
    80006760:	bce78793          	addi	a5,a5,-1074 # 8000032a <main>
    80006764:	34179073          	csrw	mepc,a5
  asm volatile("csrw satp, %0" : : "r" (x));
    80006768:	4781                	li	a5,0
    8000676a:	18079073          	csrw	satp,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
    8000676e:	67c1                	lui	a5,0x10
    80006770:	17fd                	addi	a5,a5,-1
    80006772:	30279073          	csrw	medeleg,a5
  asm volatile("csrw mideleg, %0" : : "r" (x));
    80006776:	30379073          	csrw	mideleg,a5
  asm volatile("csrr %0, sie" : "=r" (x) );
    8000677a:	104027f3          	csrr	a5,sie
  w_sie(r_sie() | SIE_SEIE | SIE_STIE | SIE_SSIE);
    8000677e:	2227e793          	ori	a5,a5,546
  asm volatile("csrw sie, %0" : : "r" (x));
    80006782:	10479073          	csrw	sie,a5
  timerinit();
    80006786:	00000097          	auipc	ra,0x0
    8000678a:	f44080e7          	jalr	-188(ra) # 800066ca <timerinit>
  asm volatile("csrr %0, mhartid" : "=r" (x) );
    8000678e:	f14027f3          	csrr	a5,mhartid
  w_tp(id);
    80006792:	2781                	sext.w	a5,a5
  asm volatile("mv tp, %0" : : "r" (x));
    80006794:	823e                	mv	tp,a5
  asm volatile("mret");
    80006796:	30200073          	mret
}
...
{
    800067a2:	715d                	addi	sp,sp,-80
    800067a4:	e486                	sd	ra,72(sp)
    800067a6:	e0a2                	sd	s0,64(sp)
    800067a8:	fc26                	sd	s1,56(sp)
    800067aa:	f84a                	sd	s2,48(sp)
    800067ac:	f44e                	sd	s3,40(sp)
    800067ae:	f052                	sd	s4,32(sp)
    800067b0:	ec56                	sd	s5,24(sp)
    800067b2:	0880                	addi	s0,sp,80
  int i;

  for(i = 0; i < n; i++){
    800067b4:	04c05663          	blez	a2,80006800 <consolewrite+0x5e>
    800067b8:	8a2a                	mv	s4,a0
    800067ba:	84ae                	mv	s1,a1
    800067bc:	89b2                	mv	s3,a2
    800067be:	4901                	li	s2,0
    char c;
    if(either_copyin(&c, user_src, src+i, 1) == -1)
    800067c0:	5afd                	li	s5,-1
    800067c2:	4685                	li	a3,1
    800067c4:	8626                	mv	a2,s1
    800067c6:	85d2                	mv	a1,s4
    800067c8:	fbf40513          	addi	a0,s0,-65
    800067cc:	ffffb097          	auipc	ra,0xffffb
    800067d0:	1be080e7          	jalr	446(ra) # 8000198a <either_copyin>
    800067d4:	01550c63          	beq	a0,s5,800067ec <consolewrite+0x4a>
      break;
    uartputc(c);
    800067d8:	fbf44503          	lbu	a0,-65(s0)
    800067dc:	00000097          	auipc	ra,0x0
    800067e0:	78e080e7          	jalr	1934(ra) # 80006f6a <uartputc>
  for(i = 0; i < n; i++){
    800067e4:	2905                	addiw	s2,s2,1
    800067e6:	0485                	addi	s1,s1,1
    800067e8:	fd299de3          	bne	s3,s2,800067c2 <consolewrite+0x20>
  }

  return i;
}
    800067ec:	854a                	mv	a0,s2
    800067ee:	60a6                	ld	ra,72(sp)
    800067f0:	6406                	ld	s0,64(sp)
    800067f2:	74e2                	ld	s1,56(sp)
    800067f4:	7942                	ld	s2,48(sp)
    800067f6:	79a2                	ld	s3,40(sp)
    800067f8:	7a02                	ld	s4,32(sp)
    800067fa:	6ae2                	ld	s5,24(sp)
    800067fc:	6161                	addi	sp,sp,80
    800067fe:	8082                	ret
  for(i = 0; i < n; i++){
    80006800:	4901                	li	s2,0
    80006802:	b7ed                	j	800067ec <consolewrite+0x4a>

0000000080006804 <consoleread>:
...
{
    80006804:	7119                	addi	sp,sp,-128
    80006806:	fc86                	sd	ra,120(sp)
    80006808:	f8a2                	sd	s0,112(sp)
    8000680a:	f4a6                	sd	s1,104(sp)
    8000680c:	f0ca                	sd	s2,96(sp)
    8000680e:	ecce                	sd	s3,88(sp)
    80006810:	e8d2                	sd	s4,80(sp)
    80006812:	e4d6                	sd	s5,72(sp)
    80006814:	e0da                	sd	s6,64(sp)
    80006816:	fc5e                	sd	s7,56(sp)
    80006818:	f862                	sd	s8,48(sp)
    8000681a:	f466                	sd	s9,40(sp)
    8000681c:	f06a                	sd	s10,32(sp)
    8000681e:	ec6e                	sd	s11,24(sp)
    80006820:	0100                	addi	s0,sp,128
    80006822:	8b2a                	mv	s6,a0
    80006824:	8aae                	mv	s5,a1
    80006826:	8a32                	mv	s4,a2
  uint target;
  int c;
  char cbuf;

  target = n;
    80006828:	00060b9b          	sext.w	s7,a2
  acquire(&cons.lock);
    8000682c:	00021517          	auipc	a0,0x21
    80006830:	c5450513          	addi	a0,a0,-940 # 80027480 <cons>
    80006834:	00001097          	auipc	ra,0x1
    80006838:	8f4080e7          	jalr	-1804(ra) # 80007128 <acquire>
  while(n > 0){
    // wait until interrupt handler has put some
    // input into cons.buffer.
    while(cons.r == cons.w){
    8000683c:	00021497          	auipc	s1,0x21
    80006840:	c4448493          	addi	s1,s1,-956 # 80027480 <cons>
      if(myproc()->killed){
        release(&cons.lock);
        return -1;
      }
      sleep(&cons.r, &cons.lock);
    80006844:	89a6                	mv	s3,s1
    80006846:	00021917          	auipc	s2,0x21
    8000684a:	cd290913          	addi	s2,s2,-814 # 80027518 <cons+0x98>
    }

    c = cons.buf[cons.r++ % INPUT_BUF];

    if(c == C('D')){  // end-of-file
    8000684e:	4c91                	li	s9,4
      break;
    }
    ...
    if(c == '\n'){
    80006852:	4da9                	li	s11,10
  while(n > 0){
    80006854:	07405863          	blez	s4,800068c4 <consoleread+0xc0>
    while(cons.r == cons.w){
    80006858:	0984a783          	lw	a5,152(s1)
    8000685c:	09c4a703          	lw	a4,156(s1)
    80006860:	02f71463          	bne	a4,a5,80006888 <consoleread+0x84>
      if(myproc()->killed){
    80006864:	ffffa097          	auipc	ra,0xffffa
    80006868:	65e080e7          	jalr	1630(ra) # 80000ec2 <myproc>
    8000686c:	591c                	lw	a5,48(a0)
    8000686e:	e7b5                	bnez	a5,800068da <consoleread+0xd6>
      sleep(&cons.r, &cons.lock);
    80006870:	85ce                	mv	a1,s3
    80006872:	854a                	mv	a0,s2
    80006874:	ffffb097          	auipc	ra,0xffffb
    80006878:	e5e080e7          	jalr	-418(ra) # 800016d2 <sleep>
    while(cons.r == cons.w){
    8000687c:	0984a783          	lw	a5,152(s1)
    80006880:	09c4a703          	lw	a4,156(s1)
    80006884:	fef700e3          	beq	a4,a5,80006864 <consoleread+0x60>
    c = cons.buf[cons.r++ % INPUT_BUF];
    80006888:	0017871b          	addiw	a4,a5,1
    8000688c:	08e4ac23          	sw	a4,152(s1)
    80006890:	07f7f713          	andi	a4,a5,127
    80006894:	9726                	add	a4,a4,s1
    80006896:	01874703          	lbu	a4,24(a4)
    8000689a:	00070c1b          	sext.w	s8,a4
    if(c == C('D')){  // end-of-file
    8000689e:	079c0663          	beq	s8,s9,8000690a <consoleread+0x106>
    cbuf = c;
    800068a2:	f8e407a3          	sb	a4,-113(s0)
    if(either_copyout(user_dst, dst, &cbuf, 1) == -1)
    800068a6:	4685                	li	a3,1
    800068a8:	f8f40613          	addi	a2,s0,-113
    800068ac:	85d6                	mv	a1,s5
    800068ae:	855a                	mv	a0,s6
    800068b0:	ffffb097          	auipc	ra,0xffffb
    800068b4:	084080e7          	jalr	132(ra) # 80001934 <either_copyout>
    800068b8:	01a50663          	beq	a0,s10,800068c4 <consoleread+0xc0>
    dst++;
    800068bc:	0a85                	addi	s5,s5,1
    --n;
    800068be:	3a7d                	addiw	s4,s4,-1
    if(c == '\n'){
    800068c0:	f9bc1ae3          	bne	s8,s11,80006854 <consoleread+0x50>
  ...
  release(&cons.lock);
    ...
    800068c8:	bbc50513          	addi	a0,a0,-1092 # 80027480 <cons>
    800068cc:	00001097          	auipc	ra,0x1
    800068d0:	910080e7          	jalr	-1776(ra) # 800071dc <release>

  return target - n;
    800068d4:	414b853b          	subw	a0,s7,s4
    800068d8:	a811                	j	800068ec <consoleread+0xe8>
        release(&cons.lock);
    800068da:	00021517          	auipc	a0,0x21
    800068de:	ba650513          	addi	a0,a0,-1114 # 80027480 <cons>
    800068e2:	00001097          	auipc	ra,0x1
    800068e6:	8fa080e7          	jalr	-1798(ra) # 800071dc <release>
        return -1;
    800068ea:	557d                	li	a0,-1
}
    800068ec:	70e6                	ld	ra,120(sp)
    800068ee:	7446                	ld	s0,112(sp)
    800068f0:	74a6                	ld	s1,104(sp)
    800068f2:	7906                	ld	s2,96(sp)
    800068f4:	69e6                	ld	s3,88(sp)
    800068f6:	6a46                	ld	s4,80(sp)
    800068f8:	6aa6                	ld	s5,72(sp)
    800068fa:	6b06                	ld	s6,64(sp)
    800068fc:	7be2                	ld	s7,56(sp)
    800068fe:	7c42                	ld	s8,48(sp)
    80006900:	7ca2                	ld	s9,40(sp)
    80006902:	7d02                	ld	s10,32(sp)
    80006904:	6de2                	ld	s11,24(sp)
    80006906:	6109                	addi	sp,sp,128
    80006908:	8082                	ret
      if(n < target){
    8000690a:	000a071b          	sext.w	a4,s4
    8000690e:	fb777be3          	bgeu	a4,s7,800068c4 <consoleread+0xc0>
        cons.r--;
    80006912:	00021717          	auipc	a4,0x21
    80006916:	c0f72323          	sw	a5,-1018(a4) # 80027518 <cons+0x98>
    8000691a:	b76d                	j	800068c4 <consoleread+0xc0>

000000008000691c <consputc>:
{
    8000691c:	1141                	addi	sp,sp,-16
    8000691e:	e406                	sd	ra,8(sp)
    80006920:	e022                	sd	s0,0(sp)
    80006922:	0800                	addi	s0,sp,16
  if(c == BACKSPACE){
    80006924:	10000793          	li	a5,256
    80006928:	00f50a63          	beq	a0,a5,8000693c <consputc+0x20>
    uartputc_sync(c);
    8000692c:	00000097          	auipc	ra,0x0
    80006930:	564080e7          	jalr	1380(ra) # 80006e90 <uartputc_sync>
}
    ...
    8000693c:	4521                	li	a0,8
    8000693e:	00000097          	auipc	ra,0x0
    80006942:	552080e7          	jalr	1362(ra) # 80006e90 <uartputc_sync>
    80006946:	02000513          	li	a0,32
    8000694a:	00000097          	auipc	ra,0x0
    8000694e:	546080e7          	jalr	1350(ra) # 80006e90 <uartputc_sync>
    80006952:	4521                	li	a0,8
    80006954:	00000097          	auipc	ra,0x0
    80006958:	53c080e7          	jalr	1340(ra) # 80006e90 <uartputc_sync>
    8000695c:	bfe1                	j	80006934 <consputc+0x18>

000000008000695e <consoleintr>:
...
consoleintr(int c)
{
    8000695e:	1101                	addi	sp,sp,-32
    80006960:	ec06                	sd	ra,24(sp)
    80006962:	e822                	sd	s0,16(sp)
    80006964:	e426                	sd	s1,8(sp)
    80006966:	e04a                	sd	s2,0(sp)
    80006968:	1000                	addi	s0,sp,32
    8000696a:	84aa                	mv	s1,a0
  acquire(&cons.lock);
    8000696c:	00021517          	auipc	a0,0x21
    80006970:	b1450513          	addi	a0,a0,-1260 # 80027480 <cons>
    80006974:	00000097          	auipc	ra,0x0
    80006978:	7b4080e7          	jalr	1972(ra) # 80007128 <acquire>

  switch(c){
    8000697c:	47d5                	li	a5,21
    8000697e:	0af48663          	beq	s1,a5,80006a2a <consoleintr+0xcc>
    80006982:	0297ca63          	blt	a5,s1,800069b6 <consoleintr+0x58>
    80006986:	47a1                	li	a5,8
    80006988:	0ef48763          	beq	s1,a5,80006a76 <consoleintr+0x118>
    8000698c:	47c1                	li	a5,16
    8000698e:	10f49a63          	bne	s1,a5,80006aa2 <consoleintr+0x144>
  case C('P'):  // Print process list.
    procdump();
    80006992:	ffffb097          	auipc	ra,0xffffb
    80006996:	04e080e7          	jalr	78(ra) # 800019e0 <procdump>
      }
    }
    break;
  }
  ...
  release(&cons.lock);
    8000699a:	00021517          	auipc	a0,0x21
    8000699e:	ae650513          	addi	a0,a0,-1306 # 80027480 <cons>
    800069a2:	00001097          	auipc	ra,0x1
    800069a6:	83a080e7          	jalr	-1990(ra) # 800071dc <release>
}
    ...
    800069b4:	8082                	ret
  switch(c){
    800069b6:	07f00793          	li	a5,127
    800069ba:	0af48e63          	beq	s1,a5,80006a76 <consoleintr+0x118>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    800069be:	00021717          	auipc	a4,0x21
    800069c2:	ac270713          	addi	a4,a4,-1342 # 80027480 <cons>
    800069c6:	0a072783          	lw	a5,160(a4)
    800069ca:	09872703          	lw	a4,152(a4)
    800069ce:	9f99                	subw	a5,a5,a4
    800069d0:	07f00713          	li	a4,127
    800069d4:	fcf763e3          	bltu	a4,a5,8000699a <consoleintr+0x3c>
      c = (c == '\r') ? '\n' : c;
    800069d8:	47b5                	li	a5,13
    800069da:	0cf48763          	beq	s1,a5,80006aa8 <consoleintr+0x14a>
      consputc(c);
    800069de:	8526                	mv	a0,s1
    800069e0:	00000097          	auipc	ra,0x0
    800069e4:	f3c080e7          	jalr	-196(ra) # 8000691c <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    800069e8:	00021797          	auipc	a5,0x21
    800069ec:	a9878793          	addi	a5,a5,-1384 # 80027480 <cons>
    800069f0:	0a07a703          	lw	a4,160(a5)
    800069f4:	0017069b          	addiw	a3,a4,1
    800069f8:	0006861b          	sext.w	a2,a3
    800069fc:	0ad7a023          	sw	a3,160(a5)
    80006a00:	07f77713          	andi	a4,a4,127
    80006a04:	97ba                	add	a5,a5,a4
    80006a06:	00978c23          	sb	s1,24(a5)
      if(c == '\n' || c == C('D') || cons.e == cons.r+INPUT_BUF){
    80006a0a:	47a9                	li	a5,10
    80006a0c:	0cf48563          	beq	s1,a5,80006ad6 <consoleintr+0x178>
    80006a10:	4791                	li	a5,4
    80006a12:	0cf48263          	beq	s1,a5,80006ad6 <consoleintr+0x178>
    80006a16:	00021797          	auipc	a5,0x21
    80006a1a:	b027a783          	lw	a5,-1278(a5) # 80027518 <cons+0x98>
    80006a1e:	0807879b          	addiw	a5,a5,128
    80006a22:	f6f61ce3          	bne	a2,a5,8000699a <consoleintr+0x3c>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006a26:	863e                	mv	a2,a5
    80006a28:	a07d                	j	80006ad6 <consoleintr+0x178>
    while(cons.e != cons.w &&
    80006a2a:	00021717          	auipc	a4,0x21
    80006a2e:	a5670713          	addi	a4,a4,-1450 # 80027480 <cons>
    80006a32:	0a072783          	lw	a5,160(a4)
    80006a36:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a3a:	00021497          	auipc	s1,0x21
    80006a3e:	a4648493          	addi	s1,s1,-1466 # 80027480 <cons>
    while(cons.e != cons.w &&
    80006a42:	4929                	li	s2,10
    80006a44:	f4f70be3          	beq	a4,a5,8000699a <consoleintr+0x3c>
          cons.buf[(cons.e-1) % INPUT_BUF] != '\n'){
    80006a48:	37fd                	addiw	a5,a5,-1
    80006a4a:	07f7f713          	andi	a4,a5,127
    80006a4e:	9726                	add	a4,a4,s1
    while(cons.e != cons.w &&
    80006a50:	01874703          	lbu	a4,24(a4)
    80006a54:	f52703e3          	beq	a4,s2,8000699a <consoleintr+0x3c>
      cons.e--;
    80006a58:	0af4a023          	sw	a5,160(s1)
      consputc(BACKSPACE);
    80006a5c:	10000513          	li	a0,256
    80006a60:	00000097          	auipc	ra,0x0
    80006a64:	ebc080e7          	jalr	-324(ra) # 8000691c <consputc>
    while(cons.e != cons.w &&
    80006a68:	0a04a783          	lw	a5,160(s1)
    80006a6c:	09c4a703          	lw	a4,156(s1)
    80006a70:	fcf71ce3          	bne	a4,a5,80006a48 <consoleintr+0xea>
    80006a74:	b71d                	j	8000699a <consoleintr+0x3c>
    if(cons.e != cons.w){
    80006a76:	00021717          	auipc	a4,0x21
    80006a7a:	a0a70713          	addi	a4,a4,-1526 # 80027480 <cons>
    80006a7e:	0a072783          	lw	a5,160(a4)
    80006a82:	09c72703          	lw	a4,156(a4)
    80006a86:	f0f70ae3          	beq	a4,a5,8000699a <consoleintr+0x3c>
      cons.e--;
    80006a8a:	37fd                	addiw	a5,a5,-1
    80006a8c:	00021717          	auipc	a4,0x21
    80006a90:	a8f72a23          	sw	a5,-1388(a4) # 80027520 <cons+0xa0>
      consputc(BACKSPACE);
    80006a94:	10000513          	li	a0,256
    80006a98:	00000097          	auipc	ra,0x0
    80006a9c:	e84080e7          	jalr	-380(ra) # 8000691c <consputc>
    80006aa0:	bded                	j	8000699a <consoleintr+0x3c>
    if(c != 0 && cons.e-cons.r < INPUT_BUF){
    80006aa2:	ee048ce3          	beqz	s1,8000699a <consoleintr+0x3c>
    80006aa6:	bf21                	j	800069be <consoleintr+0x60>
      consputc(c);
    80006aa8:	4529                	li	a0,10
    80006aaa:	00000097          	auipc	ra,0x0
    80006aae:	e72080e7          	jalr	-398(ra) # 8000691c <consputc>
      cons.buf[cons.e++ % INPUT_BUF] = c;
    80006ab2:	00021797          	auipc	a5,0x21
    80006ab6:	9ce78793          	addi	a5,a5,-1586 # 80027480 <cons>
    80006aba:	0a07a703          	lw	a4,160(a5)
    80006abe:	0017069b          	addiw	a3,a4,1
    80006ac2:	0006861b          	sext.w	a2,a3
    80006ac6:	0ad7a023          	sw	a3,160(a5)
    80006aca:	07f77713          	andi	a4,a4,127
    80006ace:	97ba                	add	a5,a5,a4
    80006ad0:	4729                	li	a4,10
    80006ad2:	00e78c23          	sb	a4,24(a5)
        cons.w = cons.e;
    80006ad6:	00021797          	auipc	a5,0x21
    80006ada:	a4c7a323          	sw	a2,-1466(a5) # 8002751c <cons+0x9c>
        wakeup(&cons.r);
    80006ade:	00021517          	auipc	a0,0x21
    80006ae2:	a3a50513          	addi	a0,a0,-1478 # 80027518 <cons+0x98>
    80006ae6:	ffffb097          	auipc	ra,0xffffb
    80006aea:	d72080e7          	jalr	-654(ra) # 80001858 <wakeup>
    80006aee:	b575                	j	8000699a <consoleintr+0x3c>

0000000080006af0 <consoleinit>:

void
consoleinit(void)
{
    80006af0:	1141                	addi	sp,sp,-16
    80006af2:	e406                	sd	ra,8(sp)
    80006af4:	e022                	sd	s0,0(sp)
    80006af6:	0800                	addi	s0,sp,16
  initlock(&cons.lock, "cons");
    80006af8:	00003597          	auipc	a1,0x3
    80006afc:	cf058593          	addi	a1,a1,-784 # 800097e8 <syscalls+0x438>
    80006b00:	00021517          	auipc	a0,0x21
    80006b04:	98050513          	addi	a0,a0,-1664 # 80027480 <cons>
    80006b08:	00000097          	auipc	ra,0x0
    80006b0c:	590080e7          	jalr	1424(ra) # 80007098 <initlock>

  uartinit();
    80006b10:	00000097          	auipc	ra,0x0
    80006b14:	330080e7          	jalr	816(ra) # 80006e40 <uartinit>

  // connect read and write system calls
  // to consoleread and consolewrite.
  devsw[CONSOLE].read = consoleread;
    80006b18:	00013797          	auipc	a5,0x13
    80006b1c:	5b878793          	addi	a5,a5,1464 # 8001a0d0 <devsw>
    80006b20:	00000717          	auipc	a4,0x0
    80006b24:	ce470713          	addi	a4,a4,-796 # 80006804 <consoleread>
    80006b28:	eb98                	sd	a4,16(a5)
  devsw[CONSOLE].write = consolewrite;
    80006b2a:	00000717          	auipc	a4,0x0
    80006b2e:	c7870713          	addi	a4,a4,-904 # 800067a2 <consolewrite>
    80006b32:	ef98                	sd	a4,24(a5)
}
    80006b34:	60a2                	ld	ra,8(sp)
    80006b36:	6402                	ld	s0,0(sp)
    80006b38:	0141                	addi	sp,sp,16
    80006b3a:	8082                	ret

0000000080006b3c <printint>:
...
{
    80006b3c:	7179                	addi	sp,sp,-48
    80006b3e:	f406                	sd	ra,40(sp)
    80006b40:	f022                	sd	s0,32(sp)
    80006b42:	ec26                	sd	s1,24(sp)
    80006b44:	e84a                	sd	s2,16(sp)
    80006b46:	1800                	addi	s0,sp,48
  char buf[16];
  int i;
  uint x;

  if(sign && (sign = xx < 0))
    80006b48:	c219                	beqz	a2,80006b4e <printint+0x12>
    80006b4a:	08054663          	bltz	a0,80006bd6 <printint+0x9a>
    x = -xx;
  else
    x = xx;
    80006b4e:	2501                	sext.w	a0,a0
    80006b50:	4881                	li	a7,0
    80006b52:	fd040693          	addi	a3,s0,-48

  i = 0;
    80006b56:	4701                	li	a4,0
  do {
    buf[i++] = digits[x % base];
    80006b58:	2581                	sext.w	a1,a1
    80006b5a:	00003617          	auipc	a2,0x3
    80006b5e:	cbe60613          	addi	a2,a2,-834 # 80009818 <digits>
    80006b62:	883a                	mv	a6,a4
    80006b64:	2705                	addiw	a4,a4,1
    80006b66:	02b577bb          	remuw	a5,a0,a1
    80006b6a:	1782                	slli	a5,a5,0x20
    80006b6c:	9381                	srli	a5,a5,0x20
    80006b6e:	97b2                	add	a5,a5,a2
    80006b70:	0007c783          	lbu	a5,0(a5)
    80006b74:	00f68023          	sb	a5,0(a3)
  } while((x /= base) != 0);
    80006b78:	0005079b          	sext.w	a5,a0
    80006b7c:	02b5553b          	divuw	a0,a0,a1
    80006b80:	0685                	addi	a3,a3,1
    80006b82:	feb7f0e3          	bgeu	a5,a1,80006b62 <printint+0x26>

  if(sign)
    80006b86:	00088b63          	beqz	a7,80006b9c <printint+0x60>
    buf[i++] = '-';
    80006b8a:	fe040793          	addi	a5,s0,-32
    80006b8e:	973e                	add	a4,a4,a5
    80006b90:	02d00793          	li	a5,45
    80006b94:	fef70823          	sb	a5,-16(a4)
    80006b98:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    80006b9c:	02e05763          	blez	a4,80006bca <printint+0x8e>
    80006ba0:	fd040793          	addi	a5,s0,-48
    80006ba4:	00e784b3          	add	s1,a5,a4
    80006ba8:	fff78913          	addi	s2,a5,-1
    80006bac:	993a                	add	s2,s2,a4
    80006bae:	377d                	addiw	a4,a4,-1
    80006bb0:	1702                	slli	a4,a4,0x20
    80006bb2:	9301                	srli	a4,a4,0x20
    80006bb4:	40e90933          	sub	s2,s2,a4
    consputc(buf[i]);
    80006bb8:	fff4c503          	lbu	a0,-1(s1)
    80006bbc:	00000097          	auipc	ra,0x0
    80006bc0:	d60080e7          	jalr	-672(ra) # 8000691c <consputc>
  while(--i >= 0)
    80006bc4:	14fd                	addi	s1,s1,-1
    80006bc6:	ff2499e3          	bne	s1,s2,80006bb8 <printint+0x7c>
}
    80006bca:	70a2                	ld	ra,40(sp)
    80006bcc:	7402                	ld	s0,32(sp)
    80006bce:	64e2                	ld	s1,24(sp)
    80006bd0:	6942                	ld	s2,16(sp)
    80006bd2:	6145                	addi	sp,sp,48
    80006bd4:	8082                	ret
    x = -xx;
    80006bd6:	40a0053b          	negw	a0,a0
  if(sign && (sign = xx < 0))
    80006bda:	4885                	li	a7,1
    x = -xx;
    80006bdc:	bf9d                	j	80006b52 <printint+0x16>

0000000080006bde <panic>:
    release(&pr.lock);
}
...
panic(char *s)
{
    80006bde:	1101                	addi	sp,sp,-32
    80006be0:	ec06                	sd	ra,24(sp)
    80006be2:	e822                	sd	s0,16(sp)
    80006be4:	e426                	sd	s1,8(sp)
    80006be6:	1000                	addi	s0,sp,32
    80006be8:	84aa                	mv	s1,a0
  pr.locking = 0;
    80006bea:	00021797          	auipc	a5,0x21
    80006bee:	9407ab23          	sw	zero,-1706(a5) # 80027540 <pr+0x18>
  printf("panic: ");
    80006bf2:	00003517          	auipc	a0,0x3
    80006bf6:	bfe50513          	addi	a0,a0,-1026 # 800097f0 <syscalls+0x440>
    80006bfa:	00000097          	auipc	ra,0x0
    80006bfe:	02e080e7          	jalr	46(ra) # 80006c28 <printf>
  printf(s);
    80006c02:	8526                	mv	a0,s1
    80006c04:	00000097          	auipc	ra,0x0
    80006c08:	024080e7          	jalr	36(ra) # 80006c28 <printf>
  printf("\n");
    80006c0c:	00002517          	auipc	a0,0x2
    80006c10:	43c50513          	addi	a0,a0,1084 # 80009048 <etext+0x48>
    80006c14:	00000097          	auipc	ra,0x0
    80006c18:	014080e7          	jalr	20(ra) # 80006c28 <printf>
  panicked = 1; // freeze uart output from other CPUs
    80006c1c:	4785                	li	a5,1
    80006c1e:	00003717          	auipc	a4,0x3
    80006c22:	40f72923          	sw	a5,1042(a4) # 8000a030 <panicked>
  for(;;)
    80006c26:	a001                	j	80006c26 <panic+0x48>

0000000080006c28 <printf>:
{
    80006c28:	7131                	addi	sp,sp,-192
    80006c2a:	fc86                	sd	ra,120(sp)
    80006c2c:	f8a2                	sd	s0,112(sp)
    80006c2e:	f4a6                	sd	s1,104(sp)
    80006c30:	f0ca                	sd	s2,96(sp)
    80006c32:	ecce                	sd	s3,88(sp)
    80006c34:	e8d2                	sd	s4,80(sp)
    80006c36:	e4d6                	sd	s5,72(sp)
    80006c38:	e0da                	sd	s6,64(sp)
    80006c3a:	fc5e                	sd	s7,56(sp)
    80006c3c:	f862                	sd	s8,48(sp)
    80006c3e:	f466                	sd	s9,40(sp)
    80006c40:	f06a                	sd	s10,32(sp)
    80006c42:	ec6e                	sd	s11,24(sp)
    80006c44:	0100                	addi	s0,sp,128
    80006c46:	8a2a                	mv	s4,a0
    80006c48:	e40c                	sd	a1,8(s0)
    80006c4a:	e810                	sd	a2,16(s0)
    80006c4c:	ec14                	sd	a3,24(s0)
    80006c4e:	f018                	sd	a4,32(s0)
    80006c50:	f41c                	sd	a5,40(s0)
    80006c52:	03043823          	sd	a6,48(s0)
    80006c56:	03143c23          	sd	a7,56(s0)
  locking = pr.locking;
    80006c5a:	00021d97          	auipc	s11,0x21
    80006c5e:	8e6dad83          	lw	s11,-1818(s11) # 80027540 <pr+0x18>
  if(locking)
    80006c62:	020d9b63          	bnez	s11,80006c98 <printf+0x70>
  if (fmt == 0)
    80006c66:	040a0263          	beqz	s4,80006caa <printf+0x82>
  va_start(ap, fmt);
    80006c6a:	00840793          	addi	a5,s0,8
    80006c6e:	f8f43423          	sd	a5,-120(s0)
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006c72:	000a4503          	lbu	a0,0(s4) # 2000 <_entry-0x7fffe000>
    80006c76:	16050263          	beqz	a0,80006dda <printf+0x1b2>
    80006c7a:	4481                	li	s1,0
    if(c != '%'){
    80006c7c:	02500a93          	li	s5,37
    switch(c){
    80006c80:	07000b13          	li	s6,112
  consputc('x');
    80006c84:	4d41                	li	s10,16
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006c86:	00003b97          	auipc	s7,0x3
    80006c8a:	b92b8b93          	addi	s7,s7,-1134 # 80009818 <digits>
    switch(c){
    80006c8e:	07300c93          	li	s9,115
    80006c92:	06400c13          	li	s8,100
    80006c96:	a82d                	j	80006cd0 <printf+0xa8>
    acquire(&pr.lock);
    80006c98:	00021517          	auipc	a0,0x21
    80006c9c:	89050513          	addi	a0,a0,-1904 # 80027528 <pr>
    80006ca0:	00000097          	auipc	ra,0x0
    80006ca4:	488080e7          	jalr	1160(ra) # 80007128 <acquire>
    80006ca8:	bf7d                	j	80006c66 <printf+0x3e>
    panic("null fmt");
    80006caa:	00003517          	auipc	a0,0x3
    80006cae:	b5650513          	addi	a0,a0,-1194 # 80009800 <syscalls+0x450>
    80006cb2:	00000097          	auipc	ra,0x0
    80006cb6:	f2c080e7          	jalr	-212(ra) # 80006bde <panic>
      consputc(c);
    80006cba:	00000097          	auipc	ra,0x0
    80006cbe:	c62080e7          	jalr	-926(ra) # 8000691c <consputc>
  for(i = 0; (c = fmt[i] & 0xff) != 0; i++){
    80006cc2:	2485                	addiw	s1,s1,1
    80006cc4:	009a07b3          	add	a5,s4,s1
    80006cc8:	0007c503          	lbu	a0,0(a5)
    80006ccc:	10050763          	beqz	a0,80006dda <printf+0x1b2>
    if(c != '%'){
    80006cd0:	ff5515e3          	bne	a0,s5,80006cba <printf+0x92>
    c = fmt[++i] & 0xff;
    80006cd4:	2485                	addiw	s1,s1,1
    80006cd6:	009a07b3          	add	a5,s4,s1
    80006cda:	0007c783          	lbu	a5,0(a5)
    80006cde:	0007891b          	sext.w	s2,a5
    if(c == 0)
    80006ce2:	cfe5                	beqz	a5,80006dda <printf+0x1b2>
    switch(c){
    80006ce4:	05678a63          	beq	a5,s6,80006d38 <printf+0x110>
    80006ce8:	02fb7663          	bgeu	s6,a5,80006d14 <printf+0xec>
    80006cec:	09978963          	beq	a5,s9,80006d7e <printf+0x156>
    80006cf0:	07800713          	li	a4,120
    80006cf4:	0ce79863          	bne	a5,a4,80006dc4 <printf+0x19c>
      printint(va_arg(ap, int), 16, 1);
    80006cf8:	f8843783          	ld	a5,-120(s0)
    80006cfc:	00878713          	addi	a4,a5,8
    80006d00:	f8e43423          	sd	a4,-120(s0)
    80006d04:	4605                	li	a2,1
    80006d06:	85ea                	mv	a1,s10
    80006d08:	4388                	lw	a0,0(a5)
    80006d0a:	00000097          	auipc	ra,0x0
    80006d0e:	e32080e7          	jalr	-462(ra) # 80006b3c <printint>
      break;
    80006d12:	bf45                	j	80006cc2 <printf+0x9a>
    switch(c){
    80006d14:	0b578263          	beq	a5,s5,80006db8 <printf+0x190>
    80006d18:	0b879663          	bne	a5,s8,80006dc4 <printf+0x19c>
      printint(va_arg(ap, int), 10, 1);
    80006d1c:	f8843783          	ld	a5,-120(s0)
    80006d20:	00878713          	addi	a4,a5,8
    80006d24:	f8e43423          	sd	a4,-120(s0)
    80006d28:	4605                	li	a2,1
    80006d2a:	45a9                	li	a1,10
    80006d2c:	4388                	lw	a0,0(a5)
    80006d2e:	00000097          	auipc	ra,0x0
    80006d32:	e0e080e7          	jalr	-498(ra) # 80006b3c <printint>
      break;
    80006d36:	b771                	j	80006cc2 <printf+0x9a>
      printptr(va_arg(ap, uint64));
    80006d38:	f8843783          	ld	a5,-120(s0)
    80006d3c:	00878713          	addi	a4,a5,8
    80006d40:	f8e43423          	sd	a4,-120(s0)
    80006d44:	0007b983          	ld	s3,0(a5)
  consputc('0');
    80006d48:	03000513          	li	a0,48
    80006d4c:	00000097          	auipc	ra,0x0
    80006d50:	bd0080e7          	jalr	-1072(ra) # 8000691c <consputc>
  consputc('x');
    80006d54:	07800513          	li	a0,120
    80006d58:	00000097          	auipc	ra,0x0
    80006d5c:	bc4080e7          	jalr	-1084(ra) # 8000691c <consputc>
    80006d60:	896a                	mv	s2,s10
    consputc(digits[x >> (sizeof(uint64) * 8 - 4)]);
    80006d62:	03c9d793          	srli	a5,s3,0x3c
    80006d66:	97de                	add	a5,a5,s7
    80006d68:	0007c503          	lbu	a0,0(a5)
    80006d6c:	00000097          	auipc	ra,0x0
    80006d70:	bb0080e7          	jalr	-1104(ra) # 8000691c <consputc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    80006d74:	0992                	slli	s3,s3,0x4
    80006d76:	397d                	addiw	s2,s2,-1
    80006d78:	fe0915e3          	bnez	s2,80006d62 <printf+0x13a>
    80006d7c:	b799                	j	80006cc2 <printf+0x9a>
      if((s = va_arg(ap, char*)) == 0)
    80006d7e:	f8843783          	ld	a5,-120(s0)
    80006d82:	00878713          	addi	a4,a5,8
    80006d86:	f8e43423          	sd	a4,-120(s0)
    80006d8a:	0007b903          	ld	s2,0(a5)
    80006d8e:	00090e63          	beqz	s2,80006daa <printf+0x182>
      for(; *s; s++)
    80006d92:	00094503          	lbu	a0,0(s2)
    80006d96:	d515                	beqz	a0,80006cc2 <printf+0x9a>
        consputc(*s);
    80006d98:	00000097          	auipc	ra,0x0
    80006d9c:	b84080e7          	jalr	-1148(ra) # 8000691c <consputc>
      for(; *s; s++)
    80006da0:	0905                	addi	s2,s2,1
    80006da2:	00094503          	lbu	a0,0(s2)
    80006da6:	f96d                	bnez	a0,80006d98 <printf+0x170>
    80006da8:	bf29                	j	80006cc2 <printf+0x9a>
        s = "(null)";
    80006daa:	00003917          	auipc	s2,0x3
    80006dae:	a4e90913          	addi	s2,s2,-1458 # 800097f8 <syscalls+0x448>
      for(; *s; s++)
    80006db2:	02800513          	li	a0,40
    80006db6:	b7cd                	j	80006d98 <printf+0x170>
      consputc('%');
    80006db8:	8556                	mv	a0,s5
    80006dba:	00000097          	auipc	ra,0x0
    80006dbe:	b62080e7          	jalr	-1182(ra) # 8000691c <consputc>
      break;
    80006dc2:	b701                	j	80006cc2 <printf+0x9a>
      consputc('%');
    80006dc4:	8556                	mv	a0,s5
    80006dc6:	00000097          	auipc	ra,0x0
    80006dca:	b56080e7          	jalr	-1194(ra) # 8000691c <consputc>
      consputc(c);
    80006dce:	854a                	mv	a0,s2
    80006dd0:	00000097          	auipc	ra,0x0
    80006dd4:	b4c080e7          	jalr	-1204(ra) # 8000691c <consputc>
      break;
    80006dd8:	b5ed                	j	80006cc2 <printf+0x9a>
  if(locking)
    80006dda:	020d9163          	bnez	s11,80006dfc <printf+0x1d4>
}
    80006dde:	70e6                	ld	ra,120(sp)
    80006de0:	7446                	ld	s0,112(sp)
    80006de2:	74a6                	ld	s1,104(sp)
    80006de4:	7906                	ld	s2,96(sp)
    80006de6:	69e6                	ld	s3,88(sp)
    80006de8:	6a46                	ld	s4,80(sp)
    80006dea:	6aa6                	ld	s5,72(sp)
    80006dec:	6b06                	ld	s6,64(sp)
    80006dee:	7be2                	ld	s7,56(sp)
    80006df0:	7c42                	ld	s8,48(sp)
    80006df2:	7ca2                	ld	s9,40(sp)
    80006df4:	7d02                	ld	s10,32(sp)
    80006df6:	6de2                	ld	s11,24(sp)
    80006df8:	6129                	addi	sp,sp,192
    80006dfa:	8082                	ret
    release(&pr.lock);
    80006dfc:	00020517          	auipc	a0,0x20
    80006e00:	72c50513          	addi	a0,a0,1836 # 80027528 <pr>
    80006e04:	00000097          	auipc	ra,0x0
    80006e08:	3d8080e7          	jalr	984(ra) # 800071dc <release>
}
    80006e0c:	bfc9                	j	80006dde <printf+0x1b6>

0000000080006e0e <printfinit>:
    ;
}
...
printfinit(void)
{
    80006e0e:	1101                	addi	sp,sp,-32
    80006e10:	ec06                	sd	ra,24(sp)
    80006e12:	e822                	sd	s0,16(sp)
    80006e14:	e426                	sd	s1,8(sp)
    80006e16:	1000                	addi	s0,sp,32
  initlock(&pr.lock, "pr");
    80006e18:	00020497          	auipc	s1,0x20
    80006e1c:	71048493          	addi	s1,s1,1808 # 80027528 <pr>
    80006e20:	00003597          	auipc	a1,0x3
    80006e24:	9f058593          	addi	a1,a1,-1552 # 80009810 <syscalls+0x460>
    80006e28:	8526                	mv	a0,s1
    80006e2a:	00000097          	auipc	ra,0x0
    80006e2e:	26e080e7          	jalr	622(ra) # 80007098 <initlock>
  pr.locking = 1;
    80006e32:	4785                	li	a5,1
    80006e34:	cc9c                	sw	a5,24(s1)
}
    80006e36:	60e2                	ld	ra,24(sp)
    80006e38:	6442                	ld	s0,16(sp)
    80006e3a:	64a2                	ld	s1,8(sp)
    80006e3c:	6105                	addi	sp,sp,32
    80006e3e:	8082                	ret

0000000080006e40 <uartinit>:
...
uartinit(void)
{
    80006e40:	1141                	addi	sp,sp,-16
    80006e42:	e406                	sd	ra,8(sp)
    80006e44:	e022                	sd	s0,0(sp)
    80006e46:	0800                	addi	s0,sp,16
  // disable interrupts.
  WriteReg(IER, 0x00);
    80006e48:	100007b7          	lui	a5,0x10000
    80006e4c:	000780a3          	sb	zero,1(a5) # 10000001 <_entry-0x6fffffff>

  // special mode to set baud rate.
  WriteReg(LCR, LCR_BAUD_LATCH);
    80006e50:	f8000713          	li	a4,-128
    80006e54:	00e781a3          	sb	a4,3(a5)

  // LSB for baud rate of 38.4K.
  WriteReg(0, 0x03);
    80006e58:	470d                	li	a4,3
    80006e5a:	00e78023          	sb	a4,0(a5)

  // MSB for baud rate of 38.4K.
  WriteReg(1, 0x00);
    80006e5e:	000780a3          	sb	zero,1(a5)

  // leave set-baud mode,
  // and set word length to 8 bits, no parity.
  WriteReg(LCR, LCR_EIGHT_BITS);
    80006e62:	00e781a3          	sb	a4,3(a5)

  // reset and enable FIFOs.
  WriteReg(FCR, FCR_FIFO_ENABLE | FCR_FIFO_CLEAR);
    80006e66:	469d                	li	a3,7
    80006e68:	00d78123          	sb	a3,2(a5)

  // enable transmit and receive interrupts.
  WriteReg(IER, IER_TX_ENABLE | IER_RX_ENABLE);
    80006e6c:	00e780a3          	sb	a4,1(a5)

  initlock(&uart_tx_lock, "uart");
    80006e70:	00003597          	auipc	a1,0x3
    80006e74:	9c058593          	addi	a1,a1,-1600 # 80009830 <digits+0x18>
    80006e78:	00020517          	auipc	a0,0x20
    80006e7c:	6d050513          	addi	a0,a0,1744 # 80027548 <uart_tx_lock>
    80006e80:	00000097          	auipc	ra,0x0
    80006e84:	218080e7          	jalr	536(ra) # 80007098 <initlock>
}
    80006e88:	60a2                	ld	ra,8(sp)
    80006e8a:	6402                	ld	s0,0(sp)
...
uartputc_sync(int c)
{
    80006e90:	1101                	addi	sp,sp,-32
    80006e92:	ec06                	sd	ra,24(sp)
    80006e94:	e822                	sd	s0,16(sp)
    80006e96:	e426                	sd	s1,8(sp)
    80006e98:	1000                	addi	s0,sp,32
    80006e9a:	84aa                	mv	s1,a0
  push_off();
    80006e9c:	00000097          	auipc	ra,0x0
    80006ea0:	240080e7          	jalr	576(ra) # 800070dc <push_off>

  if(panicked){
    80006ea4:	00003797          	auipc	a5,0x3
    80006ea8:	18c7a783          	lw	a5,396(a5) # 8000a030 <panicked>
    for(;;)
      ;
  }
  ...
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006eac:	10000737          	lui	a4,0x10000
  if(panicked){
    80006eb0:	c391                	beqz	a5,80006eb4 <uartputc_sync+0x24>
    for(;;)
    80006eb2:	a001                	j	80006eb2 <uartputc_sync+0x22>
  while((ReadReg(LSR) & LSR_TX_IDLE) == 0)
    80006eb4:	00574783          	lbu	a5,5(a4) # 10000005 <_entry-0x6ffffffb>
    80006eb8:	0ff7f793          	andi	a5,a5,255
    80006ebc:	0207f793          	andi	a5,a5,32
    80006ec0:	dbf5                	beqz	a5,80006eb4 <uartputc_sync+0x24>
    ;
  WriteReg(THR, c);
    80006ec2:	0ff4f793          	andi	a5,s1,255
    80006ec6:	10000737          	lui	a4,0x10000
    80006eca:	00f70023          	sb	a5,0(a4) # 10000000 <_entry-0x70000000>

  pop_off();
    80006ece:	00000097          	auipc	ra,0x0
    80006ed2:	2ae080e7          	jalr	686(ra) # 8000717c <pop_off>
}
    80006ed6:	60e2                	ld	ra,24(sp)
    80006ed8:	6442                	ld	s0,16(sp)
    80006eda:	64a2                	ld	s1,8(sp)
    80006edc:	6105                	addi	sp,sp,32
    80006ede:	8082                	ret

0000000080006ee0 <uartstart>:
...
uartstart()
{
  while(1){
    ...
    80006ee4:	15873703          	ld	a4,344(a4) # 8000a038 <uart_tx_r>
    80006ee8:	00003797          	auipc	a5,0x3
    80006eec:	1587b783          	ld	a5,344(a5) # 8000a040 <uart_tx_w>
    80006ef0:	06e78c63          	beq	a5,a4,80006f68 <uartstart+0x88>
{
    80006ef4:	7139                	addi	sp,sp,-64
    80006ef6:	fc06                	sd	ra,56(sp)
    80006ef8:	f822                	sd	s0,48(sp)
    80006efa:	f426                	sd	s1,40(sp)
    80006efc:	f04a                	sd	s2,32(sp)
    80006efe:	ec4e                	sd	s3,24(sp)
    80006f00:	e852                	sd	s4,16(sp)
    80006f02:	e456                	sd	s5,8(sp)
    80006f04:	0080                	addi	s0,sp,64
      // transmit buffer is empty.
      return;
    }
    
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f06:	10000937          	lui	s2,0x10000
    ...
    80006f0a:	00020a17          	auipc	s4,0x20
    80006f0e:	63ea0a13          	addi	s4,s4,1598 # 80027548 <uart_tx_lock>
    uart_tx_r += 1;
    80006f12:	00003497          	auipc	s1,0x3
    80006f16:	12648493          	addi	s1,s1,294 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80006f1a:	00003997          	auipc	s3,0x3
    80006f1e:	12698993          	addi	s3,s3,294 # 8000a040 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
    80006f22:	00594783          	lbu	a5,5(s2) # 10000005 <_entry-0x6ffffffb>
    80006f26:	0ff7f793          	andi	a5,a5,255
    80006f2a:	0207f793          	andi	a5,a5,32
    80006f2e:	c785                	beqz	a5,80006f56 <uartstart+0x76>
    int c = uart_tx_buf[uart_tx_r % UART_TX_BUF_SIZE];
    80006f30:	01f77793          	andi	a5,a4,31
    80006f34:	97d2                	add	a5,a5,s4
    80006f36:	0187ca83          	lbu	s5,24(a5)
    uart_tx_r += 1;
    80006f3a:	0705                	addi	a4,a4,1
    80006f3c:	e098                	sd	a4,0(s1)
    
    // maybe uartputc() is waiting for space in the buffer.
    wakeup(&uart_tx_r);
    80006f3e:	8526                	mv	a0,s1
    80006f40:	ffffb097          	auipc	ra,0xffffb
    80006f44:	918080e7          	jalr	-1768(ra) # 80001858 <wakeup>
    
    WriteReg(THR, c);
    80006f48:	01590023          	sb	s5,0(s2)
    if(uart_tx_w == uart_tx_r){
    80006f4c:	6098                	ld	a4,0(s1)
    80006f4e:	0009b783          	ld	a5,0(s3)
    80006f52:	fce798e3          	bne	a5,a4,80006f22 <uartstart+0x42>
  }
}
    80006f56:	70e2                	ld	ra,56(sp)
    80006f58:	7442                	ld	s0,48(sp)
    80006f5a:	74a2                	ld	s1,40(sp)
    80006f5c:	7902                	ld	s2,32(sp)
    80006f5e:	69e2                	ld	s3,24(sp)
    80006f60:	6a42                	ld	s4,16(sp)
    80006f62:	6aa2                	ld	s5,8(sp)
    80006f64:	6121                	addi	sp,sp,64
    80006f66:	8082                	ret
    80006f68:	8082                	ret

0000000080006f6a <uartputc>:
{
    80006f6a:	7179                	addi	sp,sp,-48
    80006f6c:	f406                	sd	ra,40(sp)
    80006f6e:	f022                	sd	s0,32(sp)
    80006f70:	ec26                	sd	s1,24(sp)
    80006f72:	e84a                	sd	s2,16(sp)
    80006f74:	e44e                	sd	s3,8(sp)
    80006f76:	e052                	sd	s4,0(sp)
    80006f78:	1800                	addi	s0,sp,48
    80006f7a:	89aa                	mv	s3,a0
  acquire(&uart_tx_lock);
    80006f7c:	00020517          	auipc	a0,0x20
    80006f80:	5cc50513          	addi	a0,a0,1484 # 80027548 <uart_tx_lock>
    80006f84:	00000097          	auipc	ra,0x0
    80006f88:	1a4080e7          	jalr	420(ra) # 80007128 <acquire>
  if(panicked){
    80006f8c:	00003797          	auipc	a5,0x3
    80006f90:	0a47a783          	lw	a5,164(a5) # 8000a030 <panicked>
    80006f94:	c391                	beqz	a5,80006f98 <uartputc+0x2e>
    for(;;)
    80006f96:	a001                	j	80006f96 <uartputc+0x2c>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006f98:	00003797          	auipc	a5,0x3
    80006f9c:	0a87b783          	ld	a5,168(a5) # 8000a040 <uart_tx_w>
    80006fa0:	00003717          	auipc	a4,0x3
    80006fa4:	09873703          	ld	a4,152(a4) # 8000a038 <uart_tx_r>
    80006fa8:	02070713          	addi	a4,a4,32
    80006fac:	02f71b63          	bne	a4,a5,80006fe2 <uartputc+0x78>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fb0:	00020a17          	auipc	s4,0x20
    80006fb4:	598a0a13          	addi	s4,s4,1432 # 80027548 <uart_tx_lock>
    80006fb8:	00003497          	auipc	s1,0x3
    80006fbc:	08048493          	addi	s1,s1,128 # 8000a038 <uart_tx_r>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fc0:	00003917          	auipc	s2,0x3
    80006fc4:	08090913          	addi	s2,s2,128 # 8000a040 <uart_tx_w>
      sleep(&uart_tx_r, &uart_tx_lock);
    80006fc8:	85d2                	mv	a1,s4
    80006fca:	8526                	mv	a0,s1
    80006fcc:	ffffa097          	auipc	ra,0xffffa
    80006fd0:	706080e7          	jalr	1798(ra) # 800016d2 <sleep>
    if(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80006fd4:	00093783          	ld	a5,0(s2)
    80006fd8:	6098                	ld	a4,0(s1)
    80006fda:	02070713          	addi	a4,a4,32
    80006fde:	fef705e3          	beq	a4,a5,80006fc8 <uartputc+0x5e>
      uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    80006fe2:	00020497          	auipc	s1,0x20
    80006fe6:	56648493          	addi	s1,s1,1382 # 80027548 <uart_tx_lock>
    80006fea:	01f7f713          	andi	a4,a5,31
    80006fee:	9726                	add	a4,a4,s1
    80006ff0:	01370c23          	sb	s3,24(a4)
      uart_tx_w += 1;
    80006ff4:	0785                	addi	a5,a5,1
    80006ff6:	00003717          	auipc	a4,0x3
    80006ffa:	04f73523          	sd	a5,74(a4) # 8000a040 <uart_tx_w>
      uartstart();
    80006ffe:	00000097          	auipc	ra,0x0
    80007002:	ee2080e7          	jalr	-286(ra) # 80006ee0 <uartstart>
      release(&uart_tx_lock);
    80007006:	8526                	mv	a0,s1
    80007008:	00000097          	auipc	ra,0x0
    8000700c:	1d4080e7          	jalr	468(ra) # 800071dc <release>
}
    80007010:	70a2                	ld	ra,40(sp)
    80007012:	7402                	ld	s0,32(sp)
    80007014:	64e2                	ld	s1,24(sp)
    80007016:	6942                	ld	s2,16(sp)
    80007018:	69a2                	ld	s3,8(sp)
    8000701a:	6a02                	ld	s4,0(sp)
    8000701c:	6145                	addi	sp,sp,48
    8000701e:	8082                	ret

0000000080007020 <uartgetc>:
...
uartgetc(void)
{
    80007020:	1141                	addi	sp,sp,-16
    80007022:	e422                	sd	s0,8(sp)
    80007024:	0800                	addi	s0,sp,16
  if(ReadReg(LSR) & 0x01){
    80007026:	100007b7          	lui	a5,0x10000
    8000702a:	0057c783          	lbu	a5,5(a5) # 10000005 <_entry-0x6ffffffb>
    8000702e:	8b85                	andi	a5,a5,1
    80007030:	cb91                	beqz	a5,80007044 <uartgetc+0x24>
    // input data is ready.
    return ReadReg(RHR);
    80007032:	100007b7          	lui	a5,0x10000
    80007036:	0007c503          	lbu	a0,0(a5) # 10000000 <_entry-0x70000000>
    8000703a:	0ff57513          	andi	a0,a0,255
  } else {
    return -1;
  }
}
    8000703e:	6422                	ld	s0,8(sp)
    80007040:	0141                	addi	sp,sp,16
    80007042:	8082                	ret
    return -1;
    80007044:	557d                	li	a0,-1
    80007046:	bfe5                	j	8000703e <uartgetc+0x1e>

0000000080007048 <uartintr>:
...
uartintr(void)
{
    ...
    8000704c:	e822                	sd	s0,16(sp)
    8000704e:	e426                	sd	s1,8(sp)
    80007050:	1000                	addi	s0,sp,32
  // read and process incoming characters.
  while(1){
    int c = uartgetc();
    if(c == -1)
    80007052:	54fd                	li	s1,-1
    int c = uartgetc();
    80007054:	00000097          	auipc	ra,0x0
    80007058:	fcc080e7          	jalr	-52(ra) # 80007020 <uartgetc>
    if(c == -1)
    8000705c:	00950763          	beq	a0,s1,8000706a <uartintr+0x22>
      break;
    consoleintr(c);
    80007060:	00000097          	auipc	ra,0x0
    80007064:	8fe080e7          	jalr	-1794(ra) # 8000695e <consoleintr>
  while(1){
    80007068:	b7f5                	j	80007054 <uartintr+0xc>
  }

  // send buffered characters.
  acquire(&uart_tx_lock);
    8000706a:	00020497          	auipc	s1,0x20
    8000706e:	4de48493          	addi	s1,s1,1246 # 80027548 <uart_tx_lock>
    80007072:	8526                	mv	a0,s1
    80007074:	00000097          	auipc	ra,0x0
    80007078:	0b4080e7          	jalr	180(ra) # 80007128 <acquire>
  uartstart();
    8000707c:	00000097          	auipc	ra,0x0
    80007080:	e64080e7          	jalr	-412(ra) # 80006ee0 <uartstart>
  release(&uart_tx_lock);
    80007084:	8526                	mv	a0,s1
    80007086:	00000097          	auipc	ra,0x0
    8000708a:	156080e7          	jalr	342(ra) # 800071dc <release>
}
...
initlock(struct spinlock *lk, char *name)
{
  ...
  lk->name = name;
    8000709e:	e50c                	sd	a1,8(a0)
  lk->locked = 0;
    800070a0:	00052023          	sw	zero,0(a0)
  lk->cpu = 0;
    800070a4:	00053823          	sd	zero,16(a0)
#ifdef LAB_LOCK
  lk->nts = 0;
  lk->n = 0;
  findslot(lk);
...
holding(struct spinlock *lk)
{
  ...
  r = (lk->locked && lk->cpu == mycpu());
    800070ae:	411c                	lw	a5,0(a0)
    800070b0:	e399                	bnez	a5,800070b6 <holding+0x8>
    ...
    800070b4:	8082                	ret
{
    ...
    800070be:	1000                	addi	s0,sp,32
  r = (lk->locked && lk->cpu == mycpu());
    800070c0:	6904                	ld	s1,16(a0)
    800070c2:	ffffa097          	auipc	ra,0xffffa
    800070c6:	de4080e7          	jalr	-540(ra) # 80000ea6 <mycpu>
    800070ca:	40a48533          	sub	a0,s1,a0
    800070ce:	00153513          	seqz	a0,a0
}
...
push_off(void)
{
  ...
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800070e6:	100024f3          	csrr	s1,sstatus
    800070ea:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() & ~SSTATUS_SIE);
    800070ee:	9bf5                	andi	a5,a5,-3
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800070f0:	10079073          	csrw	sstatus,a5
  int old = intr_get();

  intr_off();
  if(mycpu()->noff == 0)
    800070f4:	ffffa097          	auipc	ra,0xffffa
    800070f8:	db2080e7          	jalr	-590(ra) # 80000ea6 <mycpu>
    800070fc:	5d3c                	lw	a5,120(a0)
    800070fe:	cf89                	beqz	a5,80007118 <push_off+0x3c>
    mycpu()->intena = old;
  mycpu()->noff += 1;
    80007100:	ffffa097          	auipc	ra,0xffffa
    80007104:	da6080e7          	jalr	-602(ra) # 80000ea6 <mycpu>
    80007108:	5d3c                	lw	a5,120(a0)
    8000710a:	2785                	addiw	a5,a5,1
    8000710c:	dd3c                	sw	a5,120(a0)
}
    8000710e:	60e2                	ld	ra,24(sp)
    80007110:	6442                	ld	s0,16(sp)
    80007112:	64a2                	ld	s1,8(sp)
    80007114:	6105                	addi	sp,sp,32
    80007116:	8082                	ret
    mycpu()->intena = old;
    80007118:	ffffa097          	auipc	ra,0xffffa
    8000711c:	d8e080e7          	jalr	-626(ra) # 80000ea6 <mycpu>
  return (x & SSTATUS_SIE) != 0;
    80007120:	8085                	srli	s1,s1,0x1
    80007122:	8885                	andi	s1,s1,1
    80007124:	dd64                	sw	s1,124(a0)
    80007126:	bfe9                	j	80007100 <push_off+0x24>

0000000080007128 <acquire>:
{
    80007128:	1101                	addi	sp,sp,-32
    8000712a:	ec06                	sd	ra,24(sp)
    8000712c:	e822                	sd	s0,16(sp)
    8000712e:	e426                	sd	s1,8(sp)
    80007130:	1000                	addi	s0,sp,32
    80007132:	84aa                	mv	s1,a0
  push_off(); // disable interrupts to avoid deadlock.
    80007134:	00000097          	auipc	ra,0x0
    80007138:	fa8080e7          	jalr	-88(ra) # 800070dc <push_off>
  if(holding(lk))
    8000713c:	8526                	mv	a0,s1
    8000713e:	00000097          	auipc	ra,0x0
    80007142:	f70080e7          	jalr	-144(ra) # 800070ae <holding>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    80007146:	4705                	li	a4,1
  if(holding(lk))
    80007148:	e115                	bnez	a0,8000716c <acquire+0x44>
  while(__sync_lock_test_and_set(&lk->locked, 1) != 0) {
    8000714a:	87ba                	mv	a5,a4
    8000714c:	0cf4a7af          	amoswap.w.aq	a5,a5,(s1)
    80007150:	2781                	sext.w	a5,a5
    80007152:	ffe5                	bnez	a5,8000714a <acquire+0x22>
  __sync_synchronize();
    80007154:	0ff0000f          	fence
  lk->cpu = mycpu();
    80007158:	ffffa097          	auipc	ra,0xffffa
    8000715c:	d4e080e7          	jalr	-690(ra) # 80000ea6 <mycpu>
    80007160:	e888                	sd	a0,16(s1)
}
    80007162:	60e2                	ld	ra,24(sp)
    80007164:	6442                	ld	s0,16(sp)
    80007166:	64a2                	ld	s1,8(sp)
    80007168:	6105                	addi	sp,sp,32
    8000716a:	8082                	ret
    panic("acquire");
    8000716c:	00002517          	auipc	a0,0x2
    80007170:	6cc50513          	addi	a0,a0,1740 # 80009838 <digits+0x20>
    80007174:	00000097          	auipc	ra,0x0
    80007178:	a6a080e7          	jalr	-1430(ra) # 80006bde <panic>

000000008000717c <pop_off>:

void
pop_off(void)
{
    8000717c:	1141                	addi	sp,sp,-16
    8000717e:	e406                	sd	ra,8(sp)
    80007180:	e022                	sd	s0,0(sp)
    80007182:	0800                	addi	s0,sp,16
  struct cpu *c = mycpu();
    80007184:	ffffa097          	auipc	ra,0xffffa
    80007188:	d22080e7          	jalr	-734(ra) # 80000ea6 <mycpu>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    8000718c:	100027f3          	csrr	a5,sstatus
  return (x & SSTATUS_SIE) != 0;
    80007190:	8b89                	andi	a5,a5,2
  if(intr_get())
    80007192:	e78d                	bnez	a5,800071bc <pop_off+0x40>
    panic("pop_off - interruptible");
  if(c->noff < 1)
    80007194:	5d3c                	lw	a5,120(a0)
    80007196:	02f05b63          	blez	a5,800071cc <pop_off+0x50>
    panic("pop_off");
  c->noff -= 1;
    8000719a:	37fd                	addiw	a5,a5,-1
    8000719c:	0007871b          	sext.w	a4,a5
    800071a0:	dd3c                	sw	a5,120(a0)
  if(c->noff == 0 && c->intena)
    800071a2:	eb09                	bnez	a4,800071b4 <pop_off+0x38>
    800071a4:	5d7c                	lw	a5,124(a0)
    800071a6:	c799                	beqz	a5,800071b4 <pop_off+0x38>
  asm volatile("csrr %0, sstatus" : "=r" (x) );
    800071a8:	100027f3          	csrr	a5,sstatus
  w_sstatus(r_sstatus() | SSTATUS_SIE);
    800071ac:	0027e793          	ori	a5,a5,2
  asm volatile("csrw sstatus, %0" : : "r" (x));
    800071b0:	10079073          	csrw	sstatus,a5
    intr_on();
}
    800071b4:	60a2                	ld	ra,8(sp)
    800071b6:	6402                	ld	s0,0(sp)
    800071b8:	0141                	addi	sp,sp,16
    800071ba:	8082                	ret
    panic("pop_off - interruptible");
    800071bc:	00002517          	auipc	a0,0x2
    800071c0:	68450513          	addi	a0,a0,1668 # 80009840 <digits+0x28>
    800071c4:	00000097          	auipc	ra,0x0
    800071c8:	a1a080e7          	jalr	-1510(ra) # 80006bde <panic>
    panic("pop_off");
    800071cc:	00002517          	auipc	a0,0x2
    800071d0:	68c50513          	addi	a0,a0,1676 # 80009858 <digits+0x40>
    800071d4:	00000097          	auipc	ra,0x0
    800071d8:	a0a080e7          	jalr	-1526(ra) # 80006bde <panic>

00000000800071dc <release>:
{
  ...
  if(!holding(lk))
    ...
    800071ec:	ec6080e7          	jalr	-314(ra) # 800070ae <holding>
    800071f0:	c115                	beqz	a0,80007214 <release+0x38>
  lk->cpu = 0;
    800071f2:	0004b823          	sd	zero,16(s1)
  __sync_synchronize();
    800071f6:	0ff0000f          	fence
  __sync_lock_release(&lk->locked);
    800071fa:	0f50000f          	fence	iorw,ow
    800071fe:	0804a02f          	amoswap.w	zero,zero,(s1)
  pop_off();
    80007202:	00000097          	auipc	ra,0x0
    80007206:	f7a080e7          	jalr	-134(ra) # 8000717c <pop_off>
}
    8000720a:	60e2                	ld	ra,24(sp)
    8000720c:	6442                	ld	s0,16(sp)
    8000720e:	64a2                	ld	s1,8(sp)
    80007210:	6105                	addi	sp,sp,32
    80007212:	8082                	ret
    panic("release");
    80007214:	00002517          	auipc	a0,0x2
    80007218:	64c50513          	addi	a0,a0,1612 # 80009860 <digits+0x48>
    8000721c:	00000097          	auipc	ra,0x0
    80007220:	9c2080e7          	jalr	-1598(ra) # 80006bde <panic>

0000000080007224 <lockfree_read8>:
...
000000008000723a <lockfree_read4>:
...
lockfree_read4(int *addr) {
  ...
  __atomic_load(addr, &val, __ATOMIC_SEQ_CST);
    ...
    80007244:	4108                	lw	a0,0(a0)
    80007246:	0ff0000f          	fence
  return val;
}
    8000724a:	2501                	sext.w	a0,a0
    8000724c:	6422                	ld	s0,8(sp)
    8000724e:	0141                	addi	sp,sp,16
    80007250:	8082                	ret
	...
