...
sys_open(void)
{
    800056d2:	7129                	addi	sp,sp,-320
    800056d4:	fe06                	sd	ra,312(sp)
    800056d6:	fa22                	sd	s0,304(sp)
    800056d8:	f626                	sd	s1,296(sp)
    800056da:	f24a                	sd	s2,288(sp)
    800056dc:	ee4e                	sd	s3,280(sp)
    800056de:	ea52                	sd	s4,272(sp)
    800056e0:	0280                	addi	s0,sp,320
  int fd, omode;
  struct file *f;
  struct inode *ip;
  int n, r;
  ...
  if((n = argstr(0, path, MAXPATH)) < 0 || argint(1, &omode) < 0)
    800056f6:	1e054063          	bltz	a0,800058d6 <sys_open+0x204>
    ...
    80005708:	1c054763          	bltz	a0,800058d6 <sys_open+0x204>
  begin_op();
  ...
  if(omode & O_CREATE){
    ...
    8000571c:	c7f9                	beqz	a5,800057ea <sys_open+0x118>
    ip = create(path, T_FILE, 0, 0);
    8000571e:	4681                	li	a3,0
    80005720:	4601                	li	a2,0
    80005722:	4589                	li	a1,2
    80005724:	f5040513          	addi	a0,s0,-176
    80005728:	00000097          	auipc	ra,0x0
    8000572c:	970080e7          	jalr	-1680(ra) # 80005098 <create>
    80005730:	84aa                	mv	s1,a0
    if(ip == 0){
    80005732:	c55d                	beqz	a0,800057e0 <sys_open+0x10e>
    }
  }
  ...
  while (ip->type == T_SYMLINK && !(omode & O_NOFOLLOW)) {
    80005734:	04449783          	lh	a5,68(s1)
    80005738:	0007869b          	sext.w	a3,a5
    8000573c:	4711                	li	a4,4
    8000573e:	492d                	li	s2,11
    80005740:	06e69c63          	bne	a3,a4,800057b8 <sys_open+0xe6>
    80005744:	6985                	lui	s3,0x1
    80005746:	80098993          	addi	s3,s3,-2048 # 800 <_entry-0x7ffff800>
    8000574a:	4a11                	li	s4,4
    8000574c:	f4c42783          	lw	a5,-180(s0)
    80005750:	00f9f7b3          	and	a5,s3,a5
    80005754:	efdd                	bnez	a5,80005812 <sys_open+0x140>
    ...
    8000577a:	29a080e7          	jalr	666(ra) # 80003a10 <readi>
    8000577e:	12054363          	bltz	a0,800058a4 <sys_open+0x1d2>
      iunlockput(ip);
      end_op();
      return -1;
    }
    ...
    80005788:	23a080e7          	jalr	570(ra) # 800039be <iunlockput>
    if((ip = namei(ktarget)) == 0){
    8000578c:	ec840513          	addi	a0,s0,-312
    80005790:	ffffe097          	auipc	ra,0xffffe
    80005794:	784080e7          	jalr	1924(ra) # 80003f14 <namei>
    80005798:	84aa                	mv	s1,a0
    8000579a:	10050f63          	beqz	a0,800058b8 <sys_open+0x1e6>
      end_op();
      return -1;
    }
    ...
    800057a2:	f18080e7          	jalr	-232(ra) # 800036b6 <ilock>
    depth++;
    if (depth > 10) {
    800057a6:	397d                	addiw	s2,s2,-1
    800057a8:	10090d63          	beqz	s2,800058c2 <sys_open+0x1f0>
  while (ip->type == T_SYMLINK && !(omode & O_NOFOLLOW)) {
    800057ac:	04449783          	lh	a5,68(s1)
    800057b0:	0007871b          	sext.w	a4,a5
    800057b4:	f9470ce3          	beq	a4,s4,8000574c <sys_open+0x7a>
      end_op();
      return -1;
    }
  }
  ...
  if(ip->type == T_DEVICE && (ip->major < 0 || ip->major >= NDEV)){
    ...
    800057bc:	04e79b63          	bne	a5,a4,80005812 <sys_open+0x140>
    800057c0:	0464d703          	lhu	a4,70(s1)
    800057c4:	47a5                	li	a5,9
    800057c6:	04e7f663          	bgeu	a5,a4,80005812 <sys_open+0x140>
    iunlockput(ip);
    800057ca:	8526                	mv	a0,s1
    800057cc:	ffffe097          	auipc	ra,0xffffe
    800057d0:	1f2080e7          	jalr	498(ra) # 800039be <iunlockput>
    end_op();
    800057d4:	fffff097          	auipc	ra,0xfffff
    800057d8:	9dc080e7          	jalr	-1572(ra) # 800041b0 <end_op>
    return -1;
    800057dc:	597d                	li	s2,-1
    800057de:	a8e5                	j	800058d6 <sys_open+0x204>
      end_op();
    800057e0:	fffff097          	auipc	ra,0xfffff
    800057e4:	9d0080e7          	jalr	-1584(ra) # 800041b0 <end_op>
      return -1;
    800057e8:	a0fd                	j	800058d6 <sys_open+0x204>
    if((ip = namei(path)) == 0){
    800057ea:	f5040513          	addi	a0,s0,-176
    800057ee:	ffffe097          	auipc	ra,0xffffe
    800057f2:	726080e7          	jalr	1830(ra) # 80003f14 <namei>
    800057f6:	84aa                	mv	s1,a0
    800057f8:	c549                	beqz	a0,80005882 <sys_open+0x1b0>
    ilock(ip);
    800057fa:	ffffe097          	auipc	ra,0xffffe
    800057fe:	ebc080e7          	jalr	-324(ra) # 800036b6 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
    80005802:	04449703          	lh	a4,68(s1)
    80005806:	4785                	li	a5,1
    80005808:	f2f716e3          	bne	a4,a5,80005734 <sys_open+0x62>
    8000580c:	f4c42783          	lw	a5,-180(s0)
    80005810:	efbd                	bnez	a5,8000588e <sys_open+0x1bc>
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    80005812:	fffff097          	auipc	ra,0xfffff
    80005816:	d36080e7          	jalr	-714(ra) # 80004548 <filealloc>
    8000581a:	89aa                	mv	s3,a0
    8000581c:	c965                	beqz	a0,8000590c <sys_open+0x23a>
    8000581e:	00000097          	auipc	ra,0x0
    80005822:	838080e7          	jalr	-1992(ra) # 80005056 <fdalloc>
    80005826:	892a                	mv	s2,a0
    80005828:	0c054d63          	bltz	a0,80005902 <sys_open+0x230>
    iunlockput(ip);
    end_op();
    return -1;
  }
  ...
  if(ip->type == T_DEVICE){
    ...
    80005832:	0af70b63          	beq	a4,a5,800058e8 <sys_open+0x216>
    f->type = FD_DEVICE;
    f->major = ip->major;
  } else {
    f->type = FD_INODE;
  ...
  if((omode & O_TRUNC) && ip->type == T_FILE){
    ...
    80005862:	c791                	beqz	a5,8000586e <sys_open+0x19c>
    80005864:	04449703          	lh	a4,68(s1)
    80005868:	4789                	li	a5,2
    8000586a:	08f70663          	beq	a4,a5,800058f6 <sys_open+0x224>
    itrunc(ip);
  }
  ...
  iunlock(ip);
    ...
    80005874:	f08080e7          	jalr	-248(ra) # 80003778 <iunlock>
  end_op();
    80005878:	fffff097          	auipc	ra,0xfffff
    8000587c:	938080e7          	jalr	-1736(ra) # 800041b0 <end_op>

  return fd;
    80005880:	a899                	j	800058d6 <sys_open+0x204>
      end_op();
    80005882:	fffff097          	auipc	ra,0xfffff
    80005886:	92e080e7          	jalr	-1746(ra) # 800041b0 <end_op>
      return -1;
    8000588a:	597d                	li	s2,-1
    8000588c:	a0a9                	j	800058d6 <sys_open+0x204>
      iunlockput(ip);
    8000588e:	8526                	mv	a0,s1
    80005890:	ffffe097          	auipc	ra,0xffffe
    80005894:	12e080e7          	jalr	302(ra) # 800039be <iunlockput>
      end_op();
    80005898:	fffff097          	auipc	ra,0xfffff
    8000589c:	918080e7          	jalr	-1768(ra) # 800041b0 <end_op>
      return -1;
    800058a0:	597d                	li	s2,-1
    800058a2:	a815                	j	800058d6 <sys_open+0x204>
      iunlockput(ip);
    800058a4:	8526                	mv	a0,s1
    800058a6:	ffffe097          	auipc	ra,0xffffe
    800058aa:	118080e7          	jalr	280(ra) # 800039be <iunlockput>
      end_op();
    800058ae:	fffff097          	auipc	ra,0xfffff
    800058b2:	902080e7          	jalr	-1790(ra) # 800041b0 <end_op>
      return -1;
    800058b6:	a839                	j	800058d4 <sys_open+0x202>
      end_op();
    800058b8:	fffff097          	auipc	ra,0xfffff
    800058bc:	8f8080e7          	jalr	-1800(ra) # 800041b0 <end_op>
      return -1;
    800058c0:	a811                	j	800058d4 <sys_open+0x202>
      iunlockput(ip);
    ...
    800058d0:	8e4080e7          	jalr	-1820(ra) # 800041b0 <end_op>
      return -1;
    800058d4:	597d                	li	s2,-1
}
    800058d6:	854a                	mv	a0,s2
    800058d8:	70f2                	ld	ra,312(sp)
    800058da:	7452                	ld	s0,304(sp)
    800058dc:	74b2                	ld	s1,296(sp)
    800058de:	7912                	ld	s2,288(sp)
    800058e0:	69f2                	ld	s3,280(sp)
    800058e2:	6a52                	ld	s4,272(sp)
    800058e4:	6131                	addi	sp,sp,320
    800058e6:	8082                	ret
    f->type = FD_DEVICE;
    800058e8:	00f9a023          	sw	a5,0(s3)
    f->major = ip->major;
    800058ec:	04649783          	lh	a5,70(s1)
    800058f0:	02f99223          	sh	a5,36(s3)
    800058f4:	b7b1                	j	80005840 <sys_open+0x16e>
    itrunc(ip);
    800058f6:	8526                	mv	a0,s1
    800058f8:	ffffe097          	auipc	ra,0xffffe
    800058fc:	ecc080e7          	jalr	-308(ra) # 800037c4 <itrunc>
    80005900:	b7bd                	j	8000586e <sys_open+0x19c>
      fileclose(f);
    80005902:	854e                	mv	a0,s3
    80005904:	fffff097          	auipc	ra,0xfffff
    80005908:	d00080e7          	jalr	-768(ra) # 80004604 <fileclose>
    iunlockput(ip);
    ...
    8000591a:	89a080e7          	jalr	-1894(ra) # 800041b0 <end_op>
    return -1;
    8000591e:	597d                	li	s2,-1
    80005920:	bf5d                	j	800058d6 <sys_open+0x204>
...
sys_mkdir(void)
{
  ...
  begin_op();
    ...
    8000592e:	806080e7          	jalr	-2042(ra) # 80004130 <begin_op>
  if(argstr(0, path, MAXPATH) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
    ...
    80005940:	186080e7          	jalr	390(ra) # 80002ac2 <argstr>
    ...
    80005956:	746080e7          	jalr	1862(ra) # 80005098 <create>
  ...
  iunlockput(ip);
    ...
    80005960:	062080e7          	jalr	98(ra) # 800039be <iunlockput>
  end_op();
    80005964:	fffff097          	auipc	ra,0xfffff
    80005968:	84c080e7          	jalr	-1972(ra) # 800041b0 <end_op>
  return 0;
    ...
    8000597a:	83a080e7          	jalr	-1990(ra) # 800041b0 <end_op>
    return -1;
...
sys_mknod(void)
{
  ...
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    800059b2:	0d0080e7          	jalr	208(ra) # 80002a7e <argint>
  if((argstr(0, path, MAXPATH)) < 0 ||
    ...
    800059c4:	0be080e7          	jalr	190(ra) # 80002a7e <argint>
     argint(1, &major) < 0 ||
    ...
    800059de:	6be080e7          	jalr	1726(ra) # 80005098 <create>
     argint(2, &minor) < 0 ||
  ...
  iunlockput(ip);
    ...
    800059e8:	fda080e7          	jalr	-38(ra) # 800039be <iunlockput>
  end_op();
    800059ec:	ffffe097          	auipc	ra,0xffffe
    800059f0:	7c4080e7          	jalr	1988(ra) # 800041b0 <end_op>
  return 0;
    800059f4:	4501                	li	a0,0
    800059f6:	a031                	j	80005a02 <sys_mknod+0x80>
    end_op();
    800059f8:	ffffe097          	auipc	ra,0xffffe
    800059fc:	7b8080e7          	jalr	1976(ra) # 800041b0 <end_op>
    return -1;
...
sys_chdir(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005a1a:	faa080e7          	jalr	-86(ra) # 800019c0 <myproc>
    80005a1e:	892a                	mv	s2,a0
  
  begin_op();
    80005a20:	ffffe097          	auipc	ra,0xffffe
    80005a24:	710080e7          	jalr	1808(ra) # 80004130 <begin_op>
  ...
  ilock(ip);
    ...
    80005a52:	c68080e7          	jalr	-920(ra) # 800036b6 <ilock>
  if(ip->type != T_DIR){
  ...
  iunlock(ip);
    ...
    80005a66:	d16080e7          	jalr	-746(ra) # 80003778 <iunlock>
  iput(p->cwd);
    80005a6a:	15093503          	ld	a0,336(s2)
    80005a6e:	ffffe097          	auipc	ra,0xffffe
    80005a72:	ea8080e7          	jalr	-344(ra) # 80003916 <iput>
  end_op();
    80005a76:	ffffe097          	auipc	ra,0xffffe
    80005a7a:	73a080e7          	jalr	1850(ra) # 800041b0 <end_op>
  p->cwd = ip;
  ...
  return 0;
    ...
    80005a94:	720080e7          	jalr	1824(ra) # 800041b0 <end_op>
    return -1;
    ...
    80005aa2:	f20080e7          	jalr	-224(ra) # 800039be <iunlockput>
    end_op();
    80005aa6:	ffffe097          	auipc	ra,0xffffe
    80005aaa:	70a080e7          	jalr	1802(ra) # 800041b0 <end_op>
    return -1;
...
sys_exec(void)
{
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005ad2:	ff4080e7          	jalr	-12(ra) # 80002ac2 <argstr>
    return -1;
  ...
  if(argstr(0, path, MAXPATH) < 0 || argaddr(1, &uargv) < 0){
    ...
    80005ae6:	fbe080e7          	jalr	-66(ra) # 80002aa0 <argaddr>
  ...
  memset(argv, 0, sizeof(argv));
    ...
    80005b22:	ec6080e7          	jalr	-314(ra) # 800029e4 <fetchaddr>
    ...
    80005b4a:	ef0080e7          	jalr	-272(ra) # 80002a36 <fetchstr>
 ...
 bad:
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    ...
    80005b66:	e88080e7          	jalr	-376(ra) # 800009ea <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
  ...
  int ret = exec(path, argv);
    ...
    80005b8c:	0dc080e7          	jalr	220(ra) # 80004c64 <exec>
  ...
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
    ...
    80005b9e:	e50080e7          	jalr	-432(ra) # 800009ea <kfree>
  for(i = 0; i < NELEM(argv) && argv[i] != 0; i++)
...
sys_pipe(void)
{
  ...
  struct proc *p = myproc();
    ...
    80005bce:	df6080e7          	jalr	-522(ra) # 800019c0 <myproc>
  ...
  if(argaddr(0, &fdarray) < 0)
    ...
    80005bde:	ec6080e7          	jalr	-314(ra) # 80002aa0 <argaddr>
    return -1;
  ...
  if(pipealloc(&rf, &wf) < 0)
    ...
    80005bf4:	d44080e7          	jalr	-700(ra) # 80004934 <pipealloc>
    return -1;
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    ...
    80005c0a:	450080e7          	jalr	1104(ra) # 80005056 <fdalloc>
    ...
    80005c1e:	43c080e7          	jalr	1084(ra) # 80005056 <fdalloc>
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005c3a:	a20080e7          	jalr	-1504(ra) # 80001656 <copyout>
    ...
    80005c54:	a06080e7          	jalr	-1530(ra) # 80001656 <copyout>
    p->ofile[fd1] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  if(copyout(p->pagetable, fdarray, (char*)&fd0, sizeof(fd0)) < 0 ||
    ...
    80005c8e:	97a080e7          	jalr	-1670(ra) # 80004604 <fileclose>
    return -1;
    ...
    80005cb2:	956080e7          	jalr	-1706(ra) # 80004604 <fileclose>
    fileclose(wf);
    80005cb6:	fc843503          	ld	a0,-56(s0)
    80005cba:	fffff097          	auipc	ra,0xfffff
    80005cbe:	94a080e7          	jalr	-1718(ra) # 80004604 <fileclose>
    return -1;
...
0000000080005cd0 <sys_symlink>:

int sys_symlink(char *target, char *path) {
    80005cd0:	712d                	addi	sp,sp,-288
    80005cd2:	ee06                	sd	ra,280(sp)
    80005cd4:	ea22                	sd	s0,272(sp)
    80005cd6:	e626                	sd	s1,264(sp)
    80005cd8:	e24a                	sd	s2,256(sp)
    80005cda:	1200                	addi	s0,sp,288
  ...
  memset(ktarget, 0, MAXPATH);
    ...
    80005cf4:	ee040513          	addi	a0,s0,-288
  ...
  if((n = argstr(0, ktarget, MAXPATH)) < 0)
    ...
    80005d04:	ee040593          	addi	a1,s0,-288
    80005d08:	4501                	li	a0,0
    80005d0a:	ffffd097          	auipc	ra,0xffffd
    80005d0e:	db8080e7          	jalr	-584(ra) # 80002ac2 <argstr>
    80005d12:	08054163          	bltz	a0,80005d94 <sys_symlink+0xc4>
    return -1;
  ...
  if ((n = argstr(1, kpath, MAXPATH)) < 0)
    ...
    80005d24:	da2080e7          	jalr	-606(ra) # 80002ac2 <argstr>
    80005d28:	06054863          	bltz	a0,80005d98 <sys_symlink+0xc8>
    return -1;

  int ret = 0;
  begin_op();
    80005d2c:	ffffe097          	auipc	ra,0xffffe
    80005d30:	404080e7          	jalr	1028(ra) # 80004130 <begin_op>

  if((ip = namei(kpath)) != 0){
    80005d34:	f6040513          	addi	a0,s0,-160
    80005d38:	ffffe097          	auipc	ra,0xffffe
    80005d3c:	1dc080e7          	jalr	476(ra) # 80003f14 <namei>
    // symlink already exists
    ret = -1;
    80005d40:	54fd                	li	s1,-1
  if((ip = namei(kpath)) != 0){
    80005d42:	cd01                	beqz	a0,80005d5a <sys_symlink+0x8a>
...
final:
  end_op();
    ...
    80005d48:	46c080e7          	jalr	1132(ra) # 800041b0 <end_op>
  return ret;
}
    80005d4c:	8526                	mv	a0,s1
    80005d4e:	60f2                	ld	ra,280(sp)
    80005d50:	6452                	ld	s0,272(sp)
    80005d52:	64b2                	ld	s1,264(sp)
    80005d54:	6912                	ld	s2,256(sp)
    80005d56:	6115                	addi	sp,sp,288
    80005d58:	8082                	ret
  ip = create(kpath, T_SYMLINK, 0, 0);
    80005d5a:	4681                	li	a3,0
    80005d5c:	4601                	li	a2,0
    80005d5e:	4591                	li	a1,4
    80005d60:	f6040513          	addi	a0,s0,-160
    80005d64:	fffff097          	auipc	ra,0xfffff
    80005d68:	334080e7          	jalr	820(ra) # 80005098 <create>
    80005d6c:	892a                	mv	s2,a0
  if(ip == 0){
    80005d6e:	d979                	beqz	a0,80005d44 <sys_symlink+0x74>
  if ((r = writei(ip, 0, (uint64)ktarget, 0, MAXPATH)) < 0)
    80005d70:	08000713          	li	a4,128
    80005d74:	4681                	li	a3,0
    80005d76:	ee040613          	addi	a2,s0,-288
    80005d7a:	4581                	li	a1,0
    80005d7c:	ffffe097          	auipc	ra,0xffffe
    80005d80:	d8c080e7          	jalr	-628(ra) # 80003b08 <writei>
    80005d84:	41f5549b          	sraiw	s1,a0,0x1f
  iunlockput(ip);
    80005d88:	854a                	mv	a0,s2
    80005d8a:	ffffe097          	auipc	ra,0xffffe
    80005d8e:	c34080e7          	jalr	-972(ra) # 800039be <iunlockput>
    80005d92:	bf4d                	j	80005d44 <sys_symlink+0x74>
    return -1;
    80005d94:	54fd                	li	s1,-1
    80005d96:	bf5d                	j	80005d4c <sys_symlink+0x7c>
    return -1;
    80005d98:	54fd                	li	s1,-1
    80005d9a:	bf4d                	j	80005d4c <sys_symlink+0x7c>
    80005d9c:	0000                	unimp
	...
...
free_desc(int i)
{
  ...
  wakeup(&disk.free[0]);
    ...
    80005f76:	7d650513          	addi	a0,a0,2006 # 80008748 <syscalls+0x328>
    80005f7a:	ffffa097          	auipc	ra,0xffffa
    80005f7e:	5b6080e7          	jalr	1462(ra) # 80000530 <panic>
    panic("free_desc 2");
    80005f82:	00002517          	auipc	a0,0x2
    80005f86:	7d650513          	addi	a0,a0,2006 # 80008758 <syscalls+0x338>
...
0000000080005f92 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005fa0:	7cc58593          	addi	a1,a1,1996 # 80008768 <syscalls+0x348>
...
virtio_disk_intr()
{
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    8000646a:	37250513          	addi	a0,a0,882 # 800087d8 <syscalls+0x3b8>
